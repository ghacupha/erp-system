...
/**
 * Performance test for the PaymentRequisition entity.
 */
class PaymentRequisitionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PaymentRequisition entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all paymentRequisitions")
            .get("/services/erpservice/api/payment-requisitions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new paymentRequisition")
            .post("/services/erpservice/api/payment-requisitions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created paymentRequisition")
                .get("/services/erpservice${new_paymentRequisition_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created paymentRequisition")
            .delete("/services/erpservice${new_paymentRequisition_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
