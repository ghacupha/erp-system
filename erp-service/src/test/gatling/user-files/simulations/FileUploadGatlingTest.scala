...
class FileUploadGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the FileUpload entity")
        ...
        .repeat(2) {
            ...
            .get("/services/erpservice/api/file-uploads")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new fileUpload")
            .post("/services/erpservice/api/file-uploads")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/erpservice${new_fileUpload_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created fileUpload")
            .delete("/services/erpservice${new_fileUpload_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
