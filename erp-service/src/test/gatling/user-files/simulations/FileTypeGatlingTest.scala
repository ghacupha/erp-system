...
class FileTypeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the FileType entity")
        ...
        .repeat(2) {
            ...
            .get("/services/erpservice/api/file-types")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new fileType")
            .post("/services/erpservice/api/file-types")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/erpservice${new_fileType_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created fileType")
            .delete("/services/erpservice${new_fileType_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
