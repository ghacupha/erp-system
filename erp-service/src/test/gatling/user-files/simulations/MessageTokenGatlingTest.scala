...
class MessageTokenGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MessageToken entity")
        ...
        .repeat(2) {
            ...
            .get("/services/erpservice/api/message-tokens")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new messageToken")
            .post("/services/erpservice/api/message-tokens")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/erpservice${new_messageToken_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created messageToken")
            .delete("/services/erpservice${new_messageToken_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
