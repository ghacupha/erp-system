...
class DealerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Dealer entity")
        ...
        .repeat(2) {
            ...
            .get("/services/erpservice/api/dealers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new dealer")
            .post("/services/erpservice/api/dealers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/erpservice${new_dealer_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created dealer")
            .delete("/services/erpservice${new_dealer_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
