...
public class TaxReferenceResource {
    ...
    private static final String ENTITY_NAME = "erpServiceTaxReference";
    ...
    public TaxReferenceResource(TaxReferenceService taxReferenceService, TaxReferenceQueryService taxReferenceQueryService) {
    ...
    public ResponseEntity<TaxReferenceDTO> createTaxReference(@Valid @RequestBody TaxReferenceDTO taxReferenceDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/tax-references/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /tax-references} : Updates an existing taxReference.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/tax-references")
    public ResponseEntity<TaxReferenceDTO> updateTaxReference(@Valid @RequestBody TaxReferenceDTO taxReferenceDTO) throws URISyntaxException {
        log.debug("REST request to update TaxReference : {}", taxReferenceDTO);
        if (taxReferenceDTO.getId() == null) {
