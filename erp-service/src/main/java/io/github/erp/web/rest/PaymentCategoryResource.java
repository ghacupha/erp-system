...
public class PaymentCategoryResource {
    ...
    private static final String ENTITY_NAME = "erpServicePaymentCategory";
    ...
    public PaymentCategoryResource(PaymentCategoryService paymentCategoryService, PaymentCategoryQueryService paymentCategoryQueryService) {
    ...
    /**
     * {@code PUT  /payment-categories} : Updates an existing paymentCategory.
     *
