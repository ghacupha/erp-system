...
3. Click **Present values** on a row to open its schedule. The page title lists the related contract identifier so you know which lease you are reviewing; the booking ID now appears immediately because it is pulled from the stored selection even before the API call finishes.
