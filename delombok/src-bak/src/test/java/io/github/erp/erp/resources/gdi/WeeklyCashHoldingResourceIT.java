...
/**
 * Integration tests for the WeeklyCashHoldingResource REST controller.
 */
@IntegrationTest
...
class WeeklyCashHoldingResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/weekly-cash-holdings";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/weekly-cash-holdings";
