...
import io.github.erp.web.rest.SourceRemittancePurposeTypeResource;
...
class SourceRemittancePurposeTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/source-remittance-purpose-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/source-remittance-purpose-types";
