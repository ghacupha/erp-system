...
/**
 * Integration tests for the {@link AssetWarrantyResource} REST controller.
 */
@IntegrationTest
...
class AssetWarrantyResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/asset-warranties";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/asset-warranties";
