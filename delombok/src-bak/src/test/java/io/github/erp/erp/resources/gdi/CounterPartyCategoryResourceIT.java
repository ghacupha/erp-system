...
import io.github.erp.web.rest.CounterPartyCategoryResource;
...
class CounterPartyCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/counter-party-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/counter-party-categories";
