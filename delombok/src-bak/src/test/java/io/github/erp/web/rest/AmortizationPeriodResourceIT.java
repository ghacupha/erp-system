...
/**
 * Integration tests for the {@link AmortizationPeriodResource} REST controller.
 */
@IntegrationTest
...
class AmortizationPeriodResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/amortization-periods";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/amortization-periods";
