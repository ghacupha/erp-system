...
import io.github.erp.web.rest.CrbComplaintTypeResource;
...
class CrbComplaintTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-complaint-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-complaint-types";
