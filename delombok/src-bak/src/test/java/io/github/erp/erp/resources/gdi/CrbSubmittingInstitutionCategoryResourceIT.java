...
import io.github.erp.web.rest.CrbSubmittingInstitutionCategoryResource;
...
class CrbSubmittingInstitutionCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-submitting-institution-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-submitting-institution-categories";
