...
import io.github.erp.web.rest.FinancialDerivativeTypeCodeResource;
...
class FinancialDerivativeTypeCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/financial-derivative-type-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/financial-derivative-type-codes";
