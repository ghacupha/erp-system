...
/**
 * Integration tests for the {@link CreditCardFacilityResourceProd} REST controller.
 */
@IntegrationTest
...
class CreditCardFacilityResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/credit-card-facilities";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/credit-card-facilities";
