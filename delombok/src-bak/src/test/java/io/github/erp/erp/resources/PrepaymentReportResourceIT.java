...
import io.github.erp.web.rest.PrepaymentReportResource;
...
class PrepaymentReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/prepayments/prepayment-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/prepayments/_search/prepayment-reports";
