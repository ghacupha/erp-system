...
import io.github.erp.web.rest.CrbAmountCategoryBandResource;
...
class CrbAmountCategoryBandResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-amount-category-bands";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-amount-category-bands";
