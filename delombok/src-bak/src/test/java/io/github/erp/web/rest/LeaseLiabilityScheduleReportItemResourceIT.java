...
class LeaseLiabilityScheduleReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/lease-liability-schedule-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/lease-liability-schedule-report-items";
