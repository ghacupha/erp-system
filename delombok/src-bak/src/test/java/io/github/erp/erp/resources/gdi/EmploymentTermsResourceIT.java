...
import io.github.erp.web.rest.EmploymentTermsResource;
...
class EmploymentTermsResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/employment-terms";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/employment-terms";
