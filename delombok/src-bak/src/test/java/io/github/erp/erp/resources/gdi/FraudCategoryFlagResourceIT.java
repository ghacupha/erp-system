...
import io.github.erp.web.rest.FraudCategoryFlagResource;
...
class FraudCategoryFlagResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/fraud-category-flags";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/fraud-category-flags";
