...
import io.github.erp.web.rest.LoanRestructureFlagResource;
...
class LoanRestructureFlagResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/loan-restructure-flags";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/loan-restructure-flags";
