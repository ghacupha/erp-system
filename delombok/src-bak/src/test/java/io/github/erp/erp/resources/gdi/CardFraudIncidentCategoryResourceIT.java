...
import io.github.erp.web.rest.CardFraudIncidentCategoryResource;
...
class CardFraudIncidentCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/card-fraud-incident-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/card-fraud-incident-categories";
