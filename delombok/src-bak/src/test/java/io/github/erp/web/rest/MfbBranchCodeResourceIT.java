...
class MfbBranchCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/mfb-branch-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/mfb-branch-codes";
