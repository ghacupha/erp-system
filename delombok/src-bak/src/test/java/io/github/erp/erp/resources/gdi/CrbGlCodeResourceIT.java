...
import io.github.erp.web.rest.CrbGlCodeResource;
...
class CrbGlCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-gl-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-gl-codes";
