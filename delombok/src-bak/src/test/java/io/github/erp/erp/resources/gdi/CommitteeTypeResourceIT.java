...
import io.github.erp.web.rest.CommitteeTypeResource;
...
class CommitteeTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/committee-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/committee-types";
