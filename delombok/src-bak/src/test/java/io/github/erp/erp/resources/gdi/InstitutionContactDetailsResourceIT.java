...
import io.github.erp.web.rest.InstitutionContactDetailsResource;
...
class InstitutionContactDetailsResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/institution-contact-details";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/institution-contact-details";
