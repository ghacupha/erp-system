...
import io.github.erp.web.rest.AccountStatusTypeResource;
...
class AccountStatusTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/account-status-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/account-status-types";
