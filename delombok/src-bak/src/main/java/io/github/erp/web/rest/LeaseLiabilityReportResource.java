...
@RestController
@RequestMapping("/api")
public class LeaseLiabilityReportResource {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityReportResource.class);
    ...
    public LeaseLiabilityReportResource(
