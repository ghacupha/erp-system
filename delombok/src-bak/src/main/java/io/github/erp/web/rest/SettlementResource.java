...
public class SettlementResource {
    ...
    public ResponseEntity<SettlementDTO> updateSettlement(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, settlementDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SettlementDTO> partialUpdateSettlement(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, settlementDTO.getId().toString())
        );
    }
