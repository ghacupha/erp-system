...
@RestController
@RequestMapping("/api")
public class LeaseRepaymentPeriodResource {

    private final Logger log = LoggerFactory.getLogger(LeaseRepaymentPeriodResource.class);
    ...
    public LeaseRepaymentPeriodResource(
