...
public class CreditNoteResource {
    ...
    public ResponseEntity<CreditNoteDTO> updateCreditNote(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, creditNoteDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CreditNoteDTO> partialUpdateCreditNote(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, creditNoteDTO.getId().toString())
        );
    }
