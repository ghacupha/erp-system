...
@Component
public class AttachedWorkInProgressOutstandingReportRequisitionDTOMapper implements Mapping<WorkInProgressOutstandingReportRequisitionDTO, AttachedWorkInProgressOutstandingReportRequisitionDTO> {

    @Override
    public WorkInProgressOutstandingReportRequisitionDTO toValue1(AttachedWorkInProgressOutstandingReportRequisitionDTO vs) {
        WorkInProgressOutstandingReportRequisitionDTO dto = new WorkInProgressOutstandingReportRequisitionDTO();
    ...
    @Override
    public AttachedWorkInProgressOutstandingReportRequisitionDTO toValue2(WorkInProgressOutstandingReportRequisitionDTO vs) {
        return AttachedWorkInProgressOutstandingReportRequisitionDTO.builder()
            .id(vs.getId())
