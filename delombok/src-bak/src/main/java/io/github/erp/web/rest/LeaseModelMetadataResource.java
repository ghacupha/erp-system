...
@RestController
@RequestMapping("/api")
public class LeaseModelMetadataResource {
    ...
    public LeaseModelMetadataResource(
    ...
    public ResponseEntity<LeaseModelMetadataDTO> updateLeaseModelMetadata(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, leaseModelMetadataDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<LeaseModelMetadataDTO> partialUpdateLeaseModelMetadata(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, leaseModelMetadataDTO.getId().toString())
        );
    }
