...
/**
 * A DTO for the {@link io.github.erp.domain.LeaseLiabilityPostingReport} entity.
 */
public class LeaseLiabilityPostingReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LeaseLiabilityPostingReportDTO)) {
            return false;
        }

        LeaseLiabilityPostingReportDTO leaseLiabilityPostingReportDTO = (LeaseLiabilityPostingReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, leaseLiabilityPostingReportDTO.id);
    }
    ...
    public String toString() {
        return "LeaseLiabilityPostingReportDTO{" +
            "id=" + getId() +
