...
/**
 * Criteria class for the {@link io.github.erp.domain.RouDepreciationPostingReport} entity. This class is used
 * in {@link io.github.erp.web.rest.RouDepreciationPostingReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /rou-depreciation-posting-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class RouDepreciationPostingReportCriteria implements Serializable, Criteria {
    ...
    public RouDepreciationPostingReportCriteria() {}

    public RouDepreciationPostingReportCriteria(RouDepreciationPostingReportCriteria other) {
    ...
    @Override
    public RouDepreciationPostingReportCriteria copy() {
        return new RouDepreciationPostingReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RouDepreciationPostingReportCriteria that = (RouDepreciationPostingReportCriteria) o;
        return (
    ...
    public String toString() {
        return "RouDepreciationPostingReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
