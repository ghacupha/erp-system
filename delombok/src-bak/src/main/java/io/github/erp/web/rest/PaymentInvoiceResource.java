...
public class PaymentInvoiceResource {
    ...
    public ResponseEntity<PaymentInvoiceDTO> updatePaymentInvoice(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paymentInvoiceDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PaymentInvoiceDTO> partialUpdatePaymentInvoice(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paymentInvoiceDTO.getId().toString())
        );
    }
