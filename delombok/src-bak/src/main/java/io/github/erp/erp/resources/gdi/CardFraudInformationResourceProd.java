...
public class CardFraudInformationResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardFraudInformationResourceProd.class);
    ...
    public CardFraudInformationResourceProd(
