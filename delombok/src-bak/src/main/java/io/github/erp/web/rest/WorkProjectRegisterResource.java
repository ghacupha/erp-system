...
public class WorkProjectRegisterResource {
    ...
    public ResponseEntity<WorkProjectRegisterDTO> updateWorkProjectRegister(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workProjectRegisterDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkProjectRegisterDTO> partialUpdateWorkProjectRegister(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workProjectRegisterDTO.getId().toString())
        );
    }
