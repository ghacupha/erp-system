 ...
 */
@RestController("questionBaseResourceProd")
@RequestMapping("/api/design-report")
public class QuestionBaseResourceProd {

    private final Logger log = LoggerFactory.getLogger(QuestionBaseResourceProd.class);
    ...
    public QuestionBaseResourceProd(
    ...
    public ResponseEntity<QuestionBaseDTO> updateQuestionBase(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, questionBaseDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<QuestionBaseDTO> partialUpdateQuestionBase(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, questionBaseDTO.getId().toString())
        );
    }
