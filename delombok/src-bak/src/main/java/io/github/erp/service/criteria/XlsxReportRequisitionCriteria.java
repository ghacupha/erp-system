...
/**
 * Criteria class for the {@link io.github.erp.domain.XlsxReportRequisition} entity. This class is used
 * in {@link io.github.erp.web.rest.XlsxReportRequisitionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /xlsx-report-requisitions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class XlsxReportRequisitionCriteria implements Serializable, Criteria {
    ...
    public XlsxReportRequisitionCriteria() {}

    public XlsxReportRequisitionCriteria(XlsxReportRequisitionCriteria other) {
    ...
    @Override
    public XlsxReportRequisitionCriteria copy() {
        return new XlsxReportRequisitionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final XlsxReportRequisitionCriteria that = (XlsxReportRequisitionCriteria) o;
        return (
    ...
    public String toString() {
        return "XlsxReportRequisitionCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
