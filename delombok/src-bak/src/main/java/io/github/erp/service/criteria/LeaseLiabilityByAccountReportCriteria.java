...
/**
 * Criteria class for the {@link io.github.erp.domain.LeaseLiabilityByAccountReport} entity. This class is used
 * in {@link io.github.erp.web.rest.LeaseLiabilityByAccountReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /lease-liability-by-account-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LeaseLiabilityByAccountReportCriteria implements Serializable, Criteria {
    ...
    public LeaseLiabilityByAccountReportCriteria() {}

    public LeaseLiabilityByAccountReportCriteria(LeaseLiabilityByAccountReportCriteria other) {
    ...
    @Override
    public LeaseLiabilityByAccountReportCriteria copy() {
        return new LeaseLiabilityByAccountReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LeaseLiabilityByAccountReportCriteria that = (LeaseLiabilityByAccountReportCriteria) o;
        return (
    ...
    public String toString() {
        return "LeaseLiabilityByAccountReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
