...
public class MessageTokenResource {
    ...
    public ResponseEntity<MessageTokenDTO> updateMessageToken(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, messageTokenDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<MessageTokenDTO> partialUpdateMessageToken(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, messageTokenDTO.getId().toString())
        );
    }
