...
public class AgencyNoticeResource {
    ...
    public ResponseEntity<AgencyNoticeDTO> updateAgencyNotice(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, agencyNoticeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AgencyNoticeDTO> partialUpdateAgencyNotice(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, agencyNoticeDTO.getId().toString())
        );
    }
