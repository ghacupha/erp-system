...
/**
 * Criteria class for the {@link io.github.erp.domain.LeaseRepaymentPeriod} entity. This class is used
 * in {@link io.github.erp.web.rest.LeaseRepaymentPeriodResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /lease-repayment-periods?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LeaseRepaymentPeriodCriteria implements Serializable, Criteria {
    ...
    public LeaseRepaymentPeriodCriteria() {}

    public LeaseRepaymentPeriodCriteria(LeaseRepaymentPeriodCriteria other) {
    ...
    @Override
    public LeaseRepaymentPeriodCriteria copy() {
        return new LeaseRepaymentPeriodCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LeaseRepaymentPeriodCriteria that = (LeaseRepaymentPeriodCriteria) o;
        return (
    ...
    public String toString() {
        return "LeaseRepaymentPeriodCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
