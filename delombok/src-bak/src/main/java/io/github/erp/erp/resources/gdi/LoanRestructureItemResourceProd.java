 ...
 */
@RestController("LoanRestructureItemResourceProd")
@RequestMapping("/api/granular-data")
public class LoanRestructureItemResourceProd {

    private final Logger log = LoggerFactory.getLogger(LoanRestructureItemResourceProd.class);
    ...
    public LoanRestructureItemResourceProd(
