...
/**
 * Mapper for the entity {@link PrepaymentByAccountReportRequisition} and its DTO {@link PrepaymentByAccountReportRequisitionDTO}.
 */
@Mapper(componentModel = "spring", uses = { ApplicationUserMapper.class })
public interface PrepaymentByAccountReportRequisitionMapper
    extends EntityMapper<PrepaymentByAccountReportRequisitionDTO, PrepaymentByAccountReportRequisition> {
    ...
    PrepaymentByAccountReportRequisitionDTO toDto(PrepaymentByAccountReportRequisition s);
}
