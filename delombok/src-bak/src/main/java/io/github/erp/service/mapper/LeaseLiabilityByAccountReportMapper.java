...
/**
 * Mapper for the entity {@link LeaseLiabilityByAccountReport} and its DTO {@link LeaseLiabilityByAccountReportDTO}.
 */
@Mapper(componentModel = "spring", uses = { ApplicationUserMapper.class, LeasePeriodMapper.class })
public interface LeaseLiabilityByAccountReportMapper extends EntityMapper<LeaseLiabilityByAccountReportDTO, LeaseLiabilityByAccountReport> {
    ...
    LeaseLiabilityByAccountReportDTO toDto(LeaseLiabilityByAccountReport s);
}
