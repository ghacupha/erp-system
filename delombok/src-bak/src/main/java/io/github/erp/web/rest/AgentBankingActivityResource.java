...
@RestController
@RequestMapping("/api")
public class AgentBankingActivityResource {

    private final Logger log = LoggerFactory.getLogger(AgentBankingActivityResource.class);
    ...
    public AgentBankingActivityResource(
