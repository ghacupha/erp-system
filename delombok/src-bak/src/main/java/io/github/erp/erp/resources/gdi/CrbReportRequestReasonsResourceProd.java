...
public class CrbReportRequestReasonsResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbReportRequestReasonsResourceProd.class);
    ...
    public CrbReportRequestReasonsResourceProd(
