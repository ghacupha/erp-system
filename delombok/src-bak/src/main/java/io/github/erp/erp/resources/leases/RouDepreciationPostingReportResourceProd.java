...
public class RouDepreciationPostingReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(RouDepreciationPostingReportResourceProd.class);
    ...
    public RouDepreciationPostingReportResourceProd(
