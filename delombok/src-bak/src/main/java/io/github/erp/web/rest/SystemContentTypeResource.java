...
@RestController
@RequestMapping("/api")
public class SystemContentTypeResource {
    ...
    public SystemContentTypeResource(
    ...
    public ResponseEntity<SystemContentTypeDTO> updateSystemContentType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, systemContentTypeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SystemContentTypeDTO> partialUpdateSystemContentType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, systemContentTypeDTO.getId().toString())
        );
    }
