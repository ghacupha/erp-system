...
public class PrepaymentAmortizationResource {
    ...
    public PrepaymentAmortizationResource(
    ...
    public ResponseEntity<PrepaymentAmortizationDTO> updatePrepaymentAmortization(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, prepaymentAmortizationDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PrepaymentAmortizationDTO> partialUpdatePrepaymentAmortization(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, prepaymentAmortizationDTO.getId().toString())
        );
    }
