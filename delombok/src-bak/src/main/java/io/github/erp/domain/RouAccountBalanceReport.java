...
/**
 * A RouAccountBalanceReport.
 */
@Entity
@Table(name = "rou_account_balance_report")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "rouaccountbalancereport")
public class RouAccountBalanceReport implements Serializable {
    ...
    public RouAccountBalanceReport id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public RouAccountBalanceReport requestId(UUID requestId) {
    ...
    public RouAccountBalanceReport timeOfRequest(ZonedDateTime timeOfRequest) {
    ...
    public RouAccountBalanceReport reportIsCompiled(Boolean reportIsCompiled) {
    ...
    public RouAccountBalanceReport fileChecksum(String fileChecksum) {
    ...
    public RouAccountBalanceReport tampered(Boolean tampered) {
    ...
    public RouAccountBalanceReport filename(UUID filename) {
    ...
    public RouAccountBalanceReport reportParameters(String reportParameters) {
    ...
    public RouAccountBalanceReport reportFile(byte[] reportFile) {
    ...
    public RouAccountBalanceReport reportFileContentType(String reportFileContentType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RouAccountBalanceReport)) {
            return false;
        }
        return id != null && id.equals(((RouAccountBalanceReport) o).id);
    }
