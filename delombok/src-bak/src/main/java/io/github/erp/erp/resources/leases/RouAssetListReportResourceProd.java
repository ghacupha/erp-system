...
public class RouAssetListReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(RouAssetListReportResourceProd.class);
    ...
    public RouAssetListReportResourceProd(
