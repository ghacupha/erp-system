...
public class WeeklyCashHoldingResourceProd {

    private final Logger log = LoggerFactory.getLogger(WeeklyCashHoldingResourceProd.class);
    ...
    public WeeklyCashHoldingResourceProd(
