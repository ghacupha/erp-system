 ...
 */
@RestController("fiscalMonthResourceProd")
@RequestMapping("/api/app")
public class FiscalMonthResourceProd {

    private final Logger log = LoggerFactory.getLogger(FiscalMonthResourceProd.class);

    private static final String ENTITY_NAME = "fiscalMonthProd";
