...
public class NbvCompilationJobResourceProd {

    private final Logger log = LoggerFactory.getLogger(NbvCompilationJobResourceProd.class);
    ...
    public NbvCompilationJobResourceProd(
