...
@RestController
@RequestMapping("/api")
public class ExcelReportExportResource {
    ...
    public ExcelReportExportResource(
    ...
    public ResponseEntity<ExcelReportExportDTO> updateExcelReportExport(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, excelReportExportDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ExcelReportExportDTO> partialUpdateExcelReportExport(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, excelReportExportDTO.getId().toString())
        );
    }
