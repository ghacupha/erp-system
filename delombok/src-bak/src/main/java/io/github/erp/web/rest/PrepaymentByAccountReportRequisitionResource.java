...
@RestController
@RequestMapping("/api")
public class PrepaymentByAccountReportRequisitionResource {

    private final Logger log = LoggerFactory.getLogger(PrepaymentByAccountReportRequisitionResource.class);
    ...
    public PrepaymentByAccountReportRequisitionResource(
