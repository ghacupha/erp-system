 ...
 */
@RestController("reportContentTypeResourceProd")
@RequestMapping("/api/design-report")
@RolesAllowed({"ROLE_REPORT_ACCESSOR", "ROLE_REPORT_DESIGNER", "ROLE_DEV"})
public class ReportContentTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(ReportContentTypeResourceProd.class);
    ...
    public ReportContentTypeResourceProd(
    ...
    public ResponseEntity<ReportContentTypeDTO> updateReportContentType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportContentTypeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ReportContentTypeDTO> partialUpdateReportContentType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportContentTypeDTO.getId().toString())
        );
    }
