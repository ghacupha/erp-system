...
public class AssetAdditionsReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(AssetAdditionsReportResourceProd.class);
    ...
    public AssetAdditionsReportResourceProd(
