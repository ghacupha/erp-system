...
@Service
@Transactional
public class LeaseLiabilityServiceImpl implements LeaseLiabilityService {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityServiceImpl.class);
    ...
    public LeaseLiabilityServiceImpl(
