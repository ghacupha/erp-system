...
@RestController
@RequestMapping("/api")
public class AmortizationPostingReportRequisitionResource {

    private final Logger log = LoggerFactory.getLogger(AmortizationPostingReportRequisitionResource.class);
    ...
    private final AmortizationPostingReportRequisitionService amortizationPostingReportRequisitionService;
    ...
    public AmortizationPostingReportRequisitionResource(
        AmortizationPostingReportRequisitionService amortizationPostingReportRequisitionService,
