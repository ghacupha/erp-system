...
@RestController
@RequestMapping("/api")
public class LeaseLiabilityCompilationResource {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityCompilationResource.class);
    ...
    public LeaseLiabilityCompilationResource(
