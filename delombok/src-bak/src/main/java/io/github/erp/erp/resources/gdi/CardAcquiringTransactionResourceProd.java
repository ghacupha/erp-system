...
public class CardAcquiringTransactionResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardAcquiringTransactionResourceProd.class);
    ...
    public CardAcquiringTransactionResourceProd(
