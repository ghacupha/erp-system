...
@Service
@Transactional
public class PrepaymentAccountReportRequisitionServiceImpl implements PrepaymentAccountReportRequisitionService {

    private final Logger log = LoggerFactory.getLogger(PrepaymentAccountReportRequisitionServiceImpl.class);
    ...
    public PrepaymentAccountReportRequisitionServiceImpl(
