...
/**
 * A DTO for the {@link io.github.erp.domain.AmortizationPostingReportRequisition} entity.
 */
public class AmortizationPostingReportRequisitionDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmortizationPostingReportRequisitionDTO)) {
            return false;
        }

        AmortizationPostingReportRequisitionDTO amortizationPostingReportRequisitionDTO = (AmortizationPostingReportRequisitionDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, amortizationPostingReportRequisitionDTO.id);
    }
