...
public class XlsxReportRequisitionResource {
    ...
    public ResponseEntity<XlsxReportRequisitionDTO> updateXlsxReportRequisition(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, xlsxReportRequisitionDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<XlsxReportRequisitionDTO> partialUpdateXlsxReportRequisition(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, xlsxReportRequisitionDTO.getId().toString())
        );
    }
