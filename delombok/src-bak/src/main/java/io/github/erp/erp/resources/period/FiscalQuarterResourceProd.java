package io.github.erp.erp.resources.period;
 ...
 */
@RestController("fiscalQuarterResourceProd")
@RequestMapping("/api/app")
public class FiscalQuarterResourceProd {

    private final Logger log = LoggerFactory.getLogger(FiscalQuarterResourceProd.class);

    private static final String ENTITY_NAME = "fiscalQuarterProd";
    ...
    public FiscalQuarterResourceProd(
