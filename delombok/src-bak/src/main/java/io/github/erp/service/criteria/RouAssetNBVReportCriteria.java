...
/**
 * Criteria class for the {@link io.github.erp.domain.RouAssetNBVReport} entity. This class is used
 * in {@link io.github.erp.web.rest.RouAssetNBVReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /rou-asset-nbv-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class RouAssetNBVReportCriteria implements Serializable, Criteria {
    ...
    public RouAssetNBVReportCriteria() {}

    public RouAssetNBVReportCriteria(RouAssetNBVReportCriteria other) {
    ...
    @Override
    public RouAssetNBVReportCriteria copy() {
        return new RouAssetNBVReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RouAssetNBVReportCriteria that = (RouAssetNBVReportCriteria) o;
        return (
    ...
    public String toString() {
        return "RouAssetNBVReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
