...
@Service
@Transactional
public class InternalLeaseLiabilityScheduleReportServiceImpl implements InternalLeaseLiabilityScheduleReportService {

    private final Logger log = LoggerFactory.getLogger(InternalLeaseLiabilityScheduleReportServiceImpl.class);
    ...
    public InternalLeaseLiabilityScheduleReportServiceImpl(
