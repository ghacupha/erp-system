 ...
 */
@RestController("accountOwnershipTypeResourceProd")
@RequestMapping("/api/granular-data")
public class AccountOwnershipTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountOwnershipTypeResourceProd.class);
    ...
    public AccountOwnershipTypeResourceProd(
