 ...
 */
@RestController("messageTokenResourceProd")
@RequestMapping("/api/files")
public class MessageTokenResourceProd {

    private final Logger log = LoggerFactory.getLogger(MessageTokenResourceProd.class);
    ...
    public MessageTokenResourceProd(
