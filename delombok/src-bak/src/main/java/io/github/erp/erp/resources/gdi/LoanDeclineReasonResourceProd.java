 ...
 */
@RestController("LoanDeclineReasonResourceProd")
@RequestMapping("/api/granular-data")
public class LoanDeclineReasonResourceProd {

    private final Logger log = LoggerFactory.getLogger(LoanDeclineReasonResourceProd.class);
    ...
    public LoanDeclineReasonResourceProd(
