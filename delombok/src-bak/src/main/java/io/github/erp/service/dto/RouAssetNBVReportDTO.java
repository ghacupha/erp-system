...
/**
 * A DTO for the {@link io.github.erp.domain.RouAssetNBVReport} entity.
 */
public class RouAssetNBVReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RouAssetNBVReportDTO)) {
            return false;
        }

        RouAssetNBVReportDTO rouAssetNBVReportDTO = (RouAssetNBVReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, rouAssetNBVReportDTO.id);
    }
