...
export class PaymentCategoryComponentsPage {
  ...
  deleteButtons = element.all(by.css('gha-payment-category div table .btn-danger'));
  title = element.all(by.css('gha-payment-category div h2#page-heading span')).first();
...
export class PaymentCategoryUpdatePage {
  pageTitle = element(by.id('gha-payment-category-heading'));
...
export class PaymentCategoryDeleteDialog {
  private dialogTitle = element(by.id('gha-delete-paymentCategory-heading'));
  private confirmButton = element(by.id('gha-confirm-delete-paymentCategory'));
