...
export class FixedAssetDepreciationComponentsPage {
  ...
  deleteButtons = element.all(by.css('gha-fixed-asset-depreciation div table .btn-danger'));
  title = element.all(by.css('gha-fixed-asset-depreciation div h2#page-heading span')).first();
...
export class FixedAssetDepreciationUpdatePage {
  pageTitle = element(by.id('gha-fixed-asset-depreciation-heading'));
...
export class FixedAssetDepreciationDeleteDialog {
  private dialogTitle = element(by.id('gha-delete-fixedAssetDepreciation-heading'));
  private confirmButton = element(by.id('gha-confirm-delete-fixedAssetDepreciation'));
