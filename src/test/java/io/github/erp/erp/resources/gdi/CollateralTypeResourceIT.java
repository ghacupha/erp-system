...
import io.github.erp.web.rest.CollateralTypeResource;
...
class CollateralTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/collateral-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/collateral-types";
