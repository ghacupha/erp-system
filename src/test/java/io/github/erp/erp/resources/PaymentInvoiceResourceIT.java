...
/**
 * Integration tests for the {@link PaymentInvoiceResourceProd} REST controller.
 */
@IntegrationTest
...
class PaymentInvoiceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/payments/payment-invoices";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/payments/_search/payment-invoices";
