...
/**
 * Integration tests for the RouAccountBalanceReportResource REST controller.
 */
@IntegrationTest
...
class RouAccountBalanceReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/rou-account-balance-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-account-balance-reports";
