...
import io.github.erp.web.rest.BusinessSegmentTypesResource;
...
class BusinessSegmentTypesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/business-segment-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/business-segment-types";
