...
class SystemContentTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/dev/system-content-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/dev/_search/system-content-types";
