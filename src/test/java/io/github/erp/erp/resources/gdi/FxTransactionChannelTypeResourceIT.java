...
import io.github.erp.web.rest.FxTransactionChannelTypeResource;
...
class FxTransactionChannelTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/fx-transaction-channel-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/fx-transaction-channel-types";
