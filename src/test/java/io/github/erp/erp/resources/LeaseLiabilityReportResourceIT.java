...
/**
 * Integration tests for the LeaseLiabilityReportResource REST controller.
 */
@IntegrationTest
...
class LeaseLiabilityReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/lease-liability-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/lease-liability-reports";
