...
/**
 * Integration tests for the RouDepreciationPostingReportResourceProd REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser(roles = {"LEASE_MANAGER"})
public class RouDepreciationPostingReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/rou-depreciation-posting-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-depreciation-posting-reports";
