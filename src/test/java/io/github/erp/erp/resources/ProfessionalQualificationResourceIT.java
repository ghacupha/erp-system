...
import io.github.erp.web.rest.ProfessionalQualificationResource;
...
class ProfessionalQualificationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/professional-qualifications";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/professional-qualifications";
