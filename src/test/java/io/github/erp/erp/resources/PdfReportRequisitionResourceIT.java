...
public class PdfReportRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/pdf-report-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/_search/pdf-report-requisitions";
