...
import io.github.erp.web.rest.KenyanCurrencyDenominationResource;
...
class KenyanCurrencyDenominationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/kenyan-currency-denominations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/kenyan-currency-denominations";
