...
public class PrepaymentAmortizationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/prepayments/prepayment-amortizations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/prepayments/_search/prepayment-amortizations";
