...
import io.github.erp.web.rest.CrbSourceOfInformationTypeResource;
...
class CrbSourceOfInformationTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-source-of-information-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-source-of-information-types";
