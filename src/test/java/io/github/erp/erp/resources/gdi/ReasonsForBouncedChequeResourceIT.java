...
import io.github.erp.web.rest.ReasonsForBouncedChequeResource;
...
class ReasonsForBouncedChequeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/reasons-for-bounced-cheques";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/reasons-for-bounced-cheques";
