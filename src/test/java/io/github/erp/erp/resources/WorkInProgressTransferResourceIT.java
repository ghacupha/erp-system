...
public class WorkInProgressTransferResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/fixed-asset/work-in-progress-transfers";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/fixed-asset/_search/work-in-progress-transfers";
