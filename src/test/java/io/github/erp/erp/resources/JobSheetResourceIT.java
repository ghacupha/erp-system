...
public class JobSheetResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/payments/job-sheets";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/payments/_search/job-sheets";
