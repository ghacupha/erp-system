...
import io.github.erp.web.rest.BankTransactionTypeResource;
...
class BankTransactionTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/bank-transaction-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/bank-transaction-types";
