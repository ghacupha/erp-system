...
import io.github.erp.web.rest.PartyRelationTypeResource;
...
class PartyRelationTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/party-relation-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/party-relation-types";
