...
import io.github.erp.web.rest.ManagementMemberTypeResource;
...
class ManagementMemberTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/management-member-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/management-member-types";
