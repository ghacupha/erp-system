...
import io.github.erp.web.rest.CrbComplaintStatusTypeResource;
...
class CrbComplaintStatusTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-complaint-status-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-complaint-status-types";
