...
import io.github.erp.web.rest.PrepaymentByAccountReportRequisitionResource;
...
class PrepaymentByAccountReportRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/prepayments/prepayment-by-account-report-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/prepayments/_search/prepayment-by-account-report-requisitions";
