...
import io.github.erp.web.rest.CrbDataSubmittingInstitutionsResource;
...
class CrbDataSubmittingInstitutionsResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-data-submitting-institutions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-data-submitting-institutions";
