...
import io.github.erp.web.rest.ChartOfAccountsCodeResource;
...
class ChartOfAccountsCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/chart-of-accounts-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/chart-of-accounts-codes";
