...
import io.github.erp.web.rest.RouAccountBalanceReportItemResource;
...
class RouAccountBalanceReportItemResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-account-balance-report-items";
