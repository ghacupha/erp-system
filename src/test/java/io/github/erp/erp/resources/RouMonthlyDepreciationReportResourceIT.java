...
/**
 * Integration tests for the RouMonthlyDepreciationReportResource REST controller.
 */
@IntegrationTest
...
class RouMonthlyDepreciationReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/rou-monthly-depreciation-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-monthly-depreciation-reports";
