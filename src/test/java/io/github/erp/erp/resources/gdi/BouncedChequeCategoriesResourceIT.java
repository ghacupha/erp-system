...
import io.github.erp.web.rest.BouncedChequeCategoriesResource;
...
class BouncedChequeCategoriesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/bounced-cheque-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/bounced-cheque-categories";
