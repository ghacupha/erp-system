...
/**
 * Integration tests for the  AccountBalanceResource REST controller.
 */
@IntegrationTest
...
class AccountBalanceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/account-balances";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/account-balances";
