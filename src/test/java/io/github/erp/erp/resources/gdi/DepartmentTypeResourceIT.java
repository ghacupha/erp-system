...
import io.github.erp.web.rest.DepartmentTypeResource;
...
class DepartmentTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/department-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/department-types";
