...
import io.github.erp.web.rest.RemittanceFlagResource;
...
class RemittanceFlagResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/remittance-flags";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/remittance-flags";
