...
import io.github.erp.web.rest.LoanProductTypeResource;
...
class LoanProductTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/loan-product-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/loan-product-types";
