...
/**
 * Integration tests for the {@link LegalStatusResourceProd} REST controller.
 */
@IntegrationTest
...
class LegalStatusResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/legal-statuses";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/legal-statuses";
