...
import io.github.erp.web.rest.ShareholderTypeResource;
...
class ShareholderTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/shareholder-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/shareholder-types";
