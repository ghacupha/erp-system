...
/**
 * Integration tests for the {@link AccountAttributeMetadataResourceProd} REST controller.
 */
@IntegrationTest
...
class AccountAttributeMetadataResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/account-attribute-metadata";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/account-attribute-metadata";
