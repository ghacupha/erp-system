...
/**
 * Integration tests for the AmortizationPostingReportRequisitionResource REST controller.
 */
@IntegrationTest
...
class AmortizationPostingReportRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/prepayments/amortization-posting-report-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/prepayments/_search/amortization-posting-report-requisitions";
