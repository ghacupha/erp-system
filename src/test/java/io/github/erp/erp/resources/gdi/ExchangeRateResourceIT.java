...
/**
 * Integration tests for the {@link ExchangeRateResourceProd} REST controller.
 */
@IntegrationTest
...
class ExchangeRateResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/exchange-rates";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/exchange-rates";
