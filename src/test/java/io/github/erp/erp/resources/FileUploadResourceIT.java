...
class FileUploadResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/files/file-uploads";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/files/_search/file-uploads";
