...
import io.github.erp.web.rest.SourcesOfFundsTypeCodeResource;
...
class SourcesOfFundsTypeCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/sources-of-funds-type-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/sources-of-funds-type-codes";
