...
import io.github.erp.web.rest.CrbFileTransmissionStatusResource;
...
class CrbFileTransmissionStatusResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-file-transmission-statuses";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-file-transmission-statuses";
        ...
        restCrbFileTransmissionStatusMockMvc
            ...
            .andExpect(
                jsonPath("$.[*].submittedFileStatusTypeDescription")
                    .value(hasItem(DEFAULT_SUBMITTED_FILE_STATUS_TYPE_DESCRIPTION.toString()))
            );
    }
    ...
    void getCrbFileTransmissionStatus() throws Exception {
        ...
        restCrbFileTransmissionStatusMockMvc
            ...
            .andExpect(jsonPath("$.submittedFileStatusTypeDescription").value(DEFAULT_SUBMITTED_FILE_STATUS_TYPE_DESCRIPTION.toString()));
    }
