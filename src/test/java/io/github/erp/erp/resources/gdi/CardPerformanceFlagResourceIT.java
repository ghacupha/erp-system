...
import io.github.erp.web.rest.CardPerformanceFlagResource;
...
class CardPerformanceFlagResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/card-performance-flags";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/card-performance-flags";
