...
import io.github.erp.web.rest.CrbSubscriptionStatusTypeCodeResource;
...
class CrbSubscriptionStatusTypeCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-subscription-status-type-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-subscription-status-type-codes";
