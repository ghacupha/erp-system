...
public class DeliveryNoteResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/payments/delivery-notes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/payments/_search/delivery-notes";
