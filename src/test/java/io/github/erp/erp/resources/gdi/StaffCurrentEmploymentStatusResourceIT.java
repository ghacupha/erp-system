...
import io.github.erp.web.rest.StaffCurrentEmploymentStatusResource;
...
class StaffCurrentEmploymentStatusResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/staff-current-employment-statuses";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/staff-current-employment-statuses";
