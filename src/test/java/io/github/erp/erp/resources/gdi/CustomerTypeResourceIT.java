...
/**
 * Integration tests for the {@link CustomerTypeResourceProd} REST controller.
 */
@IntegrationTest
...
class CustomerTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/customer-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/customer-types";
    ...
    void getAllCustomerTypes() throws Exception {
        ...
        restCustomerTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].customerTypeDescription").value(hasItem(DEFAULT_CUSTOMER_TYPE_DESCRIPTION.toString())));
    }
    ...
    void getCustomerType() throws Exception {
        ...
        restCustomerTypeMockMvc
            ...
            .andExpect(jsonPath("$.customerTypeDescription").value(DEFAULT_CUSTOMER_TYPE_DESCRIPTION.toString()));
    }
