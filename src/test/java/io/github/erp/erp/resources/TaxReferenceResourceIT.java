...
class TaxReferenceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/taxes/tax-references";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/taxes/_search/tax-references";
