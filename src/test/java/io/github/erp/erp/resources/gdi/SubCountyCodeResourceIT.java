...
/**
 * Integration tests for the {@link SubCountyCodeResourceProd} REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser(roles = {"GRANULAR_REPORTS_USER", "FIXED_ASSETS_USER"})
public class SubCountyCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/sub-county-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/sub-county-codes";
