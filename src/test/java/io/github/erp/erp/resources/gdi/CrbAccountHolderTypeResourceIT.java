...
import io.github.erp.web.rest.CrbAccountHolderTypeResource;
...
class CrbAccountHolderTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-account-holder-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-account-holder-types";
