...
import io.github.erp.web.rest.AssetAdditionsReportItemResource;
...
class AssetAdditionsReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/report/asset-additions-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/report/_search/asset-additions-report-items";
