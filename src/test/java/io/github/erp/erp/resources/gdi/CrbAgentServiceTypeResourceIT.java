...
import io.github.erp.web.rest.CrbAgentServiceTypeResource;
...
class CrbAgentServiceTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-agent-service-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-agent-service-types";
