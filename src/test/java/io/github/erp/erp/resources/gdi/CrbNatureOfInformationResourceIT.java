...
import io.github.erp.web.rest.CrbNatureOfInformationResource;
...
class CrbNatureOfInformationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-nature-of-informations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-nature-of-informations";
