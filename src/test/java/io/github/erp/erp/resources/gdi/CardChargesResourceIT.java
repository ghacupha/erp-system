...
import io.github.erp.web.rest.CardChargesResource;
...
class CardChargesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/card-charges";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/card-charges";
