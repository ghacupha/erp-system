...
import io.github.erp.web.rest.LoanAccountCategoryResource;
...
class LoanAccountCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/loan-account-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/loan-account-categories";
