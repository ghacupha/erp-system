...
import io.github.erp.web.rest.DerivativeUnderlyingAssetResource;
...
class DerivativeUnderlyingAssetResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/derivative-underlying-assets";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/derivative-underlying-assets";
