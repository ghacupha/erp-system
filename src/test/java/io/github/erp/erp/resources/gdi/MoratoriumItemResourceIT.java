...
import io.github.erp.web.rest.MoratoriumItemResource;
...
class MoratoriumItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/moratorium-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/moratorium-items";
