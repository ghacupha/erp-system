...
/**
 * Integration tests for the {@link TerminalsAndPOSResourceProd} REST controller.
 */
@IntegrationTest
...
class TerminalsAndPOSResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/terminals-and-pos";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/terminals-and-pos";
