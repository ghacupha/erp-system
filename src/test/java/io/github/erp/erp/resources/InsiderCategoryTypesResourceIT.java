...
/**
 * Integration tests for the {@link InsiderCategoryTypesResourceProd} REST controller.
 */
@IntegrationTest
...
class InsiderCategoryTypesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/insider-category-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/insider-category-types";
