...
public class InstitutionCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/granular-data/institution-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/granular-data/_search/institution-codes";
