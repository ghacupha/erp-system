...
import io.github.erp.web.rest.InstitutionStatusTypeResource;
...
class InstitutionStatusTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/institution-status-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/institution-status-types";
