...
import io.github.erp.web.rest.FiscalMonthResource;
...
/**
 * Integration tests for the FiscalMonthResourceProd REST controller.
 */
@IntegrationTest
...
class FiscalMonthResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/fiscal-months";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/fiscal-months";
