...
/**
 * Integration tests for the {@link CountySubCountyCodeResourceProd} REST controller.
 */
@IntegrationTest
...
class CountySubCountyCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/county-sub-county-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/county-sub-county-codes";
