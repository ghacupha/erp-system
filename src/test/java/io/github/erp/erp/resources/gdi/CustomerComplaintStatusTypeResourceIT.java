...
import io.github.erp.web.rest.CustomerComplaintStatusTypeResource;
...
class CustomerComplaintStatusTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/customer-complaint-status-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/customer-complaint-status-types";
