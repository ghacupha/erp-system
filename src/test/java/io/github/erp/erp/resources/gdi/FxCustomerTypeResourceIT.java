...
import io.github.erp.web.rest.FxCustomerTypeResource;
...
class FxCustomerTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/fx-customer-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/fx-customer-types";
