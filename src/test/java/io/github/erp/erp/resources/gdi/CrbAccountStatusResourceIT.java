...
import io.github.erp.web.rest.CrbAccountStatusResource;
...
class CrbAccountStatusResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-account-statuses";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-account-statuses";
