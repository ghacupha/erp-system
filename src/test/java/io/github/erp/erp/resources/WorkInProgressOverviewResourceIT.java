...
import io.github.erp.web.rest.WorkInProgressOverviewResource;
...
class WorkInProgressOverviewResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/work-in-progress-overviews";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/work-in-progress-overviews";
