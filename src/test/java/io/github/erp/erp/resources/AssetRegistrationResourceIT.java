...
public class AssetRegistrationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/fixed-asset/asset-registrations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/fixed-asset/_search/asset-registrations";
