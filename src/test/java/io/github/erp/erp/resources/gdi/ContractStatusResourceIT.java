...
import io.github.erp.web.rest.ContractStatusResource;
...
class ContractStatusResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/contract-statuses";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/contract-statuses";
