...
@WithMockUser(roles = {"REPORT_DESIGNER", "REPORT_ACCESSOR", "DEV"})
public class ReportTemplateResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/report-templates";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/_search/report-templates";
