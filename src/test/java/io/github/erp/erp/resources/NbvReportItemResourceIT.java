...
import io.github.erp.web.rest.NbvReportItemResource;
...
class NbvReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/nbv-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/nbv-report-items";
