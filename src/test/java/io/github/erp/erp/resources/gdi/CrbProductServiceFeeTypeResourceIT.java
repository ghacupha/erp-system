...
import io.github.erp.web.rest.CrbProductServiceFeeTypeResource;
...
class CrbProductServiceFeeTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-product-service-fee-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-product-service-fee-types";
