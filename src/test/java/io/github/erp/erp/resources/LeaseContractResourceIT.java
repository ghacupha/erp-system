...
/**
 * Integration tests for the {@link LeaseContractResourceProd} REST controller.
 */
@IntegrationTest
...
class LeaseContractResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/lease-contracts";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/lease-contracts";
