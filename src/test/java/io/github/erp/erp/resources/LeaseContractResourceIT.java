...
class LeaseContractResourceIT {
    ...
    private static final String ENTITY_API_URL = "/v2/api/leases/lease-contracts";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/v2/api/leases/_search/lease-contracts";
