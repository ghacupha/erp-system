...
import io.github.erp.web.rest.SecurityTenureResource;
...
class SecurityTenureResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/security-tenures";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/security-tenures";
