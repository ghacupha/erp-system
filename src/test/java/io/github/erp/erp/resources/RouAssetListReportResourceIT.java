...
import io.github.erp.web.rest.RouAssetListReportResource;
...
class RouAssetListReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/rou-asset-list-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-asset-list-reports";
