...
import io.github.erp.web.rest.AccountOwnershipTypeResource;
...
class AccountOwnershipTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/account-ownership-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/account-ownership-types";
