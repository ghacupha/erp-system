...
/**
 * Integration tests for the AmortizationSequenceResource REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser(roles = {"DEV"})
class AmortizationSequenceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/amortization-sequences";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/amortization-sequences";
