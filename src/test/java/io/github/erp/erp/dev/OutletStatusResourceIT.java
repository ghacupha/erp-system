...
/**
 * Integration tests for the {@link OutletStatusResource} REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser(roles = {"DEV"})
public class OutletStatusResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/outlet-statuses";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/outlet-statuses";
