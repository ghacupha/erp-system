...
public class IsoCountryCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/iso-country-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/iso-country-codes";
