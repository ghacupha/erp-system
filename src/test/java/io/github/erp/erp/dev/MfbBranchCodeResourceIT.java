...
/**
 * Integration tests for the {@link MfbBranchCodeResource} REST controller.
 */
@IntegrationTest
...
public class MfbBranchCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/mfb-branch-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/mfb-branch-codes";
