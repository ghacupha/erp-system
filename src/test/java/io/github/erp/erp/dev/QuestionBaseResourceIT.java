...
/**
 * Integration tests for the QuestionBaseResource REST controller.
 */
@IntegrationTest
...
public class QuestionBaseResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/question-bases";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/question-bases";
