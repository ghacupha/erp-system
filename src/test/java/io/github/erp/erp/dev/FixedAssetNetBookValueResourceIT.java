...
public class FixedAssetNetBookValueResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/fixed-asset-net-book-values";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/fixed-asset-net-book-values";
