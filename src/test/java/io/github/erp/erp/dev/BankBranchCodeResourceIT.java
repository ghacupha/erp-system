...
public class BankBranchCodeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/bank-branch-codes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/bank-branch-codes";
