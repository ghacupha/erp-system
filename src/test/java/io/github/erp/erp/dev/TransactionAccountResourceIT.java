...
public class TransactionAccountResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/transaction-accounts";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/transaction-accounts";
