...
public class WorkInProgressRegistrationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/work-in-progress-registrations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/work-in-progress-registrations";
