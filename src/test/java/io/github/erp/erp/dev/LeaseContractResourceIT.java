...
/**
 * Integration tests for the LeaseContractResource REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser(roles = {"DEV"})
public class LeaseContractResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/lease-contracts";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/lease-contracts";
