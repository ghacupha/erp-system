...
//import io.github.erp.web.rest.AlgorithmResource;
...
/**
 * Integration tests for the {@link AlgorithmResourceDev} REST controller.
 */
@IntegrationTest
...
class AlgorithmResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/algorithms";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/algorithms";
