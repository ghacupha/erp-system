...
/**
 * Integration tests for the PrepaymentMappingResource REST controller.
 */
@IntegrationTest
...
class PrepaymentMappingResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/prepayment-mappings";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/prepayment-mappings";
