...
/**
 * Integration tests for the {@link SystemModuleResourceDev} REST controller.
 */
@IntegrationTest
...
class SystemModuleResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/system-modules";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/system-modules";
