package io.github.erp.erp.resource;
...
class AssetCategoryResourceIT {
    ...
    void getAllAssetCategoriesByDepreciationMethodIsEqualToSomething() throws Exception {
        ...
        DepreciationMethod depreciationMethod;
        if (TestUtil.findAll(em, DepreciationMethod.class).isEmpty()) {
            depreciationMethod = io.github.erp.erp.resource.DepreciationMethodResourceIT.createEntity(em);
            em.persist(depreciationMethod);
            em.flush();
        } else {
            depreciationMethod = TestUtil.findAll(em, DepreciationMethod.class).get(0);
    ...
    void getAllAssetCategoriesByPlaceholderIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, Placeholder.class).isEmpty()) {
            placeholder = io.github.erp.erp.resource.PlaceholderResourceIT.createEntity(em);
    ...
    void putNewAssetCategory() throws Exception {
        ...
        updatedAssetCategory.assetCategoryName(UPDATED_ASSET_CATEGORY_NAME).description(UPDATED_DESCRIPTION).notes(UPDATED_NOTES);
    ...
    void fullUpdateAssetCategoryWithPatch() throws Exception {
        ...
        partialUpdatedAssetCategory.assetCategoryName(UPDATED_ASSET_CATEGORY_NAME).description(UPDATED_DESCRIPTION).notes(UPDATED_NOTES);
