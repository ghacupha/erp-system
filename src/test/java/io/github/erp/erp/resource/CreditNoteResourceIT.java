...
public class CreditNoteResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/payments/credit-notes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/payments/_search/credit-notes";
