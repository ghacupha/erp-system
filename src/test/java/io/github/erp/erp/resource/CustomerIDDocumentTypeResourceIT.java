...
import io.github.erp.erp.resources.CustomerIDDocumentTypeResource;
...
/**
 * Integration tests for the {@link CustomerIDDocumentTypeResource} REST controller.
 */
@IntegrationTest
...
public class CustomerIDDocumentTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/customer-id-document-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/customer-id-document-types";
