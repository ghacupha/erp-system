...
class MonthlyPrepaymentOutstandingReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/monthly-prepayment-outstanding-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/monthly-prepayment-outstanding-report-items";
