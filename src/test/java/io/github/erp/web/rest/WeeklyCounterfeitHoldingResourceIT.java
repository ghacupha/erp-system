...
/**
 * Integration tests for the {@link WeeklyCounterfeitHoldingResource} REST controller.
 */
@IntegrationTest
...
class WeeklyCounterfeitHoldingResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/weekly-counterfeit-holdings";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/weekly-counterfeit-holdings";
