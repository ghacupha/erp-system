...
/**
 * Integration tests for the {@link PaymentCalculationResourceDev} REST controller.
 */
@IntegrationTest
...
public class PaymentCalculationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/payment-calculations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/payment-calculations";
