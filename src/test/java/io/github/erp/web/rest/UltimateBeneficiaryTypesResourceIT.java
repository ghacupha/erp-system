...
class UltimateBeneficiaryTypesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/ultimate-beneficiary-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/ultimate-beneficiary-types";
    ...
    void getAllUltimateBeneficiaryTypes() throws Exception {
        ...
        restUltimateBeneficiaryTypesMockMvc
            ...
            .andExpect(
                jsonPath("$.[*].ultimateBeneficiaryTypeDetails").value(hasItem(DEFAULT_ULTIMATE_BENEFICIARY_TYPE_DETAILS))
            );
    }
    ...
    void getUltimateBeneficiaryTypes() throws Exception {
        ...
        restUltimateBeneficiaryTypesMockMvc
            ...
            .andExpect(jsonPath("$.ultimateBeneficiaryTypeDetails").value(DEFAULT_ULTIMATE_BENEFICIARY_TYPE_DETAILS));
    }
