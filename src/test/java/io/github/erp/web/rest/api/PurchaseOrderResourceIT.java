...
/**
 * Integration tests for the {@link PurchaseOrderResourceDev} REST controller.
 */
@IntegrationTest
...
public class PurchaseOrderResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/purchase-orders";
