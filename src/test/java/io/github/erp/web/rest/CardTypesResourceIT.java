...
class CardTypesResourceIT {
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/card-types";
    ...
    void getAllCardTypes() throws Exception {
        ...
        restCardTypesMockMvc
            ...
            .andExpect(jsonPath("$.[*].cardTypeDetails").value(hasItem(DEFAULT_CARD_TYPE_DETAILS)));
    }
    ...
    void getCardTypes() throws Exception {
        ...
        restCardTypesMockMvc
            ...
            .andExpect(jsonPath("$.cardTypeDetails").value(DEFAULT_CARD_TYPE_DETAILS));
    }
