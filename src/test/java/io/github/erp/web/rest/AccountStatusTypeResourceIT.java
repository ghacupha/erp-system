...
class AccountStatusTypeResourceIT {
    ...
    void getAllAccountStatusTypes() throws Exception {
        ...
        restAccountStatusTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].accountStatusDescription").value(hasItem(DEFAULT_ACCOUNT_STATUS_DESCRIPTION)));
    }
    ...
    void getAccountStatusType() throws Exception {
        ...
        restAccountStatusTypeMockMvc
            ...
            .andExpect(jsonPath("$.accountStatusDescription").value(DEFAULT_ACCOUNT_STATUS_DESCRIPTION));
    }
