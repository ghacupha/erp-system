...
/**
 * Integration tests for the {@link ApplicationUserResourceDev} REST controller.
 */
@IntegrationTest
...
class ApplicationUserResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/application-users";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/application-users";
