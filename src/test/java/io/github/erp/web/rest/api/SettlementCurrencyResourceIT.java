...
/**
 * Integration tests for the {@link SettlementCurrencyResourceDev} REST controller.
 */
@IntegrationTest
...
public class SettlementCurrencyResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/settlement-currencies";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/settlement-currencies";
