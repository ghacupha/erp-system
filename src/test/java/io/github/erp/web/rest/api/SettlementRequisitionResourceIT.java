...
import io.github.erp.web.rest.SettlementRequisitionResource;
...
/**
 * Integration tests for the {@link SettlementRequisitionResource} REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser
class SettlementRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/settlement-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/settlement-requisitions";
    ...
    public static SettlementRequisition createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, SettlementCurrency.class).isEmpty()) {
            settlementCurrency = io.github.erp.web.rest.SettlementCurrencyResourceIT.createEntity(em);
    ...
    public static SettlementRequisition createUpdatedEntity(EntityManager em) {
        ...
        SettlementCurrency settlementCurrency;
        if (TestUtil.findAll(em, SettlementCurrency.class).isEmpty()) {
            settlementCurrency = io.github.erp.web.rest.SettlementCurrencyResourceIT.createUpdatedEntity(em);
            em.persist(settlementCurrency);
            em.flush();
        } else {
            settlementCurrency = TestUtil.findAll(em, SettlementCurrency.class).get(0);
    ...
    void getAllSettlementRequisitionsByCurrentOwnerIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, ApplicationUser.class).isEmpty()) {
            currentOwner = io.github.erp.web.rest.ApplicationUserResourceIT.createEntity(em);
    ...
    void getAllSettlementRequisitionsByNativeOwnerIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, ApplicationUser.class).isEmpty()) {
            nativeOwner = io.github.erp.web.rest.ApplicationUserResourceIT.createEntity(em);
    ...
    void getAllSettlementRequisitionsByNativeDepartmentIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, Dealer.class).isEmpty()) {
            nativeDepartment = io.github.erp.web.rest.DealerResourceIT.createEntity(em);
    ...
    void getAllSettlementRequisitionsByBillerIsEqualToSomething() throws Exception {
        ...
        Dealer biller;
        if (TestUtil.findAll(em, Dealer.class).isEmpty()) {
            biller = io.github.erp.web.rest.DealerResourceIT.createEntity(em);
            em.persist(biller);
            em.flush();
        } else {
    ...
    void getAllSettlementRequisitionsByPaymentInvoiceIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, PaymentInvoice.class).isEmpty()) {
            paymentInvoice = io.github.erp.web.rest.PaymentInvoiceResourceIT.createEntity(em);
    ...
    void getAllSettlementRequisitionsByDeliveryNoteIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, DeliveryNote.class).isEmpty()) {
            deliveryNote = io.github.erp.web.rest.DeliveryNoteResourceIT.createEntity(em);
    ...
    void getAllSettlementRequisitionsByJobSheetIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, JobSheet.class).isEmpty()) {
            jobSheet = io.github.erp.web.rest.JobSheetResourceIT.createEntity(em);
            em.persist(jobSheet);
            em.flush();
        } else {
    ...
    void getAllSettlementRequisitionsBySignaturesIsEqualToSomething() throws Exception {
        ...
        Dealer signatures;
        if (TestUtil.findAll(em, Dealer.class).isEmpty()) {
            signatures = io.github.erp.web.rest.DealerResourceIT.createEntity(em);
    ...
    void getAllSettlementRequisitionsByApplicationMappingIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, UniversallyUniqueMapping.class).isEmpty()) {
            applicationMapping = io.github.erp.web.rest.UniversallyUniqueMappingResourceIT.createEntity(em);
