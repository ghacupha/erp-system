...
/**
 * Integration tests for the {@link PaymentLabelResourceDev} REST controller.
 */
@IntegrationTest
...
public class PaymentLabelResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/payment-labels";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/payment-labels";
