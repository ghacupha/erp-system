...
class CrbReportViewBandResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/crb-report-view-bands";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/crb-report-view-bands";
    ...
    void getAllCrbReportViewBands() throws Exception {
        ...
        restCrbReportViewBandMockMvc
            ...
            .andExpect(jsonPath("$.[*].reportViewCategoryDescription").value(hasItem(DEFAULT_REPORT_VIEW_CATEGORY_DESCRIPTION)));
    }
    ...
    void getCrbReportViewBand() throws Exception {
        ...
        restCrbReportViewBandMockMvc
            ...
            .andExpect(jsonPath("$.reportViewCategoryDescription").value(DEFAULT_REPORT_VIEW_CATEGORY_DESCRIPTION));
    }
