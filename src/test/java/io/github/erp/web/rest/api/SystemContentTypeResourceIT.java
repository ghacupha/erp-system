...
/**
 * Integration tests for the {@link SystemContentTypeResourceDev} REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser(roles = {"DEV"})
public class SystemContentTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev-test/system-content-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev-test/_search/system-content-types";
