...
class MemoActionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/memo-actions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/memo-actions";
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamMemoAction() throws Exception {
        int databaseSizeBeforeUpdate = memoActionRepository.findAll().size();
        memoAction.setId(count.incrementAndGet());
    ...
    @Test
    @Transactional
    void patchWithMissingIdPathParamMemoAction() throws Exception {
        int databaseSizeBeforeUpdate = memoActionRepository.findAll().size();
        memoAction.setId(count.incrementAndGet());
