...
public class ReportRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/report-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/report-requisitions";
