...
@WithMockUser
class CustomerIDDocumentTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/customer-id-document-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/customer-id-document-types";
