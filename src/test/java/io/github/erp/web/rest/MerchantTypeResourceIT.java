...
class MerchantTypeResourceIT {
    ...
    void getAllMerchantTypes() throws Exception {
        ...
        restMerchantTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].merchantTypeDetails").value(hasItem(DEFAULT_MERCHANT_TYPE_DETAILS)));
    }
    ...
    void getMerchantType() throws Exception {
        ...
        restMerchantTypeMockMvc
            ...
            .andExpect(jsonPath("$.merchantTypeDetails").value(DEFAULT_MERCHANT_TYPE_DETAILS));
    }
