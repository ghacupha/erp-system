...
/**
 * Integration tests for the {@link SecurityClearanceResourceDev} REST controller.
 */
@IntegrationTest
...
public class SecurityClearanceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/security-clearances";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/security-clearances";
