...
/**
 * Integration tests for the {@link LeaseLiabilityScheduleReportResource} REST controller.
 */
@IntegrationTest
...
class LeaseLiabilityScheduleReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/lease-liability-schedule-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/lease-liability-schedule-reports";
