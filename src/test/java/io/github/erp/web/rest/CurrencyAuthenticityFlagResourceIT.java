...
class CurrencyAuthenticityFlagResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/currency-authenticity-flags";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/currency-authenticity-flags";
    ...
    void getAllCurrencyAuthenticityFlags() throws Exception {
        ...
        restCurrencyAuthenticityFlagMockMvc
            ...
            .andExpect(
                jsonPath("$.[*].currencyAuthenticityTypeDetails").value(hasItem(DEFAULT_CURRENCY_AUTHENTICITY_TYPE_DETAILS))
            );
    }
    ...
    void getCurrencyAuthenticityFlag() throws Exception {
        ...
        restCurrencyAuthenticityFlagMockMvc
            ...
            .andExpect(jsonPath("$.currencyAuthenticityTypeDetails").value(DEFAULT_CURRENCY_AUTHENTICITY_TYPE_DETAILS));
    }
