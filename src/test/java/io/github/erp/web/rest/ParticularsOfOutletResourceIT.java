...
/**
 * Integration tests for the {@link ParticularsOfOutletResource} REST controller.
 */
@IntegrationTest
...
class ParticularsOfOutletResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/particulars-of-outlets";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/particulars-of-outlets";
