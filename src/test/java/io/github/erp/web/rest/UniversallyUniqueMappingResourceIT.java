...
class UniversallyUniqueMappingResourceIT {
    ...
    void getAllUniversallyUniqueMappingsByUniversalKeyIsEqualToSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("universalKey.equals=" + DEFAULT_UNIVERSAL_KEY);

        // Get all the universallyUniqueMappingList where universalKey equals to UPDATED_UNIVERSAL_KEY
        defaultUniversallyUniqueMappingShouldNotBeFound("universalKey.equals=" + UPDATED_UNIVERSAL_KEY);
    }
    ...
    void getAllUniversallyUniqueMappingsByUniversalKeyIsNotEqualToSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldNotBeFound("universalKey.notEquals=" + DEFAULT_UNIVERSAL_KEY);

        // Get all the universallyUniqueMappingList where universalKey not equals to UPDATED_UNIVERSAL_KEY
        defaultUniversallyUniqueMappingShouldBeFound("universalKey.notEquals=" + UPDATED_UNIVERSAL_KEY);
    }
    ...
    void getAllUniversallyUniqueMappingsByUniversalKeyIsInShouldWork() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("universalKey.in=" + DEFAULT_UNIVERSAL_KEY + "," + UPDATED_UNIVERSAL_KEY);

        // Get all the universallyUniqueMappingList where universalKey equals to UPDATED_UNIVERSAL_KEY
        defaultUniversallyUniqueMappingShouldNotBeFound("universalKey.in=" + UPDATED_UNIVERSAL_KEY);
    }
    ...
    void getAllUniversallyUniqueMappingsByUniversalKeyIsNullOrNotNull() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("universalKey.specified=true");

        // Get all the universallyUniqueMappingList where universalKey is null
        defaultUniversallyUniqueMappingShouldNotBeFound("universalKey.specified=false");
    }
    ...
    void getAllUniversallyUniqueMappingsByUniversalKeyContainsSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("universalKey.contains=" + DEFAULT_UNIVERSAL_KEY);

        // Get all the universallyUniqueMappingList where universalKey contains UPDATED_UNIVERSAL_KEY
        defaultUniversallyUniqueMappingShouldNotBeFound("universalKey.contains=" + UPDATED_UNIVERSAL_KEY);
    }
    ...
    void getAllUniversallyUniqueMappingsByUniversalKeyNotContainsSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldNotBeFound("universalKey.doesNotContain=" + DEFAULT_UNIVERSAL_KEY);

        // Get all the universallyUniqueMappingList where universalKey does not contain UPDATED_UNIVERSAL_KEY
        defaultUniversallyUniqueMappingShouldBeFound("universalKey.doesNotContain=" + UPDATED_UNIVERSAL_KEY);
    }
    ...
    void getAllUniversallyUniqueMappingsByMappedValueIsEqualToSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("mappedValue.equals=" + DEFAULT_MAPPED_VALUE);

        // Get all the universallyUniqueMappingList where mappedValue equals to UPDATED_MAPPED_VALUE
        defaultUniversallyUniqueMappingShouldNotBeFound("mappedValue.equals=" + UPDATED_MAPPED_VALUE);
    }
    ...
    void getAllUniversallyUniqueMappingsByMappedValueIsNotEqualToSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldNotBeFound("mappedValue.notEquals=" + DEFAULT_MAPPED_VALUE);

        // Get all the universallyUniqueMappingList where mappedValue not equals to UPDATED_MAPPED_VALUE
        defaultUniversallyUniqueMappingShouldBeFound("mappedValue.notEquals=" + UPDATED_MAPPED_VALUE);
    }
    ...
    void getAllUniversallyUniqueMappingsByMappedValueIsInShouldWork() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("mappedValue.in=" + DEFAULT_MAPPED_VALUE + "," + UPDATED_MAPPED_VALUE);

        // Get all the universallyUniqueMappingList where mappedValue equals to UPDATED_MAPPED_VALUE
        defaultUniversallyUniqueMappingShouldNotBeFound("mappedValue.in=" + UPDATED_MAPPED_VALUE);
    }
    ...
    void getAllUniversallyUniqueMappingsByMappedValueIsNullOrNotNull() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("mappedValue.specified=true");

        // Get all the universallyUniqueMappingList where mappedValue is null
        defaultUniversallyUniqueMappingShouldNotBeFound("mappedValue.specified=false");
    }
    ...
    void getAllUniversallyUniqueMappingsByMappedValueContainsSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldBeFound("mappedValue.contains=" + DEFAULT_MAPPED_VALUE);

        // Get all the universallyUniqueMappingList where mappedValue contains UPDATED_MAPPED_VALUE
        defaultUniversallyUniqueMappingShouldNotBeFound("mappedValue.contains=" + UPDATED_MAPPED_VALUE);
    }
    ...
    void getAllUniversallyUniqueMappingsByMappedValueNotContainsSomething() throws Exception {
        ...
        defaultUniversallyUniqueMappingShouldNotBeFound("mappedValue.doesNotContain=" + DEFAULT_MAPPED_VALUE);
