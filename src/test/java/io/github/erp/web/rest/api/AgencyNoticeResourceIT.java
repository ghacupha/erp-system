...
/**
 * Integration tests for the {@link AgencyNoticeResourceDev} REST controller.
 */
@IntegrationTest
...
public class AgencyNoticeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/agency-notices";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/agency-notices";
