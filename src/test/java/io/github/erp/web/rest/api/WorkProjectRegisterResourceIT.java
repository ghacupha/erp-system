...
/**
 * Integration tests for the WorkProjectRegisterResource REST controller.
 */
@IntegrationTest
...
public class WorkProjectRegisterResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/work-project-registers";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/work-project-registers";
