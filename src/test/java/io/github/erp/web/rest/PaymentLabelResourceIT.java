...
class PaymentLabelResourceIT {
    ...
    void createPaymentLabel() throws Exception {
        ...
        assertThat(testPaymentLabel.getRemarks()).isEqualTo(DEFAULT_REMARKS);
    ...
    void putNewPaymentLabel() throws Exception {
        ...
        assertThat(testPaymentLabel.getRemarks()).isEqualTo(UPDATED_REMARKS);
    ...
    void partialUpdatePaymentLabelWithPatch() throws Exception {
        ...
        partialUpdatedPaymentLabel.description(UPDATED_DESCRIPTION).fileUploadToken(UPDATED_FILE_UPLOAD_TOKEN).remarks(UPDATED_REMARKS);
