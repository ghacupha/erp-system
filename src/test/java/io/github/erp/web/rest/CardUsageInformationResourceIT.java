...
/**
 * Integration tests for the {@link CardUsageInformationResource} REST controller.
 */
@IntegrationTest
...
class CardUsageInformationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/card-usage-informations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/card-usage-informations";
