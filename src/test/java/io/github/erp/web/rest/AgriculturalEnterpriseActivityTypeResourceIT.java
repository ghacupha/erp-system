...
class AgriculturalEnterpriseActivityTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/agricultural-enterprise-activity-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/agricultural-enterprise-activity-types";
        ...
        restAgriculturalEnterpriseActivityTypeMockMvc
            ...
            .andExpect(
                jsonPath("$.[*].agriculturalEnterpriseActivityTypeDescription")
                    .value(hasItem(DEFAULT_AGRICULTURAL_ENTERPRISE_ACTIVITY_TYPE_DESCRIPTION))
            );
    }
    ...
    void getAgriculturalEnterpriseActivityType() throws Exception {
        ...
        restAgriculturalEnterpriseActivityTypeMockMvc
            ...
            .andExpect(
                jsonPath("$.agriculturalEnterpriseActivityTypeDescription")
                    .value(DEFAULT_AGRICULTURAL_ENTERPRISE_ACTIVITY_TYPE_DESCRIPTION)
            );
    }
