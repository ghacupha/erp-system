...
class CrbCreditFacilityTypeResourceIT {
    ...
    void getAllCrbCreditFacilityTypes() throws Exception {
        ...
        restCrbCreditFacilityTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].creditFacilityDescription").value(hasItem(DEFAULT_CREDIT_FACILITY_DESCRIPTION)));
    }
    ...
    void getCrbCreditFacilityType() throws Exception {
        ...
        restCrbCreditFacilityTypeMockMvc
            ...
            .andExpect(jsonPath("$.creditFacilityDescription").value(DEFAULT_CREDIT_FACILITY_DESCRIPTION));
    }
