...
class DepartmentTypeResourceIT {
    ...
    void getAllDepartmentTypes() throws Exception {
        ...
        restDepartmentTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].departmentTypeDetails").value(hasItem(DEFAULT_DEPARTMENT_TYPE_DETAILS)));
    }
    ...
    void getDepartmentType() throws Exception {
        ...
        restDepartmentTypeMockMvc
            ...
            .andExpect(jsonPath("$.departmentTypeDetails").value(DEFAULT_DEPARTMENT_TYPE_DETAILS));
    }
