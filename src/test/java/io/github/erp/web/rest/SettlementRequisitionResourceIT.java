...
class SettlementRequisitionResourceIT {
    ...
    void createSettlementRequisition() throws Exception {
        ...
        assertThat(testSettlementRequisition.getTransactionId()).isEqualTo(DEFAULT_TRANSACTION_ID);
        assertThat(testSettlementRequisition.getTransactionDate()).isEqualTo(DEFAULT_TRANSACTION_DATE);
    ...
    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionIdIsEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionId equals to DEFAULT_TRANSACTION_ID
        defaultSettlementRequisitionShouldBeFound("transactionId.equals=" + DEFAULT_TRANSACTION_ID);

        // Get all the settlementRequisitionList where transactionId equals to UPDATED_TRANSACTION_ID
        defaultSettlementRequisitionShouldNotBeFound("transactionId.equals=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionId not equals to DEFAULT_TRANSACTION_ID
        defaultSettlementRequisitionShouldNotBeFound("transactionId.notEquals=" + DEFAULT_TRANSACTION_ID);

        // Get all the settlementRequisitionList where transactionId not equals to UPDATED_TRANSACTION_ID
        defaultSettlementRequisitionShouldBeFound("transactionId.notEquals=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionIdIsInShouldWork() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionId in DEFAULT_TRANSACTION_ID or UPDATED_TRANSACTION_ID
        defaultSettlementRequisitionShouldBeFound("transactionId.in=" + DEFAULT_TRANSACTION_ID + "," + UPDATED_TRANSACTION_ID);

        // Get all the settlementRequisitionList where transactionId equals to UPDATED_TRANSACTION_ID
        defaultSettlementRequisitionShouldNotBeFound("transactionId.in=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionId is not null
        defaultSettlementRequisitionShouldBeFound("transactionId.specified=true");

        // Get all the settlementRequisitionList where transactionId is null
        defaultSettlementRequisitionShouldNotBeFound("transactionId.specified=false");
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionIdContainsSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionId contains DEFAULT_TRANSACTION_ID
        defaultSettlementRequisitionShouldBeFound("transactionId.contains=" + DEFAULT_TRANSACTION_ID);

        // Get all the settlementRequisitionList where transactionId contains UPDATED_TRANSACTION_ID
        defaultSettlementRequisitionShouldNotBeFound("transactionId.contains=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionIdNotContainsSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionId does not contain DEFAULT_TRANSACTION_ID
        defaultSettlementRequisitionShouldNotBeFound("transactionId.doesNotContain=" + DEFAULT_TRANSACTION_ID);

        // Get all the settlementRequisitionList where transactionId does not contain UPDATED_TRANSACTION_ID
        defaultSettlementRequisitionShouldBeFound("transactionId.doesNotContain=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate equals to DEFAULT_TRANSACTION_DATE
        defaultSettlementRequisitionShouldBeFound("transactionDate.equals=" + DEFAULT_TRANSACTION_DATE);

        // Get all the settlementRequisitionList where transactionDate equals to UPDATED_TRANSACTION_DATE
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.equals=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate not equals to DEFAULT_TRANSACTION_DATE
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.notEquals=" + DEFAULT_TRANSACTION_DATE);

        // Get all the settlementRequisitionList where transactionDate not equals to UPDATED_TRANSACTION_DATE
        defaultSettlementRequisitionShouldBeFound("transactionDate.notEquals=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsInShouldWork() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate in DEFAULT_TRANSACTION_DATE or UPDATED_TRANSACTION_DATE
        defaultSettlementRequisitionShouldBeFound("transactionDate.in=" + DEFAULT_TRANSACTION_DATE + "," + UPDATED_TRANSACTION_DATE);

        // Get all the settlementRequisitionList where transactionDate equals to UPDATED_TRANSACTION_DATE
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.in=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate is not null
        defaultSettlementRequisitionShouldBeFound("transactionDate.specified=true");

        // Get all the settlementRequisitionList where transactionDate is null
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.specified=false");
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate is greater than or equal to DEFAULT_TRANSACTION_DATE
        defaultSettlementRequisitionShouldBeFound("transactionDate.greaterThanOrEqual=" + DEFAULT_TRANSACTION_DATE);

        // Get all the settlementRequisitionList where transactionDate is greater than or equal to UPDATED_TRANSACTION_DATE
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.greaterThanOrEqual=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate is less than or equal to DEFAULT_TRANSACTION_DATE
        defaultSettlementRequisitionShouldBeFound("transactionDate.lessThanOrEqual=" + DEFAULT_TRANSACTION_DATE);

        // Get all the settlementRequisitionList where transactionDate is less than or equal to SMALLER_TRANSACTION_DATE
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.lessThanOrEqual=" + SMALLER_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsLessThanSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate is less than DEFAULT_TRANSACTION_DATE
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.lessThan=" + DEFAULT_TRANSACTION_DATE);

        // Get all the settlementRequisitionList where transactionDate is less than UPDATED_TRANSACTION_DATE
        defaultSettlementRequisitionShouldBeFound("transactionDate.lessThan=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByTransactionDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where transactionDate is greater than DEFAULT_TRANSACTION_DATE
        defaultSettlementRequisitionShouldNotBeFound("transactionDate.greaterThan=" + DEFAULT_TRANSACTION_DATE);

        // Get all the settlementRequisitionList where transactionDate is greater than SMALLER_TRANSACTION_DATE
        defaultSettlementRequisitionShouldBeFound("transactionDate.greaterThan=" + SMALLER_TRANSACTION_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllSettlementRequisitionsBySettlementIsEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);
        ...
        em.persist(settlement);
        em.flush();
        settlementRequisition.addSettlement(settlement);
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);
        Long settlementId = settlement.getId();

        // Get all the settlementRequisitionList where settlement equals to settlementId
        defaultSettlementRequisitionShouldBeFound("settlementId.equals=" + settlementId);

        // Get all the settlementRequisitionList where settlement equals to (settlementId + 1)
        defaultSettlementRequisitionShouldNotBeFound("settlementId.equals=" + (settlementId + 1));
    }
    ...
    void putNewSettlementRequisition() throws Exception {
        ...
        assertThat(testSettlementRequisition.getTransactionId()).isEqualTo(UPDATED_TRANSACTION_ID);
        assertThat(testSettlementRequisition.getTransactionDate()).isEqualTo(UPDATED_TRANSACTION_DATE);
