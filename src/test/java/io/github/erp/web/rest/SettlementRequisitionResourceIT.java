...
public class SettlementRequisitionResourceIT {
    ...
    void createSettlementRequisition() throws Exception {
        ...
        assertThat(testSettlementRequisition.getRemarks()).isEqualTo(DEFAULT_REMARKS);
    ...
    @Test
    @Transactional
    void getAllSettlementRequisitionsByRemarksIsEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where remarks equals to DEFAULT_REMARKS
        defaultSettlementRequisitionShouldBeFound("remarks.equals=" + DEFAULT_REMARKS);

        // Get all the settlementRequisitionList where remarks equals to UPDATED_REMARKS
        defaultSettlementRequisitionShouldNotBeFound("remarks.equals=" + UPDATED_REMARKS);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByRemarksIsNotEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where remarks not equals to DEFAULT_REMARKS
        defaultSettlementRequisitionShouldNotBeFound("remarks.notEquals=" + DEFAULT_REMARKS);

        // Get all the settlementRequisitionList where remarks not equals to UPDATED_REMARKS
        defaultSettlementRequisitionShouldBeFound("remarks.notEquals=" + UPDATED_REMARKS);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByRemarksIsInShouldWork() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where remarks in DEFAULT_REMARKS or UPDATED_REMARKS
        defaultSettlementRequisitionShouldBeFound("remarks.in=" + DEFAULT_REMARKS + "," + UPDATED_REMARKS);

        // Get all the settlementRequisitionList where remarks equals to UPDATED_REMARKS
        defaultSettlementRequisitionShouldNotBeFound("remarks.in=" + UPDATED_REMARKS);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByRemarksIsNullOrNotNull() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where remarks is not null
        defaultSettlementRequisitionShouldBeFound("remarks.specified=true");

        // Get all the settlementRequisitionList where remarks is null
        defaultSettlementRequisitionShouldNotBeFound("remarks.specified=false");
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByRemarksContainsSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where remarks contains DEFAULT_REMARKS
        defaultSettlementRequisitionShouldBeFound("remarks.contains=" + DEFAULT_REMARKS);

        // Get all the settlementRequisitionList where remarks contains UPDATED_REMARKS
        defaultSettlementRequisitionShouldNotBeFound("remarks.contains=" + UPDATED_REMARKS);
    }

    @Test
    @Transactional
    void getAllSettlementRequisitionsByRemarksNotContainsSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);

        // Get all the settlementRequisitionList where remarks does not contain DEFAULT_REMARKS
        defaultSettlementRequisitionShouldNotBeFound("remarks.doesNotContain=" + DEFAULT_REMARKS);

        // Get all the settlementRequisitionList where remarks does not contain UPDATED_REMARKS
        defaultSettlementRequisitionShouldBeFound("remarks.doesNotContain=" + UPDATED_REMARKS);
    }
    ...
    @Test
    @Transactional
    void getAllSettlementRequisitionsByOtherBeneficiariesIsEqualToSomething() throws Exception {
        // Initialize the database
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);
        Dealer otherBeneficiaries;
        if (TestUtil.findAll(em, Dealer.class).isEmpty()) {
            otherBeneficiaries = DealerResourceIT.createEntity(em);
            em.persist(otherBeneficiaries);
            em.flush();
        } else {
            otherBeneficiaries = TestUtil.findAll(em, Dealer.class).get(0);
        }
        em.persist(otherBeneficiaries);
        em.flush();
        settlementRequisition.addOtherBeneficiaries(otherBeneficiaries);
        settlementRequisitionRepository.saveAndFlush(settlementRequisition);
        Long otherBeneficiariesId = otherBeneficiaries.getId();

        // Get all the settlementRequisitionList where otherBeneficiaries equals to otherBeneficiariesId
        defaultSettlementRequisitionShouldBeFound("otherBeneficiariesId.equals=" + otherBeneficiariesId);

        // Get all the settlementRequisitionList where otherBeneficiaries equals to (otherBeneficiariesId + 1)
        defaultSettlementRequisitionShouldNotBeFound("otherBeneficiariesId.equals=" + (otherBeneficiariesId + 1));
    }
    ...
    void putNewSettlementRequisition() throws Exception {
        ...
        assertThat(testSettlementRequisition.getRemarks()).isEqualTo(UPDATED_REMARKS);
