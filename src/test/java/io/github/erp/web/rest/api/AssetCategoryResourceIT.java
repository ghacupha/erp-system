...
class AssetCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/dev/asset-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/dev/_search/asset-categories";
