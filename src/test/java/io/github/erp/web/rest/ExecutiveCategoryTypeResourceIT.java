...
class ExecutiveCategoryTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/executive-category-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/executive-category-types";
    ...
    void getAllExecutiveCategoryTypes() throws Exception {
        ...
        restExecutiveCategoryTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].directorCategoryTypeDetails").value(hasItem(DEFAULT_DIRECTOR_CATEGORY_TYPE_DETAILS)));
    }
    ...
    void getExecutiveCategoryType() throws Exception {
        ...
        restExecutiveCategoryTypeMockMvc
            ...
            .andExpect(jsonPath("$.directorCategoryTypeDetails").value(DEFAULT_DIRECTOR_CATEGORY_TYPE_DETAILS));
    }
