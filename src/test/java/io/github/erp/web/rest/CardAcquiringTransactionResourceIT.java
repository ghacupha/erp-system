...
/**
 * Integration tests for the {@link CardAcquiringTransactionResource} REST controller.
 */
@IntegrationTest
...
class CardAcquiringTransactionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/card-acquiring-transactions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/card-acquiring-transactions";
