...
/**
 * Integration tests for the {@link PaymentRequisitionResourceDev} REST controller.
 */
@IntegrationTest
...
public class PaymentRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/payment-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/payment-requisitions";
