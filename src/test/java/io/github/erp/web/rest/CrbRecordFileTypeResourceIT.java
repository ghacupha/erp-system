...
class CrbRecordFileTypeResourceIT {
    ...
    void getAllCrbRecordFileTypes() throws Exception {
        ...
        restCrbRecordFileTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].recordFileTypeDetails").value(hasItem(DEFAULT_RECORD_FILE_TYPE_DETAILS)));
    }
    ...
    void getCrbRecordFileType() throws Exception {
        ...
        restCrbRecordFileTypeMockMvc
            ...
            .andExpect(jsonPath("$.recordFileTypeDetails").value(DEFAULT_RECORD_FILE_TYPE_DETAILS));
    }
