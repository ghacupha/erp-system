...
/**
 * Integration tests for the {@link FileUploadResourceDev} REST controller.
 */
@IntegrationTest
...
public class FileUploadResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/file-uploads";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/file-uploads";
