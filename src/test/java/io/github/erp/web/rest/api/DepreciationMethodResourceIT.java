...
public class DepreciationMethodResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/depreciation-methods";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/depreciation-methods";
    ...
    void createDepreciationMethod() throws Exception {
        ...
        assertThat(testDepreciationMethod.getRemarks()).isEqualTo(DEFAULT_REMARKS);
    ...
    void putNewDepreciationMethod() throws Exception {
        ...
        assertThat(testDepreciationMethod.getRemarks()).isEqualTo(UPDATED_REMARKS);
