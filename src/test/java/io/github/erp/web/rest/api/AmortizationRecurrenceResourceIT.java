...
/**
 * Integration tests for the AmortizationRecurrenceResource REST controller.
 */
@IntegrationTest
@ExtendWith(MockitoExtension.class)
@AutoConfigureMockMvc
@WithMockUser(roles = {"DEV"})
class AmortizationRecurrenceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/amortization-recurrences";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/amortization-recurrences";
