...
public class AssetRegistrationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/asset-registrations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/asset-registrations";
