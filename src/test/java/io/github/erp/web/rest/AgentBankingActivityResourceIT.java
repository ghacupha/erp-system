...
/**
 * Integration tests for the {@link AgentBankingActivityResource} REST controller.
 */
@IntegrationTest
...
class AgentBankingActivityResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/agent-banking-activities";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/agent-banking-activities";
