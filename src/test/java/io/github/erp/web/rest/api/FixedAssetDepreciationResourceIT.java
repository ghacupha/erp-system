...
/**
 * Integration tests for the {@link FixedAssetDepreciationResourceDev} REST controller.
 */
@IntegrationTest
...
public class FixedAssetDepreciationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/fixed-asset-depreciations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/fixed-asset-depreciations";
