...
class XlsxReportRequisitionResourceIT {
    ...
    void createXlsxReportRequisition() throws Exception {
        ...
        assertThat(testXlsxReportRequisition.getReportFileChecksum()).isEqualTo(DEFAULT_REPORT_FILE_CHECKSUM);
    ...
    @Test
    @Transactional
    void getAllXlsxReportRequisitionsByReportFileChecksumIsEqualToSomething() throws Exception {
        // Initialize the database
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);

        // Get all the xlsxReportRequisitionList where reportFileChecksum equals to DEFAULT_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldBeFound("reportFileChecksum.equals=" + DEFAULT_REPORT_FILE_CHECKSUM);

        // Get all the xlsxReportRequisitionList where reportFileChecksum equals to UPDATED_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldNotBeFound("reportFileChecksum.equals=" + UPDATED_REPORT_FILE_CHECKSUM);
    }

    @Test
    @Transactional
    void getAllXlsxReportRequisitionsByReportFileChecksumIsNotEqualToSomething() throws Exception {
        // Initialize the database
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);

        // Get all the xlsxReportRequisitionList where reportFileChecksum not equals to DEFAULT_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldNotBeFound("reportFileChecksum.notEquals=" + DEFAULT_REPORT_FILE_CHECKSUM);

        // Get all the xlsxReportRequisitionList where reportFileChecksum not equals to UPDATED_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldBeFound("reportFileChecksum.notEquals=" + UPDATED_REPORT_FILE_CHECKSUM);
    }

    @Test
    @Transactional
    void getAllXlsxReportRequisitionsByReportFileChecksumIsInShouldWork() throws Exception {
        // Initialize the database
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);

        // Get all the xlsxReportRequisitionList where reportFileChecksum in DEFAULT_REPORT_FILE_CHECKSUM or UPDATED_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldBeFound(
            "reportFileChecksum.in=" + DEFAULT_REPORT_FILE_CHECKSUM + "," + UPDATED_REPORT_FILE_CHECKSUM
        );

        // Get all the xlsxReportRequisitionList where reportFileChecksum equals to UPDATED_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldNotBeFound("reportFileChecksum.in=" + UPDATED_REPORT_FILE_CHECKSUM);
    }

    @Test
    @Transactional
    void getAllXlsxReportRequisitionsByReportFileChecksumIsNullOrNotNull() throws Exception {
        // Initialize the database
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);

        // Get all the xlsxReportRequisitionList where reportFileChecksum is not null
        defaultXlsxReportRequisitionShouldBeFound("reportFileChecksum.specified=true");

        // Get all the xlsxReportRequisitionList where reportFileChecksum is null
        defaultXlsxReportRequisitionShouldNotBeFound("reportFileChecksum.specified=false");
    }

    @Test
    @Transactional
    void getAllXlsxReportRequisitionsByReportFileChecksumContainsSomething() throws Exception {
        // Initialize the database
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);

        // Get all the xlsxReportRequisitionList where reportFileChecksum contains DEFAULT_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldBeFound("reportFileChecksum.contains=" + DEFAULT_REPORT_FILE_CHECKSUM);

        // Get all the xlsxReportRequisitionList where reportFileChecksum contains UPDATED_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldNotBeFound("reportFileChecksum.contains=" + UPDATED_REPORT_FILE_CHECKSUM);
    }

    @Test
    @Transactional
    void getAllXlsxReportRequisitionsByReportFileChecksumNotContainsSomething() throws Exception {
        // Initialize the database
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);

        // Get all the xlsxReportRequisitionList where reportFileChecksum does not contain DEFAULT_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldNotBeFound("reportFileChecksum.doesNotContain=" + DEFAULT_REPORT_FILE_CHECKSUM);

        // Get all the xlsxReportRequisitionList where reportFileChecksum does not contain UPDATED_REPORT_FILE_CHECKSUM
        defaultXlsxReportRequisitionShouldBeFound("reportFileChecksum.doesNotContain=" + UPDATED_REPORT_FILE_CHECKSUM);
    }
    ...
    @Test
    @Transactional
    void getAllXlsxReportRequisitionsByParametersIsEqualToSomething() throws Exception {
        // Initialize the database
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);
        ...
        em.persist(parameters);
        em.flush();
        xlsxReportRequisition.addParameters(parameters);
        xlsxReportRequisitionRepository.saveAndFlush(xlsxReportRequisition);
        Long parametersId = parameters.getId();

        // Get all the xlsxReportRequisitionList where parameters equals to parametersId
        defaultXlsxReportRequisitionShouldBeFound("parametersId.equals=" + parametersId);

        // Get all the xlsxReportRequisitionList where parameters equals to (parametersId + 1)
        defaultXlsxReportRequisitionShouldNotBeFound("parametersId.equals=" + (parametersId + 1));
    }
    ...
    void putNewXlsxReportRequisition() throws Exception {
        ...
        assertThat(testXlsxReportRequisition.getReportFileChecksum()).isEqualTo(UPDATED_REPORT_FILE_CHECKSUM);
