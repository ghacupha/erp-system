...
/**
 * Integration tests for the {@link PerformanceOfForeignSubsidiariesResource} REST controller.
 */
@IntegrationTest
...
class PerformanceOfForeignSubsidiariesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/performance-of-foreign-subsidiaries";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/performance-of-foreign-subsidiaries";
