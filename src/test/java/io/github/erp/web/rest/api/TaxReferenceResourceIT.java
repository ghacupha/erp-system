...
/**
 * Integration tests for the {@link TaxReferenceResourceDev} REST controller.
 */
@IntegrationTest
...
public class TaxReferenceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/tax-references";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/tax-references";
