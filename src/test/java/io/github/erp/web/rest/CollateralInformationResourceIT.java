...
/**
 * Integration tests for the {@link CollateralInformationResource} REST controller.
 */
@IntegrationTest
...
class CollateralInformationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/collateral-informations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/collateral-informations";
