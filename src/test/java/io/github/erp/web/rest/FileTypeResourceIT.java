...
class FileTypeResourceIT {
    ...
    void createFileType() throws Exception {
        ...
        // Create the FileType
        restFileTypeMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(fileType)))
    ...
    void putNewFileType() throws Exception {
        ...
        restFileTypeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedFileType.getId())
    ...
    void putNonExistingFileType() throws Exception {
        ...
        restFileTypeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, fileType.getId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void putWithMissingIdPathParamFileType() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFileTypeMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(fileType)))
    ...
    void patchNonExistingFileType() throws Exception {
        ...
        restFileTypeMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, fileType.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(fileType))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamFileType() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFileTypeMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(fileType)))
            .andExpect(status().isMethodNotAllowed());
