...
/**
 * Integration tests for the {@link PaymentCategoryResourceDev} REST controller.
 */
@IntegrationTest
...
public class PaymentCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/payment-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/payment-categories";
