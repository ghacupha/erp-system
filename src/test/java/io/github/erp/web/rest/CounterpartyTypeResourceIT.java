...
class CounterpartyTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/counterparty-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/counterparty-types";
    ...
    void getAllCounterpartyTypes() throws Exception {
        ...
        restCounterpartyTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].counterpartyTypeDescription").value(hasItem(DEFAULT_COUNTERPARTY_TYPE_DESCRIPTION)));
    }
    ...
    void getCounterpartyType() throws Exception {
        ...
        restCounterpartyTypeMockMvc
            ...
            .andExpect(jsonPath("$.counterpartyTypeDescription").value(DEFAULT_COUNTERPARTY_TYPE_DESCRIPTION));
    }
