...
/**
 * Integration tests for the {@link ReportStatusResourceDev} REST controller.
 */
@IntegrationTest
...
class ReportStatusResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/dev/report-statuses";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/dev/_search/report-statuses";
