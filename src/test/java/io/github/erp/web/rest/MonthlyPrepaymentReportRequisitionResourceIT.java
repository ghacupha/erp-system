...
/**
 * Integration tests for the {@link MonthlyPrepaymentReportRequisitionResource} REST controller.
 */
@IntegrationTest
...
class MonthlyPrepaymentReportRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/monthly-prepayment-report-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/monthly-prepayment-report-requisitions";
