...
class CollateralTypeResourceIT {
    ...
    void getAllCollateralTypes() throws Exception {
        ...
        restCollateralTypeMockMvc
            ...
            .andExpect(jsonPath("$.[*].collateralTypeDescription").value(hasItem(DEFAULT_COLLATERAL_TYPE_DESCRIPTION)));
    }
    ...
    void getCollateralType() throws Exception {
        ...
        restCollateralTypeMockMvc
            ...
            .andExpect(jsonPath("$.collateralTypeDescription").value(DEFAULT_COLLATERAL_TYPE_DESCRIPTION));
    }
