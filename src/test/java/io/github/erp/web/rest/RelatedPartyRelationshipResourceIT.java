...
/**
 * Integration tests for the {@link RelatedPartyRelationshipResource} REST controller.
 */
@IntegrationTest
...
class RelatedPartyRelationshipResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/related-party-relationships";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/related-party-relationships";
