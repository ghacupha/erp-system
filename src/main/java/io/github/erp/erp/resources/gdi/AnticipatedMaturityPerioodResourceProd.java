...
public class AnticipatedMaturityPerioodResourceProd {

    private final Logger log = LoggerFactory.getLogger(AnticipatedMaturityPerioodResourceProd.class);
    ...
    public AnticipatedMaturityPerioodResourceProd(
