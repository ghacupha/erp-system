 ...
 */
@RestController("InstitutionStatusTypeResourceProd")
@RequestMapping("/api/granular-data")
public class InstitutionStatusTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(InstitutionStatusTypeResourceProd.class);
    ...
    public InstitutionStatusTypeResourceProd(
