 ...
 */
@RestController("pdfReportRequisitionResourceProd")
@RequestMapping("/api/app")
@RolesAllowed({"ROLE_REPORT_ACCESSOR", "ROLE_REPORT_DESIGNER", "ROLE_DEV"})
public class PdfReportRequisitionResourceProd {

    private final Logger log = LoggerFactory.getLogger(PdfReportRequisitionResourceProd.class);
    ...
    public PdfReportRequisitionResourceProd(
