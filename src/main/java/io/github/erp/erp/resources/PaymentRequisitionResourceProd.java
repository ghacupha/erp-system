 ...
 */
@RestController("PaymentRequisitionResourceProd")
@RequestMapping("/api/payments")
public class PaymentRequisitionResourceProd {

    private final Logger log = LoggerFactory.getLogger(PaymentRequisitionResourceProd.class);
    ...
    public PaymentRequisitionResourceProd(
    ...
    public ResponseEntity<PaymentRequisitionDTO> partialUpdatePaymentRequisition(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentRequisitionDTO.getId().toString())
        );
    }
