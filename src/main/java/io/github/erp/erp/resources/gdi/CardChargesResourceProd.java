 ...
 */
@RestController("CardChargesResourceProd")
@RequestMapping("/api/granular-data")
public class CardChargesResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardChargesResourceProd.class);
    ...
    public CardChargesResourceProd(
