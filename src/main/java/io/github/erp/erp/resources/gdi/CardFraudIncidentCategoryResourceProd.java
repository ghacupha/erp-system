 ...
 */
@RestController("CardFraudIncidentCategoryResourceProd")
@RequestMapping("/api/granular-data")
public class CardFraudIncidentCategoryResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardFraudIncidentCategoryResourceProd.class);
    ...
    public CardFraudIncidentCategoryResourceProd(
