...
public class AccountBalanceResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountBalanceResourceProd.class);
    ...
    public AccountBalanceResourceProd(
