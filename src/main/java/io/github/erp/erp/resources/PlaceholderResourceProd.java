 ...
 */
@RestController("placeholderResourceProd")
@RequestMapping("/api/app")
public class PlaceholderResourceProd {

    private final Logger log = LoggerFactory.getLogger(PlaceholderResourceProd.class);
    ...
    public PlaceholderResourceProd(
