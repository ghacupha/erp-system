...
/**
 * REST controller for managing {@link RouInitialDirectCost}.
 */
@RestController
@RequestMapping("/api/leases")
public class RouInitialDirectCostResourceProd {

    private final Logger log = LoggerFactory.getLogger(RouInitialDirectCostResourceProd.class);
    ...
    private final InternalRouInitialDirectCostService rouInitialDirectCostService;
    ...
    public RouInitialDirectCostResourceProd(
        InternalRouInitialDirectCostService rouInitialDirectCostService,
    ...
    public ResponseEntity<RouInitialDirectCostDTO> updateRouInitialDirectCost(
        ...
        RouInitialDirectCostDTO result = null;

        if (rouInitialDirectCostService.partialUpdate(rouInitialDirectCostDTO).isPresent()) {
            result = rouInitialDirectCostService.partialUpdate(rouInitialDirectCostDTO).get();
