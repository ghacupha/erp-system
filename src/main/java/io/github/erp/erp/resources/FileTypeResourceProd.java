 ...
 */
@RestController("fileTypeResourceProd")
@RequestMapping("/api/files")
public class FileTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(FileTypeResourceProd.class);
