 ...
 */
@RestController("LoanApplicationStatusResourceProd")
@RequestMapping("/api/granular-data")
public class LoanApplicationStatusResourceProd {

    private final Logger log = LoggerFactory.getLogger(LoanApplicationStatusResourceProd.class);
    ...
    public LoanApplicationStatusResourceProd(
