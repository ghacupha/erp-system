 ...
 */
@RestController("FxTransactionRateTypeResourceProd")
@RequestMapping("/api/granular-data")
public class FxTransactionRateTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(FxTransactionRateTypeResourceProd.class);
    ...
    public FxTransactionRateTypeResourceProd(
