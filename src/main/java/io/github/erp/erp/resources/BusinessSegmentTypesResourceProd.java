 ...
 */
@RestController("BusinessSegmentTypesResourceProd")
@RequestMapping("/api/granular-data")
public class BusinessSegmentTypesResourceProd {

    private final Logger log = LoggerFactory.getLogger(BusinessSegmentTypesResourceProd.class);
    ...
    public BusinessSegmentTypesResourceProd(
