...
public class CrbAgingBandsResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbAgingBandsResourceProd.class);
    ...
    public CrbAgingBandsResourceProd(
