 ...
 */
@RestController("businessStampResourceProd")
@RequestMapping("/api/payments")
public class BusinessStampResourceProd {

    private final Logger log = LoggerFactory.getLogger(BusinessStampResourceProd.class);
    ...
    public BusinessStampResourceProd(
