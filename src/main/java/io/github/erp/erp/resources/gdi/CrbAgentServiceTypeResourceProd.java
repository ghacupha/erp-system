...
public class CrbAgentServiceTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbAgentServiceTypeResourceProd.class);
    ...
    public CrbAgentServiceTypeResourceProd(
