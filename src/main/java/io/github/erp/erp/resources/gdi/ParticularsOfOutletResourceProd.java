...
public class ParticularsOfOutletResourceProd {

    private final Logger log = LoggerFactory.getLogger(ParticularsOfOutletResourceProd.class);
    ...
    public ParticularsOfOutletResourceProd(
