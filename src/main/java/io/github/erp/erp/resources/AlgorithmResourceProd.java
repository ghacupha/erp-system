 ...
 */
@RestController("AlgorithmResourceProd")
@RequestMapping("/api/app")
public class AlgorithmResourceProd {

    private final Logger log = LoggerFactory.getLogger(AlgorithmResourceProd.class);
    ...
    public ResponseEntity<AlgorithmDTO> updateAlgorithm(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, algorithmDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AlgorithmDTO> partialUpdateAlgorithm(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, algorithmDTO.getId().toString())
        );
    }
