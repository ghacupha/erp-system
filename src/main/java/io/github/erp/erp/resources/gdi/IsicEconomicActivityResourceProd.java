 ...
 */
@RestController("IsicEconomicActivityResourceProd")
@RequestMapping("/api/granular-data")
public class IsicEconomicActivityResourceProd {

    private final Logger log = LoggerFactory.getLogger(IsicEconomicActivityResourceProd.class);
    ...
    public IsicEconomicActivityResourceProd(
