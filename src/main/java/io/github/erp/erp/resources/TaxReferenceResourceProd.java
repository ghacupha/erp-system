 ...
 */
@RestController("TaxReferenceResourceProd")
@RequestMapping("/api/taxes")
public class TaxReferenceResourceProd {

    private final Logger log = LoggerFactory.getLogger(TaxReferenceResourceProd.class);
    ...
    public TaxReferenceResourceProd(
