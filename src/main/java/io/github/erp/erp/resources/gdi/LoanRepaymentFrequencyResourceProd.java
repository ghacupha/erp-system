 ...
 */
@RestController("LoanRepaymentFrequencyResourceProd")
@RequestMapping("/api/granular-data")
public class LoanRepaymentFrequencyResourceProd {

    private final Logger log = LoggerFactory.getLogger(LoanRepaymentFrequencyResourceProd.class);
    ...
    public LoanRepaymentFrequencyResourceProd(
