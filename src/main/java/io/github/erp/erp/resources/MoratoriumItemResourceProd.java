 ...
 */
@RestController("MoratoriumItemResourceProd")
@RequestMapping("/api/granular-data")
public class MoratoriumItemResourceProd {

    private final Logger log = LoggerFactory.getLogger(MoratoriumItemResourceProd.class);
    ...
    public MoratoriumItemResourceProd(
