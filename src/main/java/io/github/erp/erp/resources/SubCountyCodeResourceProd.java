 ...
 */
@RestController("SubCountyCodeResourceProd")
@RequestMapping("/api/granular-data")
public class SubCountyCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(SubCountyCodeResourceProd.class);
    ...
    public SubCountyCodeResourceProd(
