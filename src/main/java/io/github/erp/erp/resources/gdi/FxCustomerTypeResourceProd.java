 ...
 */
@RestController("FxCustomerTypeResourceProd")
@RequestMapping("/api/granular-data")
public class FxCustomerTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(FxCustomerTypeResourceProd.class);
    ...
    public FxCustomerTypeResourceProd(
