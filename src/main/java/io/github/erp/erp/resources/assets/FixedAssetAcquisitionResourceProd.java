 ...
 */
@RestController("fixedAssetAcquisitionResourceProd")
@RequestMapping("/api/fixed-asset")
public class FixedAssetAcquisitionResourceProd {

    private final Logger log = LoggerFactory.getLogger(FixedAssetAcquisitionResourceProd.class);
    ...
    public FixedAssetAcquisitionResourceProd(
