 ...
 */
@RestController("isoCountryCodeResourceProd")
@RequestMapping("/api/granular-data")
public class IsoCountryCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(IsoCountryCodeResourceProd.class);
    ...
    public IsoCountryCodeResourceProd(
    ...
    public ResponseEntity<IsoCountryCodeDTO> updateIsoCountryCode(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, isoCountryCodeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<IsoCountryCodeDTO> partialUpdateIsoCountryCode(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, isoCountryCodeDTO.getId().toString())
        );
    }
