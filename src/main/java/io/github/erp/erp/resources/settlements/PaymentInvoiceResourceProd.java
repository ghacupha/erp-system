 ...
 */
@RestController("paymentInvoiceResourceProd")
@RequestMapping("/api/payments")
public class PaymentInvoiceResourceProd {

    private final Logger log = LoggerFactory.getLogger(PaymentInvoiceResourceProd.class);
