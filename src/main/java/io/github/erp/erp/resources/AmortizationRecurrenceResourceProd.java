 ...
 */
@RestController("AmortizationRecurrenceResourceProd")
@RequestMapping("/api/prepayments")
public class AmortizationRecurrenceResourceProd {

    private final Logger log = LoggerFactory.getLogger(AmortizationRecurrenceResourceProd.class);
    ...
    public AmortizationRecurrenceResourceProd(
