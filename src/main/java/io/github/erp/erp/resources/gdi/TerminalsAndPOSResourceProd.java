...
public class TerminalsAndPOSResourceProd {

    private final Logger log = LoggerFactory.getLogger(TerminalsAndPOSResourceProd.class);
    ...
    public TerminalsAndPOSResourceProd(
