 ...
 */
@RestController("MerchantTypeResourceProd")
@RequestMapping("/api/granular-data")
public class MerchantTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(MerchantTypeResourceProd.class);
    ...
    public MerchantTypeResourceProd(
