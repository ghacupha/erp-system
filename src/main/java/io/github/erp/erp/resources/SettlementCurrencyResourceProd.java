 ...
 */
@RestController("settlementCurrencyResourceProd")
@RequestMapping("/api/app")
public class SettlementCurrencyResourceProd {

    private final Logger log = LoggerFactory.getLogger(SettlementCurrencyResourceProd.class);
    ...
    public SettlementCurrencyResourceProd(
    ...
    public ResponseEntity<SettlementCurrencyDTO> updateSettlementCurrency(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, settlementCurrencyDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SettlementCurrencyDTO> partialUpdateSettlementCurrency(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, settlementCurrencyDTO.getId().toString())
        );
    }
