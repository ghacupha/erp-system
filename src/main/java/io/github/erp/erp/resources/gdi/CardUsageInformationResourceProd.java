...
public class CardUsageInformationResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardUsageInformationResourceProd.class);
    ...
    public CardUsageInformationResourceProd(
