 ...
 */
@RestController("FileUploadResourceProd")
@RequestMapping("/api/files")
public class FileUploadResourceProd {

    private final Logger log = LoggerFactory.getLogger(FileUploadResourceProd.class);
