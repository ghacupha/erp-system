...
public class AccountAttributeResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountAttributeResourceProd.class);
    ...
    public AccountAttributeResourceProd(
