 ...
 */
@RestController("transactionAccountResourceProd")
@RequestMapping("/api/accounts")
public class TransactionAccountResourceProd {

    private final Logger log = LoggerFactory.getLogger(TransactionAccountResourceProd.class);
    ...
    public TransactionAccountResourceProd(
