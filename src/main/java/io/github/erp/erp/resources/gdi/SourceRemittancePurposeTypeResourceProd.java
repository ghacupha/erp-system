...
public class SourceRemittancePurposeTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(SourceRemittancePurposeTypeResourceProd.class);
    ...
    public SourceRemittancePurposeTypeResourceProd(
