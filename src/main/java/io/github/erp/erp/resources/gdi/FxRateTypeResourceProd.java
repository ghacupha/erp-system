 ...
 */
@RestController("FxRateTypeResourceProd")
@RequestMapping("/api/granular-data")
public class FxRateTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(FxRateTypeResourceProd.class);
