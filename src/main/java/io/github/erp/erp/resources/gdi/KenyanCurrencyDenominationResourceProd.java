...
public class KenyanCurrencyDenominationResourceProd {

    private final Logger log = LoggerFactory.getLogger(KenyanCurrencyDenominationResourceProd.class);
    ...
    public KenyanCurrencyDenominationResourceProd(
