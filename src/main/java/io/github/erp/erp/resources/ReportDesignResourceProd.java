 ...
 */
@RestController("reportDesignResourceProd")
@RequestMapping("/api/app")
public class ReportDesignResourceProd {

    private final Logger log = LoggerFactory.getLogger(ReportDesignResourceProd.class);
    ...
    public ReportDesignResourceProd(
    ...
    public ResponseEntity<ReportDesignDTO> updateReportDesign(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportDesignDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ReportDesignDTO> partialUpdateReportDesign(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportDesignDTO.getId().toString())
        );
    }
