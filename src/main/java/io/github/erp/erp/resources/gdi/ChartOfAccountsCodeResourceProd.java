 ...
 */
@RestController("ChartOfAccountsCodeResourceProd")
@RequestMapping("/api/granular-data")
public class ChartOfAccountsCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(ChartOfAccountsCodeResourceProd.class);
    ...
    public ChartOfAccountsCodeResourceProd(
