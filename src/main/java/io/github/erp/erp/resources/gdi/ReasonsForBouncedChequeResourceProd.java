...
public class ReasonsForBouncedChequeResourceProd {

    private final Logger log = LoggerFactory.getLogger(ReasonsForBouncedChequeResourceProd.class);
    ...
    public ReasonsForBouncedChequeResourceProd(
