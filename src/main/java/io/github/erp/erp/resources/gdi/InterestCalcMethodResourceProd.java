...
public class InterestCalcMethodResourceProd {

    private final Logger log = LoggerFactory.getLogger(InterestCalcMethodResourceProd.class);
    ...
    public InterestCalcMethodResourceProd(
