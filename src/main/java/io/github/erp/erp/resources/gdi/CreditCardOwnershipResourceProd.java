...
public class CreditCardOwnershipResourceProd {

    private final Logger log = LoggerFactory.getLogger(CreditCardOwnershipResourceProd.class);
    ...
    public CreditCardOwnershipResourceProd(
