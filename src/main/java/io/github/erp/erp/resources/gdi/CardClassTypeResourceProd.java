 ...
 */
@RestController("CardClassTypeResourceProd")
@RequestMapping("/api/granular-data")
public class CardClassTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardClassTypeResourceProd.class);
    ...
    public CardClassTypeResourceProd(
