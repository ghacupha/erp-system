 ...
 */
@RestController("CardCategoryTypeResourceProd")
@RequestMapping("/api/granular-data")
public class CardCategoryTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardCategoryTypeResourceProd.class);
    ...
    public CardCategoryTypeResourceProd(
