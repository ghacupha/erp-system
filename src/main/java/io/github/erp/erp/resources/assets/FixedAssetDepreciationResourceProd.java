 ...
 */
@RestController("fixedAssetDepreciationResourceProd")
@RequestMapping("/api/fixed-asset")
public class FixedAssetDepreciationResourceProd {

    private final Logger log = LoggerFactory.getLogger(FixedAssetDepreciationResourceProd.class);
    ...
    public FixedAssetDepreciationResourceProd(
