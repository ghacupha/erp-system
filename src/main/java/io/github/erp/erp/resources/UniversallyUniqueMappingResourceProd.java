 ...
 */
@RestController("UniversallyUniqueMappingResourceProd")
@RequestMapping("/api/app")
@Transactional
public class UniversallyUniqueMappingResourceProd {

    private final Logger log = LoggerFactory.getLogger(UniversallyUniqueMappingResourceProd.class);
    ...
    public UniversallyUniqueMappingResourceProd(
