 ...
 */
@RestController("taxRuleResourceProd")
@RequestMapping("/api/taxes")
public class TaxRuleResourceProd {

    private final Logger log = LoggerFactory.getLogger(TaxRuleResourceProd.class);
    ...
    public TaxRuleResourceProd(TaxRuleService taxRuleService, TaxRuleRepository taxRuleRepository, TaxRuleQueryService taxRuleQueryService) {
