 ...
 */
@RestController("ChannelTypeResourceProd")
@RequestMapping("/api/granular-data")
public class ChannelTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(ChannelTypeResourceProd.class);
    ...
    public ChannelTypeResourceProd(
