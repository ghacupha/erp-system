 ...
 */
import io.github.erp.internal.service.leases.InternalLeaseLiabilityByAccountReportItemService;
...
public class LeaseLiabilityByAccountReportItemResourceProd {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityByAccountReportItemResourceProd.class);

    private final InternalLeaseLiabilityByAccountReportItemService leaseLiabilityByAccountReportItemService;
    ...
    public LeaseLiabilityByAccountReportItemResourceProd(
        InternalLeaseLiabilityByAccountReportItemService leaseLiabilityByAccountReportItemService,
