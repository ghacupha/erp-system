 ...
 */
@RestController("CardBrandTypeResourceProd")
@RequestMapping("/api/granular-data")
public class CardBrandTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardBrandTypeResourceProd.class);
    ...
    public CardBrandTypeResourceProd(
