...
public class TransactionAccountLedgerResourceProd {

    private final Logger log = LoggerFactory.getLogger(TransactionAccountLedgerResourceProd.class);
    ...
    public TransactionAccountLedgerResourceProd(
