 ...
 */
@RestController("bankBranchCodeResourceProd")
@RequestMapping("/api/granular-data")
public class BankBranchCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(BankBranchCodeResourceProd.class);
    ...
    public BankBranchCodeResourceProd(
    ...
    public ResponseEntity<BankBranchCodeDTO> updateBankBranchCode(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, bankBranchCodeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<BankBranchCodeDTO> partialUpdateBankBranchCode(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, bankBranchCodeDTO.getId().toString())
        );
    }
