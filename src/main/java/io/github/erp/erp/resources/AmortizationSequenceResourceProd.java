 ...
 */
@RestController("AmortizationSequenceResourceProd")
@RequestMapping("/api/prepayments")
public class AmortizationSequenceResourceProd {

    private final Logger log = LoggerFactory.getLogger(AmortizationSequenceResourceProd.class);
    ...
    public AmortizationSequenceResourceProd(
    ...
    public ResponseEntity<AmortizationSequenceDTO> updateAmortizationSequence(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, amortizationSequenceDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AmortizationSequenceDTO> partialUpdateAmortizationSequence(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, amortizationSequenceDTO.getId().toString())
        );
    }
