...
public class RouDepreciationEntryResourceProd {

    private final Logger log = LoggerFactory.getLogger(RouDepreciationEntryResourceProd.class);
    ...
    public RouDepreciationEntryResourceProd(
