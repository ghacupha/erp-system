 ...
 */
@RestController("depreciationEntryResourceProd")
@RequestMapping("/api/fixed-asset")
public class DepreciationEntryResourceProd {

    private final Logger log = LoggerFactory.getLogger(DepreciationEntryResourceProd.class);
    ...
    public DepreciationEntryResourceProd(
    ...
    public ResponseEntity<DepreciationEntryDTO> updateDepreciationEntry(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, depreciationEntryDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<DepreciationEntryDTO> partialUpdateDepreciationEntry(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, depreciationEntryDTO.getId().toString())
        );
    }
