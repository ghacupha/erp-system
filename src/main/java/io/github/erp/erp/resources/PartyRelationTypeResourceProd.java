 ...
 */
@RestController("PartyRelationTypeResourceProd")
@RequestMapping("/api/granular-data")
public class PartyRelationTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(PartyRelationTypeResourceProd.class);
    ...
    public PartyRelationTypeResourceProd(
