 ...
 */
@RestController("deliveryNoteResourceProd")
@RequestMapping("/api/payments")
public class DeliveryNoteResourceProd {

    private final Logger log = LoggerFactory.getLogger(DeliveryNoteResourceProd.class);
    ...
    public DeliveryNoteResourceProd(
