...
public class CardIssuerChargesResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardIssuerChargesResourceProd.class);
    ...
    public CardIssuerChargesResourceProd(
