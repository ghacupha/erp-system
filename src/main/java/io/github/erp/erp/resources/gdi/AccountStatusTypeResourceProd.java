 ...
 */
@RestController("AccountStatusTypeResourceProd")
@RequestMapping("/api/granular-data")
public class AccountStatusTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountStatusTypeResourceProd.class);
    ...
    public AccountStatusTypeResourceProd(
