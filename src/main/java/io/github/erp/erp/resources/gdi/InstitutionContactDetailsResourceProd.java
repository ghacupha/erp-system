 ...
 */
@RestController("InstitutionContactDetailsResourceProd")
@RequestMapping("/api/granular-data")
public class InstitutionContactDetailsResourceProd {

    private final Logger log = LoggerFactory.getLogger(InstitutionContactDetailsResourceProd.class);
    ...
    public InstitutionContactDetailsResourceProd(
