...
public class CrbComplaintStatusTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbComplaintStatusTypeResourceProd.class);
    ...
    public CrbComplaintStatusTypeResourceProd(
