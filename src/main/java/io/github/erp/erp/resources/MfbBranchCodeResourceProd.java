 ...
 */
@RestController("mfbBranchCodeResourceProd")
@RequestMapping("/api/granular-data")
public class MfbBranchCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(MfbBranchCodeResourceProd.class);
    ...
    public MfbBranchCodeResourceProd(
