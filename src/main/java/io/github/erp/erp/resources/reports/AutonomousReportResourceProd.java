 ...
 */
@RestController("autonomousReportResourceProd")
@RequestMapping("/api/app")
public class AutonomousReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(AutonomousReportResourceProd.class);
