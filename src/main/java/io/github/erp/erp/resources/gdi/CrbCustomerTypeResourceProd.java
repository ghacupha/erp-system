...
public class CrbCustomerTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbCustomerTypeResourceProd.class);
    ...
    public CrbCustomerTypeResourceProd(
