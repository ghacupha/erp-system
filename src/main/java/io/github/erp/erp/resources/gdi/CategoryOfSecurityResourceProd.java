...
public class CategoryOfSecurityResourceProd {

    private final Logger log = LoggerFactory.getLogger(CategoryOfSecurityResourceProd.class);
    ...
    public CategoryOfSecurityResourceProd(
