...
public class RelatedPartyRelationshipResourceProd {

    private final Logger log = LoggerFactory.getLogger(RelatedPartyRelationshipResourceProd.class);
    ...
    public RelatedPartyRelationshipResourceProd(
