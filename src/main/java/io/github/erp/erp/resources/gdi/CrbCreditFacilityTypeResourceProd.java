...
public class CrbCreditFacilityTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbCreditFacilityTypeResourceProd.class);
    ...
    public CrbCreditFacilityTypeResourceProd(
