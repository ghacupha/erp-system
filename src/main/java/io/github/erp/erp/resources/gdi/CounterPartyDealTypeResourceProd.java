...
public class CounterPartyDealTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CounterPartyDealTypeResourceProd.class);
    ...
    public CounterPartyDealTypeResourceProd(
