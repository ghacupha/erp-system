 ...
 */
@RestController("GlMappingResourceProd")
@RequestMapping("/api/granular-data")
public class GlMappingResourceProd {

    private final Logger log = LoggerFactory.getLogger(GlMappingResourceProd.class);
