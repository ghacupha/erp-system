 ...
 */
@RestController("AccountTypeResourceProd")
@RequestMapping("/api/granular-data")
public class AccountTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountTypeResourceProd.class);
    ...
    public AccountTypeResourceProd(
