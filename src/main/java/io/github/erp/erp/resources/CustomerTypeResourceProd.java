 ...
 */
@RestController("customerTypeResourceProd")
@RequestMapping("/api/granular-data")
public class CustomerTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CustomerTypeResourceProd.class);
    ...
    public CustomerTypeResourceProd(
