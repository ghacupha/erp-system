 ...
 */
@RestController("workInProgressRegistrationResourceProd")
@RequestMapping("/api/fixed-asset")
public class WorkInProgressRegistrationResourceProd {

    private final Logger log = LoggerFactory.getLogger(WorkInProgressRegistrationResourceProd.class);
