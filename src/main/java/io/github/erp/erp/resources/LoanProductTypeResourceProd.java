 ...
 */
@RestController("LoanProductTypeResourceProd")
@RequestMapping("/api/granular-data")
public class LoanProductTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(LoanProductTypeResourceProd.class);
    ...
    public LoanProductTypeResourceProd(
