...
public class AccountAttributeMetadataResourceProd {

    private final Logger log = LoggerFactory.getLogger(AccountAttributeMetadataResourceProd.class);
    ...
    public AccountAttributeMetadataResourceProd(
