 ...
 */
@RestController("legalStatusResourceProd")
@RequestMapping("/api/granular-data")
public class LegalStatusResourceProd {

    private final Logger log = LoggerFactory.getLogger(LegalStatusResourceProd.class);
    ...
    public LegalStatusResourceProd(
