...
public class NbvCompilationBatchResourceProd {

    private final Logger log = LoggerFactory.getLogger(NbvCompilationBatchResourceProd.class);
    ...
    public NbvCompilationBatchResourceProd(
