...
public class PrepaymentReportRequisitionResourceProd {

    private final Logger log = LoggerFactory.getLogger(PrepaymentReportRequisitionResourceProd.class);
    ...
    private final InternalPrepaymentReportRequisitionService prepaymentReportRequisitionService;
    ...
    public PrepaymentReportRequisitionResourceProd(
        InternalPrepaymentReportRequisitionService prepaymentReportRequisitionService,
