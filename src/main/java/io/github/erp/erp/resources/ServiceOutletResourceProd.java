 ...
 */
@RestController("serviceOutletResourceProd")
@RequestMapping("/api/granular-data")
public class ServiceOutletResourceProd {

    private final Logger log = LoggerFactory.getLogger(ServiceOutletResourceProd.class);
    ...
    public ServiceOutletResourceProd(
