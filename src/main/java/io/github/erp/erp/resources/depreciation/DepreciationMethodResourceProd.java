 ...
 */
@RestController("depreciationMethodResourceProd")
@RequestMapping("/api/fixed-asset")
public class DepreciationMethodResourceProd {

    private final Logger log = LoggerFactory.getLogger(DepreciationMethodResourceProd.class);
    ...
    public DepreciationMethodResourceProd(
