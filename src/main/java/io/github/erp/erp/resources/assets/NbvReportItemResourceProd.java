...
/**
 * REST controller for managing {@link NbvReportItem}.
 */
@RestController
@RequestMapping("/api/fixed-asset")
@Transactional
public class NbvReportItemResourceProd {

    private final Logger log = LoggerFactory.getLogger(NbvReportItemResourceProd.class);
    ...
    public NbvReportItemResourceProd(
