...
public class CrbSubmittingInstitutionCategoryResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbSubmittingInstitutionCategoryResourceProd.class);
    ...
    public CrbSubmittingInstitutionCategoryResourceProd(
