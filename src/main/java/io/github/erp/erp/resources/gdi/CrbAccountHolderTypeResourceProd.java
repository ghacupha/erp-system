...
public class CrbAccountHolderTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbAccountHolderTypeResourceProd.class);
    ...
    public CrbAccountHolderTypeResourceProd(
