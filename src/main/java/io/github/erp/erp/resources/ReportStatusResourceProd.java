 ...
 */
@RestController("reportStatusResourceProd")
@RequestMapping("/api/app")
public class ReportStatusResourceProd {

    private final Logger log = LoggerFactory.getLogger(ReportStatusResourceProd.class);
    ...
    public ReportStatusResourceProd(
    ...
    public ResponseEntity<ReportStatusDTO> updateReportStatus(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportStatusDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ReportStatusDTO> partialUpdateReportStatus(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportStatusDTO.getId().toString())
        );
    }
