 ...
 */
@RestController("ExecutiveCategoryTypeResourceProd")
@RequestMapping("/api/granular-data")
public class ExecutiveCategoryTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(ExecutiveCategoryTypeResourceProd.class);
    ...
    public ExecutiveCategoryTypeResourceProd(
