 ...
 */
@RestController("workInProgressTransferResourceProd")
@RequestMapping("/api/fixed-asset")
public class WorkInProgressTransferResourceProd {

    private final Logger log = LoggerFactory.getLogger(WorkInProgressTransferResourceProd.class);
