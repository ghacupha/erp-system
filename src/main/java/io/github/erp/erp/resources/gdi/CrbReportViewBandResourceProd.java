...
public class CrbReportViewBandResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbReportViewBandResourceProd.class);
    ...
    public CrbReportViewBandResourceProd(
