 ...
 */
@RestController("customerIDDocumentTypeResourceProd")
@RequestMapping("/api/granular-data")
public class CustomerIDDocumentTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CustomerIDDocumentTypeResourceProd.class);
    ...
    public CustomerIDDocumentTypeResourceProd(
