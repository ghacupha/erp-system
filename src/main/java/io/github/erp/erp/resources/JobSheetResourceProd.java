 ...
 */
@RestController("jobSheetResourceProd")
@RequestMapping("/api/payments")
public class JobSheetResourceProd {

    private final Logger log = LoggerFactory.getLogger(JobSheetResourceProd.class);
