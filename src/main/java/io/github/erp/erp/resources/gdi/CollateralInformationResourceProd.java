...
public class CollateralInformationResourceProd {

    private final Logger log = LoggerFactory.getLogger(CollateralInformationResourceProd.class);
    ...
    public CollateralInformationResourceProd(
