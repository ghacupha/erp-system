 ...
 */
@RestController("DepartmentTypeResourceProd")
@RequestMapping("/api/granular-data")
public class DepartmentTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(DepartmentTypeResourceProd.class);
    ...
    public DepartmentTypeResourceProd(
