 ...
 */
@RestController("PaymentCalculationResourceProd")
@RequestMapping("/api/payments")
public class PaymentCalculationResourceProd {

    private final Logger log = LoggerFactory.getLogger(PaymentCalculationResourceProd.class);
    ...
    public PaymentCalculationResourceProd(
