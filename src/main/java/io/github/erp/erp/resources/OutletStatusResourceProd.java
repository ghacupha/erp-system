 ...
 */
@RestController("OutletStatusResourceProd")
@RequestMapping("/api/granular-data")
public class OutletStatusResourceProd {

    private final Logger log = LoggerFactory.getLogger(OutletStatusResourceProd.class);
    ...
    public OutletStatusResourceProd(
