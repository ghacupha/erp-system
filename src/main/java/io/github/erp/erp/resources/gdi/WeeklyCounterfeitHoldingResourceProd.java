...
public class WeeklyCounterfeitHoldingResourceProd {

    private final Logger log = LoggerFactory.getLogger(WeeklyCounterfeitHoldingResourceProd.class);
    ...
    public WeeklyCounterfeitHoldingResourceProd(
