 ...
 */
@RestController("InvoiceResourceProd")
@RequestMapping("/api/payments")
public class InvoiceResourceProd {

    private final Logger log = LoggerFactory.getLogger(InvoiceResourceProd.class);
    ...
    public InvoiceResourceProd(InvoiceService invoiceService, InvoiceRepository invoiceRepository, InvoiceQueryService invoiceQueryService) {
