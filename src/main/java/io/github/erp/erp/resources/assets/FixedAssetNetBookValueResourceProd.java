 ...
 */
@RestController("fixedAssetNetBookValueResourceProd")
@RequestMapping("/api/fixed-asset")
public class FixedAssetNetBookValueResourceProd {

    private final Logger log = LoggerFactory.getLogger(FixedAssetNetBookValueResourceProd.class);
    ...
    public FixedAssetNetBookValueResourceProd(
