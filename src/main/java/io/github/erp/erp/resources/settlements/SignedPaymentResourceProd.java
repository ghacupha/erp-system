 ...
 */
@RestController("signedPaymentResourceProd")
@RequestMapping("/api/payments")
public class SignedPaymentResourceProd {

    private final Logger log = LoggerFactory.getLogger(SignedPaymentResourceProd.class);
    ...
    public SignedPaymentResourceProd(
    ...
    public ResponseEntity<SignedPaymentDTO> updateSignedPayment(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, signedPaymentDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SignedPaymentDTO> partialUpdateSignedPayment(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, signedPaymentDTO.getId().toString())
        );
    }
