 ...
 */
@RestController("depreciationJobResourceProd")
@RequestMapping("/api/fixed-asset")
public class DepreciationJobResourceProd {

    private final Logger log = LoggerFactory.getLogger(DepreciationJobResourceProd.class);
