...
public class BankTransactionTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(BankTransactionTypeResourceProd.class);
    ...
    public BankTransactionTypeResourceProd(
