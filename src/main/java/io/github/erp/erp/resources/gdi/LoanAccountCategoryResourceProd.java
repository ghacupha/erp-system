...
public class LoanAccountCategoryResourceProd {

    private final Logger log = LoggerFactory.getLogger(LoanAccountCategoryResourceProd.class);
    ...
    public LoanAccountCategoryResourceProd(
