 ...
 */
@RestController("securityClearanceResourceProd")
@RequestMapping("/api/app")
public class SecurityClearanceResourceProd {

    private final Logger log = LoggerFactory.getLogger(SecurityClearanceResourceProd.class);
    ...
    public SecurityClearanceResourceProd(
