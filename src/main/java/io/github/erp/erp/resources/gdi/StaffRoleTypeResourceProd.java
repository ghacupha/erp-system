...
public class StaffRoleTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(StaffRoleTypeResourceProd.class);
    ...
    public StaffRoleTypeResourceProd(
