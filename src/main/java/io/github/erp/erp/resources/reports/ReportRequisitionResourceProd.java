 ...
 */
@RestController("reportRequisitionResourceProd")
@RequestMapping("/api/app")
@RolesAllowed({"ROLE_REPORT_ACCESSOR", "ROLE_REPORT_DESIGNER", "ROLE_DEV"})
public class ReportRequisitionResourceProd {

    private final Logger log = LoggerFactory.getLogger(ReportRequisitionResourceProd.class);

    private static final String ENTITY_NAME = "reportRequisition";
    ...
    public ReportRequisitionResourceProd(
    ...
    public ResponseEntity<ReportRequisitionDTO> updateReportRequisition(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportRequisitionDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ReportRequisitionDTO> partialUpdateReportRequisition(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, reportRequisitionDTO.getId().toString())
        );
    }
