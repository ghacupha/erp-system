 ...
 */
@RestController("leaseLiabilityScheduleItemResourceProd")
@RequestMapping("/api/leases")
public class LeaseLiabilityScheduleItemResourceProd {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityScheduleItemResourceProd.class);
    ...
    public LeaseLiabilityScheduleItemResourceProd(
