...
public class CrbDataSubmittingInstitutionsResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbDataSubmittingInstitutionsResourceProd.class);
    ...
    public CrbDataSubmittingInstitutionsResourceProd(
