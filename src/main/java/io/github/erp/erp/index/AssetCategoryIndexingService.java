...
@Service
@Transactional
public class AssetCategoryIndexingService extends AbtractStartUpIndexService implements ApplicationIndexingService, ApplicationListener<ApplicationReadyEvent> {
    ...
    public AssetCategoryIndexingService(AssetCategoryMapper mapper, AssetCategoryService service, AssetCategorySearchRepository searchRepository) {
        this.mapper = mapper;
