...
public class ReportContentTypeResourceDev {

    private final Logger log = LoggerFactory.getLogger(ReportContentTypeResourceDev.class);
    ...
    public ReportContentTypeResourceDev(
