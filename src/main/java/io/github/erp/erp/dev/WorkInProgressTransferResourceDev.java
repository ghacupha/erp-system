...
public class WorkInProgressTransferResourceDev {

    private final Logger log = LoggerFactory.getLogger(WorkInProgressTransferResourceDev.class);
    ...
    public WorkInProgressTransferResourceDev(
