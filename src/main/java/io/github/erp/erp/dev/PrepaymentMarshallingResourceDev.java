...
public class PrepaymentMarshallingResourceDev {

    private final Logger log = LoggerFactory.getLogger(PrepaymentMarshallingResourceDev.class);
    ...
    public PrepaymentMarshallingResourceDev(
