...
public class ReportTemplateResourceDev {

    private final Logger log = LoggerFactory.getLogger(ReportTemplateResourceDev.class);
    ...
    public ReportTemplateResourceDev(
