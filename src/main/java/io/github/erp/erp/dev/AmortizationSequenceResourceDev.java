...
public class AmortizationSequenceResourceDev {

    private final Logger log = LoggerFactory.getLogger(AmortizationSequenceResourceDev.class);
    ...
    public AmortizationSequenceResourceDev(
