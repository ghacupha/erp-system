...
public class BusinessDocumentResourceDev {

    private final Logger log = LoggerFactory.getLogger(BusinessDocumentResourceDev.class);
    ...
    public BusinessDocumentResourceDev(
