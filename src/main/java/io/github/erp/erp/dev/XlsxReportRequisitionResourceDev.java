...
public class XlsxReportRequisitionResourceDev {

    private final Logger log = LoggerFactory.getLogger(XlsxReportRequisitionResourceDev.class);
    ...
    public XlsxReportRequisitionResourceDev(
