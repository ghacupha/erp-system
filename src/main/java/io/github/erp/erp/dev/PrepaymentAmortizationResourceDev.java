...
public class PrepaymentAmortizationResourceDev {

    private final Logger log = LoggerFactory.getLogger(PrepaymentAmortizationResourceDev.class);
    ...
    public PrepaymentAmortizationResourceDev(
