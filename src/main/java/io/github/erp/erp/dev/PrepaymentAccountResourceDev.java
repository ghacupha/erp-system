...
public class PrepaymentAccountResourceDev {

    private final Logger log = LoggerFactory.getLogger(PrepaymentAccountResourceDev.class);
    ...
    public PrepaymentAccountResourceDev(
