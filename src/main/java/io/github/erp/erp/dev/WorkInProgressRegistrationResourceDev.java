...
public class WorkInProgressRegistrationResourceDev {

    private final Logger log = LoggerFactory.getLogger(WorkInProgressRegistrationResourceDev.class);
    ...
    public WorkInProgressRegistrationResourceDev(
