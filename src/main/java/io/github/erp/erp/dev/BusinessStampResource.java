...
public class BusinessStampResource {
    ...
    public ResponseEntity<BusinessStampDTO> updateBusinessStamp(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, businessStampDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<BusinessStampDTO> partialUpdateBusinessStamp(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, businessStampDTO.getId().toString())
        );
    }
