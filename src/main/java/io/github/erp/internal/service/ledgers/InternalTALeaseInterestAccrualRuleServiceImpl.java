...
@Service
@Transactional
public class InternalTALeaseInterestAccrualRuleServiceImpl implements InternalTALeaseInterestAccrualRuleService {

    private final Logger log = LoggerFactory.getLogger(InternalTALeaseInterestAccrualRuleServiceImpl.class);
    ...
    public InternalTALeaseInterestAccrualRuleServiceImpl(
