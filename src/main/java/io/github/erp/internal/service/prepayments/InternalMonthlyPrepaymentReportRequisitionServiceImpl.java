...
@Service
@Transactional
public class InternalMonthlyPrepaymentReportRequisitionServiceImpl implements InternalMonthlyPrepaymentReportRequisitionService {

    private final Logger log = LoggerFactory.getLogger(InternalMonthlyPrepaymentReportRequisitionServiceImpl.class);
