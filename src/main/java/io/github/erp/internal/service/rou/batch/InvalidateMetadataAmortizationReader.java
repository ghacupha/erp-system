...
public class InvalidateMetadataAmortizationReader implements ItemReader<RouModelMetadataDTO> {
    ...
    public InvalidateMetadataAmortizationReader(InternalRouModelMetadataService rouModelMetadataService, String previousBatchJobIdentifier) {
    ...
    public RouModelMetadataDTO read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
        if (metadataList == null) {
            metadataList = rouModelMetadataService.getProcessedItems(UUID.fromString(previousBatchJobIdentifier)).orElse(Collections.emptyList());
