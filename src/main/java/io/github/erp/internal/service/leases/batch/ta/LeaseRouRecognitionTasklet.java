...
import io.github.erp.internal.service.leases.trxAccounts.LeaseRouRecognitionTransactionDetailsService;
...
public class LeaseRouRecognitionTasklet implements Tasklet, InitializingBean {

    private final LeaseRouRecognitionTransactionDetailsService transactionDetailsService;

    private final UUID requisitionId;

    private final Long postedById;

    public LeaseRouRecognitionTasklet(LeaseRouRecognitionTransactionDetailsService leaseRouRecognitionTransactionDetailsService, UUID requisitionId, Long postedById) {
        this.transactionDetailsService = leaseRouRecognitionTransactionDetailsService;
