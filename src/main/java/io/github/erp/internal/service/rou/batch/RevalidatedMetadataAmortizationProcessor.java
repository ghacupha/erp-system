...
public class RevalidatedMetadataAmortizationProcessor implements ItemProcessor<RouModelMetadataDTO, RouModelMetadataDTO> {

    private final String batchJobIdentifier;

    public RevalidatedMetadataAmortizationProcessor(String batchJobIdentifier) {
