package io.github.erp.internal.service.payments;
...
public class InternalSettlementServiceImpl implements InternalSettlementService {
    ...
    private final Logger log = LoggerFactory.getLogger(InternalSettlementServiceImpl.class);
    ...
    public InternalSettlementServiceImpl(
