...
@Service
@Transactional
public class InternalTARecognitionROURuleServiceImpl implements InternalTARecognitionROURuleService {

    private final Logger log = LoggerFactory.getLogger(InternalTARecognitionROURuleServiceImpl.class);
    ...
    public InternalTARecognitionROURuleServiceImpl(
