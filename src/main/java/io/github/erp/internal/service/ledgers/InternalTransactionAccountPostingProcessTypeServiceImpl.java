...
@Service
@Transactional
public class InternalTransactionAccountPostingProcessTypeServiceImpl implements InternalTransactionAccountPostingProcessTypeService {

    private final Logger log = LoggerFactory.getLogger(InternalTransactionAccountPostingProcessTypeServiceImpl.class);
    ...
    public InternalTransactionAccountPostingProcessTypeServiceImpl(
