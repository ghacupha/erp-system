 ...
 */
public class FADepreciationPersistenceProcessor implements ListProcessor<FixedAssetDepreciationEVM, FixedAssetDepreciationDTO> {
    ...
    public FADepreciationPersistenceProcessor(Mapping<FixedAssetDepreciationEVM, FixedAssetDepreciationDTO> mapping, String uploadToken) {
