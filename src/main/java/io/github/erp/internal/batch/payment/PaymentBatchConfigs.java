...
public class PaymentBatchConfigs {
    ...
    @JobScope
    public EntityItemsReader<PaymentEVM> listItemReader(
    ...
    @JobScope
    public ItemProcessor<List<PaymentEVM>, List<PaymentDTO>> listItemsProcessor(
    ...
    // deletePaymentListFromFile step
