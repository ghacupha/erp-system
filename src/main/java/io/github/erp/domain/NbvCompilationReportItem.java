...
/**
 * A NbvCompilationReportItem.
 */
@Entity
@Table(name = "nbv_compilation_report_item")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "nbvcompilationreportitem")
public class NbvCompilationReportItem implements Serializable {
    ...
    public NbvCompilationReportItem id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public NbvCompilationReportItem assetNumber(String assetNumber) {
    ...
    public NbvCompilationReportItem nbvAmount(BigDecimal nbvAmount) {
    ...
    public NbvCompilationReportItem previousNBVAmount(BigDecimal previousNBVAmount) {
    ...
    public NbvCompilationReportItem assetDescription(String assetDescription) {
    ...
    public NbvCompilationReportItem batchSequenceNumber(String batchSequenceNumber) {
    ...
    public NbvCompilationReportItem processedItems(Integer processedItems) {
    ...
    public NbvCompilationReportItem totalItemsProcessed(Integer totalItemsProcessed) {
    ...
    public NbvCompilationReportItem elapsedMonths(Integer elapsedMonths) {
    ...
    public NbvCompilationReportItem priorMonths(Integer priorMonths) {
    ...
    public NbvCompilationReportItem usefulLifeYears(BigDecimal usefulLifeYears) {
    ...
    public NbvCompilationReportItem capitalizationDate(String capitalizationDate) {
    ...
    public NbvCompilationReportItem transactionNumber(String transactionNumber) {
    ...
    public NbvCompilationReportItem transactionDate(String transactionDate) {
    ...
    public NbvCompilationReportItem depreciationPeriodStartDate(String depreciationPeriodStartDate) {
    ...
    public NbvCompilationReportItem depreciationPeriodEndDate(String depreciationPeriodEndDate) {
    ...
    public NbvCompilationReportItem serviceOutletCode(String serviceOutletCode) {
    ...
    public NbvCompilationReportItem assetCategoryName(String assetCategoryName) {
    ...
    public NbvCompilationReportItem depreciationPeriodTitle(String depreciationPeriodTitle) {
    ...
    public NbvCompilationReportItem compilationJobTitle(String compilationJobTitle) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NbvCompilationReportItem)) {
            return false;
        }
        return id != null && id.equals(((NbvCompilationReportItem) o).id);
    }
