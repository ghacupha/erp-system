...
/**
 * A LeaseLiabilityReport.
 */
@Entity
@Table(name = "lease_liability_report")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "leaseliabilityreport")
public class LeaseLiabilityReport implements Serializable {
    ...
    public LeaseLiabilityReport id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public LeaseLiabilityReport requestId(UUID requestId) {
    ...
    public LeaseLiabilityReport timeOfRequest(ZonedDateTime timeOfRequest) {
    ...
    public LeaseLiabilityReport fileChecksum(String fileChecksum) {
    ...
    public LeaseLiabilityReport tampered(Boolean tampered) {
    ...
    public LeaseLiabilityReport filename(UUID filename) {
    ...
    public LeaseLiabilityReport reportParameters(String reportParameters) {
    ...
    public LeaseLiabilityReport reportFile(byte[] reportFile) {
    ...
    public LeaseLiabilityReport reportFileContentType(String reportFileContentType) {
    ...
    public LeaseLiabilityReport requestedBy(ApplicationUser applicationUser) {
    ...
    public LeaseLiabilityReport leasePeriod(LeasePeriod leasePeriod) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LeaseLiabilityReport)) {
            return false;
        }
        return id != null && id.equals(((LeaseLiabilityReport) o).id);
    }
