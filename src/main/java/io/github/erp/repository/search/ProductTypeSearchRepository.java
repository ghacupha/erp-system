...
class ProductTypeSearchRepositoryInternalImpl implements ProductTypeSearchRepositoryInternal {
    ...
    ProductTypeSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<ProductType> search(String query, Pageable pageable) {
        ...
        List<ProductType> hits = elasticsearchTemplate
            .search(nativeSearchQuery, ProductType.class)
