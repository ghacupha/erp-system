...
class FiscalYearSearchRepositoryInternalImpl implements FiscalYearSearchRepositoryInternal {
    ...
    FiscalYearSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<FiscalYear> search(String query, Pageable pageable) {
        ...
        List<FiscalYear> hits = elasticsearchTemplate
            .search(nativeSearchQuery, FiscalYear.class)
