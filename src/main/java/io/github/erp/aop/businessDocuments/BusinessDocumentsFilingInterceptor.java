...
public class BusinessDocumentsFilingInterceptor {
    ...
    private MultipartFile compileMultipart(BusinessDocumentFSO bDoc) {
        // FileItem fileItem = new DiskFileItem(bDoc.getDocumentFile(), bDoc.getDocumentFileContentType(),true, bDoc.getDocumentSerial().toString(), 100000000, new java.io.File(System.getProperty("java.io.tmpdir")));
        FileItem fileItem = new DiskFileItem(Base64.getEncoder().encodeToString(bDoc.getDocumentFile()), bDoc.getDocumentFileContentType(),false, bDoc.getDocumentSerial().toString(), 100000000, new java.io.File(System.getProperty("java.io.tmpdir")));
