...
/**
 * A DTO for the {@link io.github.erp.domain.WIPTransferListReport} entity.
 */
public class WIPTransferListReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WIPTransferListReportDTO)) {
            return false;
        }

        WIPTransferListReportDTO wIPTransferListReportDTO = (WIPTransferListReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, wIPTransferListReportDTO.id);
    }
    ...
    public String toString() {
        return "WIPTransferListReportDTO{" +
            "id=" + getId() +
