...
/**
 * A DTO for the {@link io.github.erp.domain.CounterpartyType} entity.
 */
public class CounterpartyTypeDTO implements Serializable {
    ...
    public String getCounterpartyTypeDescription() {
        return counterpartyTypeDescription;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CounterpartyTypeDTO)) {
            return false;
        }

        CounterpartyTypeDTO counterpartyTypeDTO = (CounterpartyTypeDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, counterpartyTypeDTO.id);
    }
