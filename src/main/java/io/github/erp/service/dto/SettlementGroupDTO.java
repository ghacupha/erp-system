...
/**
 * A DTO for the {@link io.github.erp.domain.SettlementGroup} entity.
 */
public class SettlementGroupDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SettlementGroupDTO)) {
            return false;
        }

        SettlementGroupDTO settlementGroupDTO = (SettlementGroupDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, settlementGroupDTO.id);
    }
