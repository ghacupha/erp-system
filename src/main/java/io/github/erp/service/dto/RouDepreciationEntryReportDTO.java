...
/**
 * A DTO for the {@link io.github.erp.domain.RouDepreciationEntryReport} entity.
 */
public class RouDepreciationEntryReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RouDepreciationEntryReportDTO)) {
            return false;
        }

        RouDepreciationEntryReportDTO rouDepreciationEntryReportDTO = (RouDepreciationEntryReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, rouDepreciationEntryReportDTO.id);
    }
    ...
    public String toString() {
        return "RouDepreciationEntryReportDTO{" +
            "id=" + getId() +
