...
/**
 * Criteria class for the {@link io.github.erp.domain.NbvReport} entity. This class is used
 * in {@link io.github.erp.web.rest.NbvReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /nbv-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class NbvReportCriteria implements Serializable, Criteria {
    ...
    public NbvReportCriteria() {}

    public NbvReportCriteria(NbvReportCriteria other) {
    ...
    @Override
    public NbvReportCriteria copy() {
        return new NbvReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final NbvReportCriteria that = (NbvReportCriteria) o;
        return (
