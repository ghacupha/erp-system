...
/**
 * Criteria class for the {@link io.github.erp.domain.TARecognitionROURule} entity. This class is used
 * in {@link io.github.erp.web.rest.TARecognitionROURuleResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ta-recognition-rou-rules?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TARecognitionROURuleCriteria implements Serializable, Criteria {
    ...
    public TARecognitionROURuleCriteria() {}

    public TARecognitionROURuleCriteria(TARecognitionROURuleCriteria other) {
    ...
    @Override
    public TARecognitionROURuleCriteria copy() {
        return new TARecognitionROURuleCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TARecognitionROURuleCriteria that = (TARecognitionROURuleCriteria) o;
        return (
    ...
    public String toString() {
        return "TARecognitionROURuleCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
