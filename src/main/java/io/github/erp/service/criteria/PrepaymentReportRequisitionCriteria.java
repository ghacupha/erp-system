...
/**
 * Criteria class for the {@link io.github.erp.domain.PrepaymentReportRequisition} entity. This class is used
 * in {@link io.github.erp.web.rest.PrepaymentReportRequisitionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /prepayment-report-requisitions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PrepaymentReportRequisitionCriteria implements Serializable, Criteria {
    ...
    public PrepaymentReportRequisitionCriteria() {}
    ...
    @Override
    public PrepaymentReportRequisitionCriteria copy() {
        return new PrepaymentReportRequisitionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PrepaymentReportRequisitionCriteria that = (PrepaymentReportRequisitionCriteria) o;
        return (
