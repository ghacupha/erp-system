...
/**
 * Criteria class for the {@link io.github.erp.domain.AmortizationPeriod} entity. This class is used
 * in {@link io.github.erp.web.rest.AmortizationPeriodResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /amortization-periods?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class AmortizationPeriodCriteria implements Serializable, Criteria {
    ...
    public AmortizationPeriodCriteria() {}

    public AmortizationPeriodCriteria(AmortizationPeriodCriteria other) {
    ...
    @Override
    public AmortizationPeriodCriteria copy() {
        return new AmortizationPeriodCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AmortizationPeriodCriteria that = (AmortizationPeriodCriteria) o;
        return (
    ...
    public String toString() {
        return "AmortizationPeriodCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
