...
import io.github.erp.erp.resources.XlsxReportRequisitionResource;
 ...
 * in {@link XlsxReportRequisitionResource} to receive all the possible filtering options from
...
public class XlsxReportRequisitionCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, reportName, reportDate, userPassword, reportStatus, reportId, reportTemplateId, placeholderId, distinct);
    }
