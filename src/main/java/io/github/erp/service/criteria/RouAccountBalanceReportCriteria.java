...
/**
 * Criteria class for the {@link io.github.erp.domain.RouAccountBalanceReport} entity. This class is used
 * in {@link io.github.erp.web.rest.RouAccountBalanceReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /rou-account-balance-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class RouAccountBalanceReportCriteria implements Serializable, Criteria {
    ...
    private LongFilter reportingMonthId;

    private Boolean distinct;

    public RouAccountBalanceReportCriteria() {}

    public RouAccountBalanceReportCriteria(RouAccountBalanceReportCriteria other) {
        ...
        this.reportingMonthId = other.reportingMonthId == null ? null : other.reportingMonthId.copy();
        this.distinct = other.distinct;
    }

    @Override
    public RouAccountBalanceReportCriteria copy() {
        return new RouAccountBalanceReportCriteria(this);
    }
    ...
    public LongFilter getReportingMonthId() {
        return reportingMonthId;
    }

    public LongFilter reportingMonthId() {
        if (reportingMonthId == null) {
            reportingMonthId = new LongFilter();
        }
        return reportingMonthId;
    }

    public void setReportingMonthId(LongFilter reportingMonthId) {
        this.reportingMonthId = reportingMonthId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final RouAccountBalanceReportCriteria that = (RouAccountBalanceReportCriteria) o;
        return (
            ...
            Objects.equals(reportingMonthId, that.reportingMonthId) &&
    ...
    public String toString() {
        return "RouAccountBalanceReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            ...
            (reportingMonthId != null ? "reportingMonthId=" + reportingMonthId + ", " : "") +
