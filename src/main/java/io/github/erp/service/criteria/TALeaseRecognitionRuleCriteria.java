...
/**
 * Criteria class for the {@link io.github.erp.domain.TALeaseRecognitionRule} entity. This class is used
 * in {@link io.github.erp.web.rest.TALeaseRecognitionRuleResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ta-lease-recognition-rules?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TALeaseRecognitionRuleCriteria implements Serializable, Criteria {
    ...
    public TALeaseRecognitionRuleCriteria() {}

    public TALeaseRecognitionRuleCriteria(TALeaseRecognitionRuleCriteria other) {
    ...
    @Override
    public TALeaseRecognitionRuleCriteria copy() {
        return new TALeaseRecognitionRuleCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TALeaseRecognitionRuleCriteria that = (TALeaseRecognitionRuleCriteria) o;
        return (
    ...
    public String toString() {
        return "TALeaseRecognitionRuleCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
