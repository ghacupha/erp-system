...
/**
 * Criteria class for the {@link io.github.erp.domain.PrepaymentAccountReportRequisition} entity. This class is used
 * in {@link io.github.erp.web.rest.PrepaymentAccountReportRequisitionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /prepayment-account-report-requisitions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PrepaymentAccountReportRequisitionCriteria implements Serializable, Criteria {
    ...
    public PrepaymentAccountReportRequisitionCriteria() {}

    public PrepaymentAccountReportRequisitionCriteria(PrepaymentAccountReportRequisitionCriteria other) {
    ...
    @Override
    public PrepaymentAccountReportRequisitionCriteria copy() {
        return new PrepaymentAccountReportRequisitionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PrepaymentAccountReportRequisitionCriteria that = (PrepaymentAccountReportRequisitionCriteria) o;
        return (
    ...
    public String toString() {
        return "PrepaymentAccountReportRequisitionCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
