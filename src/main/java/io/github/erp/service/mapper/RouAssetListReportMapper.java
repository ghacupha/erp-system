...
/**
 * Mapper for the entity {@link RouAssetListReport} and its DTO {@link RouAssetListReportDTO}.
 */
@Mapper(componentModel = "spring", uses = { ApplicationUserMapper.class })
public interface RouAssetListReportMapper extends EntityMapper<RouAssetListReportDTO, RouAssetListReport> {
    @Mapping(target = "requestedBy", source = "requestedBy", qualifiedByName = "applicationIdentity")
    RouAssetListReportDTO toDto(RouAssetListReport s);
}
