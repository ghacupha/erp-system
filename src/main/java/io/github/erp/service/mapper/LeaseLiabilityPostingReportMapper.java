...
/**
 * Mapper for the entity {@link LeaseLiabilityPostingReport} and its DTO {@link LeaseLiabilityPostingReportDTO}.
 */
@Mapper(componentModel = "spring", uses = { ApplicationUserMapper.class, LeasePeriodMapper.class })
public interface LeaseLiabilityPostingReportMapper extends EntityMapper<LeaseLiabilityPostingReportDTO, LeaseLiabilityPostingReport> {
    ...
    LeaseLiabilityPostingReportDTO toDto(LeaseLiabilityPostingReport s);
}
