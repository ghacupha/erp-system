...
public class UniversallyUniqueMappingResource {
    ...
    public ResponseEntity<UniversallyUniqueMappingDTO> updateUniversallyUniqueMapping(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, universallyUniqueMappingDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<UniversallyUniqueMappingDTO> partialUpdateUniversallyUniqueMapping(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, universallyUniqueMappingDTO.getId().toString())
        );
    }
