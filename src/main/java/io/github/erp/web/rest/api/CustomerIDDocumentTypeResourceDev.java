...
public class CustomerIDDocumentTypeResourceDev {

    private final Logger log = LoggerFactory.getLogger(CustomerIDDocumentTypeResourceDev.class);
    ...
    public CustomerIDDocumentTypeResourceDev(
