...
public class PrepaymentMappingResource {
    ...
    private static final String ENTITY_NAME = "gdiDataPrepaymentMapping";
    ...
    public ResponseEntity<PrepaymentMappingDTO> updatePrepaymentMapping(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, prepaymentMappingDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PrepaymentMappingDTO> partialUpdatePrepaymentMapping(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, prepaymentMappingDTO.getId().toString())
        );
    }
