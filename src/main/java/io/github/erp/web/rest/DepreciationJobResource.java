...
public class DepreciationJobResource {
    ...
    public ResponseEntity<DepreciationJobDTO> updateDepreciationJob(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, depreciationJobDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<DepreciationJobDTO> partialUpdateDepreciationJob(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, depreciationJobDTO.getId().toString())
        );
    }
