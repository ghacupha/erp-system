...
public class ServiceOutletResource {
    ...
    public ResponseEntity<ServiceOutletDTO> updateServiceOutlet(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, serviceOutletDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ServiceOutletDTO> partialUpdateServiceOutlet(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, serviceOutletDTO.getId().toString())
        );
    }
