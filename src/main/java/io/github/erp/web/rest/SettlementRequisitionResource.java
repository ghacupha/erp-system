...
public class SettlementRequisitionResource {
    ...
    public ResponseEntity<SettlementRequisitionDTO> updateSettlementRequisition(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, settlementRequisitionDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SettlementRequisitionDTO> partialUpdateSettlementRequisition(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, settlementRequisitionDTO.getId().toString())
        );
    }
