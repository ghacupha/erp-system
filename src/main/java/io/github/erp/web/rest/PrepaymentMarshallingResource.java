...
@RestController
@RequestMapping("/api")
public class PrepaymentMarshallingResource {

    private final Logger log = LoggerFactory.getLogger(PrepaymentMarshallingResource.class);

    private static final String ENTITY_NAME = "gdiDataPrepaymentMarshalling";
    ...
    public PrepaymentMarshallingResource(
    ...
    public ResponseEntity<PrepaymentMarshallingDTO> updatePrepaymentMarshalling(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, prepaymentMarshallingDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PrepaymentMarshallingDTO> partialUpdatePrepaymentMarshalling(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, prepaymentMarshallingDTO.getId().toString())
        );
    }
