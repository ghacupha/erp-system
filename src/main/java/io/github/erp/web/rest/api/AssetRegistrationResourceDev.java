...
public class AssetRegistrationResourceDev {

    private final Logger log = LoggerFactory.getLogger(AssetRegistrationResourceDev.class);
    ...
    public AssetRegistrationResourceDev(
