...
public class SystemModuleResource {
    ...
    public ResponseEntity<SystemModuleDTO> updateSystemModule(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, systemModuleDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SystemModuleDTO> partialUpdateSystemModule(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, systemModuleDTO.getId().toString())
        );
    }
