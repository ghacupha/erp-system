...
public class PdfReportRequisitionResourceDev {

    private final Logger log = LoggerFactory.getLogger(PdfReportRequisitionResourceDev.class);
    ...
    public PdfReportRequisitionResourceDev(
