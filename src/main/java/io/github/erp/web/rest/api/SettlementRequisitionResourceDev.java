...
public class SettlementRequisitionResourceDev {

    private final Logger log = LoggerFactory.getLogger(SettlementRequisitionResourceDev.class);
    ...
    public SettlementRequisitionResourceDev(
