...
@RestController
@RequestMapping("/api")
public class CrbGlCodeResource {

    private final Logger log = LoggerFactory.getLogger(CrbGlCodeResource.class);

    private static final String ENTITY_NAME = "gdiDataCrbGlCode";
