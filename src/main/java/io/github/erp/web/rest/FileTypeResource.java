...
public class FileTypeResource {
    ...
    public ResponseEntity<FileTypeDTO> updateFileType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, fileTypeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<FileTypeDTO> partialUpdateFileType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, fileTypeDTO.getId().toString())
        );
    }
