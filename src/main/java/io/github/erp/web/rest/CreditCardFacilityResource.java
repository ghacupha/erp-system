...
@RestController
@RequestMapping("/api")
public class CreditCardFacilityResource {

    private final Logger log = LoggerFactory.getLogger(CreditCardFacilityResource.class);
    ...
    public CreditCardFacilityResource(
