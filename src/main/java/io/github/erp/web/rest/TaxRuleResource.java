...
public class TaxRuleResource {
    ...
    public ResponseEntity<TaxRuleDTO> updateTaxRule(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, taxRuleDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TaxRuleDTO> partialUpdateTaxRule(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, taxRuleDTO.getId().toString())
        );
    }
