...
public class InstitutionCodeResourceDev {

    private final Logger log = LoggerFactory.getLogger(InstitutionCodeResourceDev.class);
    ...
    public InstitutionCodeResourceDev(
