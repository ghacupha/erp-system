...
public class CustomerIDDocumentTypeResource {
    ...
    public ResponseEntity<CustomerIDDocumentTypeDTO> updateCustomerIDDocumentType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, customerIDDocumentTypeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CustomerIDDocumentTypeDTO> partialUpdateCustomerIDDocumentType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, customerIDDocumentTypeDTO.getId().toString())
        );
    }
