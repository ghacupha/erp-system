...
@RestController
@RequestMapping("/api")
public class AmortizationPeriodResource {

    private final Logger log = LoggerFactory.getLogger(AmortizationPeriodResource.class);
    ...
    private final AmortizationPeriodService amortizationPeriodService;
    ...
    public AmortizationPeriodResource(
        AmortizationPeriodService amortizationPeriodService,
