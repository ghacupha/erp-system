...
public class ReportRequisitionResourceDev {

    private final Logger log = LoggerFactory.getLogger(ReportRequisitionResourceDev.class);
    ...
    public ReportRequisitionResourceDev(
