...
@RestController
@RequestMapping("/api")
public class CardStatusFlagResource {

    private final Logger log = LoggerFactory.getLogger(CardStatusFlagResource.class);

    private static final String ENTITY_NAME = "gdiDataCardStatusFlag";
