...
public class OutletStatusResource {
    ...
    private static final String ENTITY_NAME = "gdiDataOutletStatus";
    ...
    public ResponseEntity<OutletStatusDTO> updateOutletStatus(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, outletStatusDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<OutletStatusDTO> partialUpdateOutletStatus(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, outletStatusDTO.getId().toString())
        );
    }
