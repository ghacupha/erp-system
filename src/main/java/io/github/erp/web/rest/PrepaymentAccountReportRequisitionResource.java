...
@RestController
@RequestMapping("/api")
public class PrepaymentAccountReportRequisitionResource {

    private final Logger log = LoggerFactory.getLogger(PrepaymentAccountReportRequisitionResource.class);
    ...
    private final PrepaymentAccountReportRequisitionService prepaymentAccountReportRequisitionService;
    ...
    public PrepaymentAccountReportRequisitionResource(
        PrepaymentAccountReportRequisitionService prepaymentAccountReportRequisitionService,
