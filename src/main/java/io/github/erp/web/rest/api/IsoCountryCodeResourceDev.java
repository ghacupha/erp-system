...
public class IsoCountryCodeResourceDev {

    private final Logger log = LoggerFactory.getLogger(IsoCountryCodeResourceDev.class);
    ...
    public IsoCountryCodeResourceDev(
