...
public class WorkProjectRegisterResourceDev {

    private final Logger log = LoggerFactory.getLogger(WorkProjectRegisterResourceDev.class);
    ...
    public WorkProjectRegisterResourceDev(
