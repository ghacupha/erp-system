...
public class DepreciationMethodResource {
    ...
    private static final String ENTITY_NAME = "gdiDataDepreciationMethod";
    ...
    public ResponseEntity<DepreciationMethodDTO> updateDepreciationMethod(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, depreciationMethodDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<DepreciationMethodDTO> partialUpdateDepreciationMethod(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, depreciationMethodDTO.getId().toString())
        );
    }
