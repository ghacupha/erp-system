...
public class WorkInProgressTransferResource {
    ...
    public ResponseEntity<WorkInProgressTransferDTO> updateWorkInProgressTransfer(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workInProgressTransferDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkInProgressTransferDTO> partialUpdateWorkInProgressTransfer(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workInProgressTransferDTO.getId().toString())
        );
    }
