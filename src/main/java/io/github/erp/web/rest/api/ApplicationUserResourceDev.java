...
public class ApplicationUserResourceDev {

    private final Logger log = LoggerFactory.getLogger(ApplicationUserResourceDev.class);
    ...
    public ApplicationUserResourceDev(
