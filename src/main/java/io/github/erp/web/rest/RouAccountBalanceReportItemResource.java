...
@RestController
@RequestMapping("/api")
public class RouAccountBalanceReportItemResource {

    private final Logger log = LoggerFactory.getLogger(RouAccountBalanceReportItemResource.class);
    ...
    public RouAccountBalanceReportItemResource(
