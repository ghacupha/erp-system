...
public class PaymentRequisitionResourceDev {

    private final Logger log = LoggerFactory.getLogger(PaymentRequisitionResourceDev.class);
    ...
    public PaymentRequisitionResourceDev(
