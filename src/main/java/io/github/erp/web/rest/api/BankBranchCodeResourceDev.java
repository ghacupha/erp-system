...
public class BankBranchCodeResourceDev {

    private final Logger log = LoggerFactory.getLogger(BankBranchCodeResourceDev.class);
    ...
    public BankBranchCodeResourceDev(
