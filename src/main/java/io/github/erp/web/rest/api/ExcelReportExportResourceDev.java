...
public class ExcelReportExportResourceDev {

    private final Logger log = LoggerFactory.getLogger(ExcelReportExportResourceDev.class);
    ...
    public ExcelReportExportResourceDev(
