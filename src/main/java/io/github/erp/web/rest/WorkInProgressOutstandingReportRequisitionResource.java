...
@RestController
@RequestMapping("/api")
public class WorkInProgressOutstandingReportRequisitionResource {

    private final Logger log = LoggerFactory.getLogger(WorkInProgressOutstandingReportRequisitionResource.class);
    ...
    private final WorkInProgressOutstandingReportRequisitionService workInProgressOutstandingReportRequisitionService;
    ...
    public WorkInProgressOutstandingReportRequisitionResource(
        WorkInProgressOutstandingReportRequisitionService workInProgressOutstandingReportRequisitionService,
