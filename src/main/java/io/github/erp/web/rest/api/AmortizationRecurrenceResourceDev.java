...
public class AmortizationRecurrenceResourceDev {

    private final Logger log = LoggerFactory.getLogger(AmortizationRecurrenceResourceDev.class);
    ...
    public AmortizationRecurrenceResourceDev(
