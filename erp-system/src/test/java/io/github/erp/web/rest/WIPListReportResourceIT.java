...
/**
 * Integration tests for the {@link WIPListReportResource} REST controller.
 */
@IntegrationTest
...
class WIPListReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/wip-list-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/wip-list-reports";
