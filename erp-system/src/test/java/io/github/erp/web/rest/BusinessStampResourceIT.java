...
/**
 * Integration tests for the {@link BusinessStampResource} REST controller.
 */
@IntegrationTest
...
class BusinessStampResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/business-stamps";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/business-stamps";
    ...
    public static BusinessStamp createEntity(EntityManager em) {
        BusinessStamp businessStamp = new BusinessStamp()
            .stampDate(DEFAULT_STAMP_DATE)
    ...
    void createBusinessStamp() throws Exception {
        ...
        assertThat(testBusinessStamp.getRemarks()).isEqualTo(DEFAULT_REMARKS);
    ...
    void putNewBusinessStamp() throws Exception {
        ...
        updatedBusinessStamp.stampDate(UPDATED_STAMP_DATE).purpose(UPDATED_PURPOSE).details(UPDATED_DETAILS).remarks(UPDATED_REMARKS);
        ...
        assertThat(testBusinessStamp.getRemarks()).isEqualTo(UPDATED_REMARKS);
