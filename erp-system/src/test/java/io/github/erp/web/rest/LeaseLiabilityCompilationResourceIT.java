...
/**
 * Integration tests for the {@link LeaseLiabilityCompilationResource} REST controller.
 */
@IntegrationTest
...
class LeaseLiabilityCompilationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/lease-liability-compilations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/lease-liability-compilations";
