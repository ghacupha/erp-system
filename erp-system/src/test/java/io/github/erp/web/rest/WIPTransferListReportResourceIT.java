...
/**
 * Integration tests for the {@link WIPTransferListReportResource} REST controller.
 */
@IntegrationTest
...
class WIPTransferListReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/wip-transfer-list-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/wip-transfer-list-reports";
