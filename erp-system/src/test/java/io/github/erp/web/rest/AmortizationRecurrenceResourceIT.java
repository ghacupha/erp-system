...
/**
 * Integration tests for the {@link AmortizationRecurrenceResource} REST controller.
 */
@IntegrationTest
...
class AmortizationRecurrenceResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/amortization-recurrences";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/amortization-recurrences";
