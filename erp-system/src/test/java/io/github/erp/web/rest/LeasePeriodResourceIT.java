...
/**
 * Integration tests for the {@link LeasePeriodResource} REST controller.
 */
@IntegrationTest
...
class LeasePeriodResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/lease-periods";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/lease-periods";
