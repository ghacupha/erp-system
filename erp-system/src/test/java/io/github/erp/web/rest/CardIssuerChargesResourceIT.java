...
/**
 * Integration tests for the {@link CardIssuerChargesResource} REST controller.
 */
@IntegrationTest
...
class CardIssuerChargesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/card-issuer-charges";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/card-issuer-charges";
