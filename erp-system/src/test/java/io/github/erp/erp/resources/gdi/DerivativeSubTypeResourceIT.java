...
import io.github.erp.web.rest.DerivativeSubTypeResource;
...
class DerivativeSubTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/derivative-sub-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/derivative-sub-types";
