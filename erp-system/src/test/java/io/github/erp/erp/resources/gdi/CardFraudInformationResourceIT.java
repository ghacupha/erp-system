...
/**
 * Integration tests for the {@link CardFraudInformationResourceProd} REST controller.
 */
@IntegrationTest
...
class CardFraudInformationResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/card-fraud-informations";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/card-fraud-informations";
