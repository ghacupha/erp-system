...
import io.github.erp.web.rest.InterestCalcMethodResource;
...
class InterestCalcMethodResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/interest-calc-methods";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/interest-calc-methods";
