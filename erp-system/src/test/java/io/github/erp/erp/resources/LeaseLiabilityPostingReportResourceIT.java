...
/**
 * Integration tests for the LeaseLiabilityPostingReportResource REST controller.
 */
@IntegrationTest
...
class LeaseLiabilityPostingReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/lease-liability-posting-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/lease-liability-posting-reports";
