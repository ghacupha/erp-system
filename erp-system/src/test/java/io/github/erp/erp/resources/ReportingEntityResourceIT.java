...
class ReportingEntityResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/reporting-entities";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/reporting-entities";
