...
/**
 * Integration tests for the InternalTransactionAccountPostingProcessTypeResource REST controller.
 */
@IntegrationTest
...
class TransactionAccountPostingProcessTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/accounts/transaction-account-posting-process-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/accounts/_search/transaction-account-posting-process-types";
