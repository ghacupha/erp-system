...
/**
 * Integration tests for the LeaseRepaymentPeriodResourceProd REST controller.
 */
@IntegrationTest
...
class LeaseRepaymentPeriodResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/lease-repayment-periods";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/lease-repayment-periods";
