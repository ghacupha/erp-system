...
/**
 * Integration tests for the LeaseLiabilityByAccountReportResource REST controller.
 */
@IntegrationTest
...
class LeaseLiabilityByAccountReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/lease-liability-by-account-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/lease-liability-by-account-reports";
