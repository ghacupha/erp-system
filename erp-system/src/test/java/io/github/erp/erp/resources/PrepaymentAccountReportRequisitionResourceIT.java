...
/**
 * Integration tests for the PrepaymentAccountReportRequisitionResourceProd REST controller.
 */
@IntegrationTest
...
class PrepaymentAccountReportRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/prepayments/prepayment-account-report-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/prepayments/_search/prepayment-account-report-requisitions";
