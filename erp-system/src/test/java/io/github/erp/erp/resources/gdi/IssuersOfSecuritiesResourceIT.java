...
import io.github.erp.web.rest.IssuersOfSecuritiesResource;
...
class IssuersOfSecuritiesResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/issuers-of-securities";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/issuers-of-securities";
