...
import io.github.erp.web.rest.CrbRecordFileTypeResource;
...
class CrbRecordFileTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/crb-record-file-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/crb-record-file-types";
