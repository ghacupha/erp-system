...
/**
 * Integration tests for the {@link CardStateResourceProd} REST controller.
 */
@IntegrationTest
...
class CardStateResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/card-states";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/card-states";
