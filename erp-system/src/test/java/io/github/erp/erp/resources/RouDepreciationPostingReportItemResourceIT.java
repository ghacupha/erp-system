...
import io.github.erp.web.rest.RouDepreciationPostingReportItemResource;
...
class RouDepreciationPostingReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/rou-depreciation-posting-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-depreciation-posting-report-items";
