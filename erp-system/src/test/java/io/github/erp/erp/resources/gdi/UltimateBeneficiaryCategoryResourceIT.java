...
import io.github.erp.web.rest.UltimateBeneficiaryCategoryResource;
...
class UltimateBeneficiaryCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/ultimate-beneficiary-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/ultimate-beneficiary-categories";
        ...
        restUltimateBeneficiaryCategoryMockMvc
            ...
            .andExpect(
                jsonPath("$.[*].ultimateBeneficiaryCategoryTypeDetails")
                    .value(hasItem(DEFAULT_ULTIMATE_BENEFICIARY_CATEGORY_TYPE_DETAILS.toString()))
            );
    }
    ...
    void getUltimateBeneficiaryCategory() throws Exception {
        ...
        restUltimateBeneficiaryCategoryMockMvc
            ...
            .andExpect(
                jsonPath("$.ultimateBeneficiaryCategoryTypeDetails").value(DEFAULT_ULTIMATE_BENEFICIARY_CATEGORY_TYPE_DETAILS.toString())
            );
    }
