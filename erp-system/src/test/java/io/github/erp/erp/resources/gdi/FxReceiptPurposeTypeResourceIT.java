...
import io.github.erp.web.rest.FxReceiptPurposeTypeResource;
...
class FxReceiptPurposeTypeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/fx-receipt-purpose-types";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/fx-receipt-purpose-types";
