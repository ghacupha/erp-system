...
import io.github.erp.web.rest.AmortizationPostingReportResource;
...
class AmortizationPostingReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/prepayments/amortization-posting-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/prepayments/_search/amortization-posting-reports";
