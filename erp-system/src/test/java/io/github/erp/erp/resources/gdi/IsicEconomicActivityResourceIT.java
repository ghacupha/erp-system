...
import io.github.erp.web.rest.IsicEconomicActivityResource;
...
class IsicEconomicActivityResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/isic-economic-activities";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/isic-economic-activities";
