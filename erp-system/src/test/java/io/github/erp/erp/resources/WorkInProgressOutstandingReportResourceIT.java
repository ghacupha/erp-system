...
import io.github.erp.web.rest.WorkInProgressOutstandingReportResource;
...
class WorkInProgressOutstandingReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/work-in-progress-outstanding-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/work-in-progress-outstanding-reports";
