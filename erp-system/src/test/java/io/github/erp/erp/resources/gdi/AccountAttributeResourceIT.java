...
/**
 * Integration tests for the AccountAttributeResource REST controller.
 */
@IntegrationTest
...
class AccountAttributeResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/granular-data/account-attributes";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/granular-data/_search/account-attributes";
