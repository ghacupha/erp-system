...
class TransactionAccountLedgerResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/accounts/transaction-account-ledgers";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/accounts/_search/transaction-account-ledgers";
