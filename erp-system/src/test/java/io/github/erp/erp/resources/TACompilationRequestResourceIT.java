...
/**
 * Integration tests for the TACompilationRequestResource REST controller.
 */
@IntegrationTest
...
class TACompilationRequestResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/accounts/ta-compilation-requests";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/accounts/_search/ta-compilation-requests";
