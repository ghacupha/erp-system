...
import io.github.erp.web.rest.NbvCompilationBatchResource;
...
class NbvCompilationBatchResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/nbv-compilation-batches";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/fixed-asset/nbv-compilation-batches";
