...
import io.github.erp.web.rest.PrepaymentOutstandingOverviewReportResource;
...
class PrepaymentOutstandingOverviewReportResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/prepayments/prepayment-outstanding-overview-reports";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/prepayments/_search/prepayment-outstanding-overview-reports";
