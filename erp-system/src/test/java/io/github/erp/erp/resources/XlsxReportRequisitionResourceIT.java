...
/**
 * Integration tests for the {@link XlsxReportRequisitionResourceProd} REST controller.
 */
@IntegrationTest
...
public class XlsxReportRequisitionResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/app/xlsx-report-requisitions";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/app/_search/xlsx-report-requisitions";
