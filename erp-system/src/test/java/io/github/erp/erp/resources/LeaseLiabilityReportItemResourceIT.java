...
import io.github.erp.web.rest.LeaseLiabilityReportItemResource;
...
class LeaseLiabilityReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/lease-liability-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/lease-liability-report-items";
