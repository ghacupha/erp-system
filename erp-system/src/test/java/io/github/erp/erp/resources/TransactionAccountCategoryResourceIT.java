...
import io.github.erp.erp.resources.ledgers.TransactionAccountCategoryResourceProd;
...
/**
 * Integration tests for the {@link TransactionAccountCategoryResourceProd} REST controller.
 */
@IntegrationTest
...
class TransactionAccountCategoryResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/accounts/transaction-account-categories";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/accounts/_search/transaction-account-categories";
