...
import io.github.erp.web.rest.RouAssetNBVReportItemResource;
...
class RouAssetNBVReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/rou-asset-nbv-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-asset-nbv-report-items";
