...
/**
 * Integration tests for the NbvCompilationJobResource REST controller.
 */
 @IntegrationTest
...
class NbvCompilationJobResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/fixed-asset/nbv-compilation-jobs";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/fixed-asset/_search/nbv-compilation-jobs";
