...
import io.github.erp.web.rest.RouMonthlyDepreciationReportItemResource;
...
class RouMonthlyDepreciationReportItemResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/leases/rou-monthly-depreciation-report-items";
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{id}";
    private static final String ENTITY_SEARCH_API_URL = "/api/leases/_search/rou-monthly-depreciation-report-items";
