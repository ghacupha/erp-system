...
import io.github.erp.internal.service.ledgers.InternalTALeaseRepaymentRuleService;
...
public class TALeaseRepaymentRuleResourceProd {

    private final Logger log = LoggerFactory.getLogger(TALeaseRepaymentRuleResourceProd.class);

    private static final String ENTITY_NAME = "tALeaseRepaymentRule";

    @Value("${jhipster.clientApp.name}")
    private String applicationName;

    private final InternalTALeaseRepaymentRuleService tALeaseRepaymentRuleService;

    private final InternalTALeaseRepaymentRuleRepository tALeaseRepaymentRuleRepository;

    private final TALeaseRepaymentRuleQueryService tALeaseRepaymentRuleQueryService;

    public TALeaseRepaymentRuleResourceProd(
        InternalTALeaseRepaymentRuleService tALeaseRepaymentRuleService,
        InternalTALeaseRepaymentRuleRepository tALeaseRepaymentRuleRepository,
