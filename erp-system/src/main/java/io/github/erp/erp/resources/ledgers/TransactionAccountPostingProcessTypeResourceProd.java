...
import io.github.erp.internal.repository.InternalTransactionAccountPostingProcessTypeRepository;
import io.github.erp.internal.service.ledgers.InternalTransactionAccountPostingProcessTypeService;
...
public class TransactionAccountPostingProcessTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(TransactionAccountPostingProcessTypeResourceProd.class);
    ...
    private final InternalTransactionAccountPostingProcessTypeService transactionAccountPostingProcessTypeService;

    private final InternalTransactionAccountPostingProcessTypeRepository transactionAccountPostingProcessTypeRepository;

    private final TransactionAccountPostingProcessTypeQueryService transactionAccountPostingProcessTypeQueryService;

    public TransactionAccountPostingProcessTypeResourceProd(
        InternalTransactionAccountPostingProcessTypeService transactionAccountPostingProcessTypeService,
        InternalTransactionAccountPostingProcessTypeRepository transactionAccountPostingProcessTypeRepository,
