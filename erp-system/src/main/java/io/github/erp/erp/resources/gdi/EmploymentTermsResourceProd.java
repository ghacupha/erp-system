 ...
 */
@RestController("EmploymentTermsResourceProd")
@RequestMapping("/api/granular-data")
public class EmploymentTermsResourceProd {

    private final Logger log = LoggerFactory.getLogger(EmploymentTermsResourceProd.class);
    ...
    public EmploymentTermsResourceProd(
