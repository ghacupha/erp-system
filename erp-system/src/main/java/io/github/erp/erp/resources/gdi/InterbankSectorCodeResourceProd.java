...
public class InterbankSectorCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(InterbankSectorCodeResourceProd.class);
    ...
    public InterbankSectorCodeResourceProd(
