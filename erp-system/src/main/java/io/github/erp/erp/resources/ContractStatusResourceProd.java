 ...
 */
@RestController("ContractStatusResourceProd")
@RequestMapping("/api/granular-data")
public class ContractStatusResourceProd {

    private final Logger log = LoggerFactory.getLogger(ContractStatusResourceProd.class);
    ...
    public ContractStatusResourceProd(
