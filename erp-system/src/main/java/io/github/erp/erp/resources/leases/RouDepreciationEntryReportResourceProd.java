...
public class RouDepreciationEntryReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(RouDepreciationEntryReportResourceProd.class);
    ...
    public RouDepreciationEntryReportResourceProd(
