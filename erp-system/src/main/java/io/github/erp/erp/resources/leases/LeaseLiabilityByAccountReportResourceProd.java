...
public class LeaseLiabilityByAccountReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityByAccountReportResourceProd.class);
    ...
    public LeaseLiabilityByAccountReportResourceProd(
