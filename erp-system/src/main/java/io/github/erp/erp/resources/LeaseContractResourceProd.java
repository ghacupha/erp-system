 ...
 */
@RestController("leaseContractResourceProd")
@RequestMapping("/api/leases")
public class LeaseContractResourceProd {

    private final Logger log = LoggerFactory.getLogger(LeaseContractResourceProd.class);
    ...
    public LeaseContractResourceProd(
