...
@Service
@Transactional
public class LeaseTemplateIndexingService extends AbstractStartupRegisteredIndexService {

    private static final String TAG = "LeaseTemplateScheduleItemIndex";
    private static final Logger log = LoggerFactory.getLogger(LeaseTemplateIndexingService.class);

    private final LeaseTemplateService service;
    private final LeaseTemplateMapper mapper;
    private final LeaseTemplateSearchRepository searchRepository;

    public LeaseTemplateIndexingService (IndexProperties indexProperties, LeaseTemplateService service, LeaseTemplateMapper mapper, LeaseTemplateSearchRepository searchRepository) {
