...
public class CrbSourceOfInformationTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbSourceOfInformationTypeResourceProd.class);
    ...
    public CrbSourceOfInformationTypeResourceProd(
