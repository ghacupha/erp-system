...
@Service
@Transactional
public class ReportMetadataIndexingService extends AbstractStartupRegisteredIndexService {

    private static final String TAG = "ReportMetadataIndex";
    private static final Logger log = LoggerFactory.getLogger(TAG);

    private final ReportMetadataMapper mapper;
    private final ReportMetadataService service;
    private final ReportMetadataSearchRepository searchRepository;

    public ReportMetadataIndexingService(
        IndexProperties indexProperties,
        ReportMetadataMapper mapper,
        ReportMetadataService service,
        ReportMetadataSearchRepository searchRepository
    ) {
