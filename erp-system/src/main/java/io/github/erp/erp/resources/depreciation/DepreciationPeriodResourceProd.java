 ...
 */
@RestController("depreciationPeriodResourceProd")
@RequestMapping("/api/fixed-asset")
public class DepreciationPeriodResourceProd {

    private final Logger log = LoggerFactory.getLogger(DepreciationPeriodResourceProd.class);
...
//            .map(applicationUserMapper::toDto);
    ...
    public ResponseEntity<DepreciationPeriodDTO> updateDepreciationPeriod(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, depreciationPeriodDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<DepreciationPeriodDTO> partialUpdateDepreciationPeriod(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, depreciationPeriodDTO.getId().toString())
        );
    }
