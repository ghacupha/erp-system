 ...
 */
@RestController("assetRegistrationResourceProd")
@RequestMapping("/api/fixed-asset")
public class AssetRegistrationResourceProd {

    private final Logger log = LoggerFactory.getLogger(AssetRegistrationResourceProd.class);
    ...
    public ResponseEntity<AssetRegistrationDTO> partialUpdateAssetRegistration(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, assetRegistrationDTO.getId().toString())
        );
    }
