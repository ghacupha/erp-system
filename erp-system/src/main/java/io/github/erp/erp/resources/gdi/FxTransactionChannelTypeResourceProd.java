 ...
 */
@RestController("FxTransactionChannelTypeResourceProd")
@RequestMapping("/api/granular-data")
public class FxTransactionChannelTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(FxTransactionChannelTypeResourceProd.class);
    ...
    public FxTransactionChannelTypeResourceProd(
