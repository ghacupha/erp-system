...
import io.github.erp.internal.service.ledgers.InternalTALeaseRecognitionRuleService;
...
public class TALeaseRecognitionRuleResourceProd {
    ...
    private static final String ENTITY_NAME = "tALeaseRecognitionRule";

    @Value("${jhipster.clientApp.name}")
    private String applicationName;

    private final InternalTALeaseRecognitionRuleService tALeaseRecognitionRuleService;

    private final InternalTALeaseRecognitionRuleRepository tALeaseRecognitionRuleRepository;

    private final TALeaseRecognitionRuleQueryService tALeaseRecognitionRuleQueryService;

    public TALeaseRecognitionRuleResourceProd(
        InternalTALeaseRecognitionRuleService tALeaseRecognitionRuleService,
        InternalTALeaseRecognitionRuleRepository tALeaseRecognitionRuleRepository,
