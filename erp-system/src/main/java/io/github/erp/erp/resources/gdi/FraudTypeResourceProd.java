 ...
 */
@RestController("FraudTypeResourceProd")
@RequestMapping("/api/granular-data")
public class FraudTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(FraudTypeResourceProd.class);
