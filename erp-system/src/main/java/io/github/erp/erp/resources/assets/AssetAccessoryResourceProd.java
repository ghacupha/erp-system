 ...
 */
@RestController("assetAccessoryResourceProd")
@RequestMapping("/api/fixed-asset")
public class AssetAccessoryResourceProd {

    private final Logger log = LoggerFactory.getLogger(AssetAccessoryResourceProd.class);
    ...
    public ResponseEntity<AssetAccessoryDTO> updateAssetAccessory(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, assetAccessoryDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AssetAccessoryDTO> partialUpdateAssetAccessory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, assetAccessoryDTO.getId().toString())
        );
    }
