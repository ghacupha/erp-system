...
public class CounterPartyCategoryResourceProd {

    private final Logger log = LoggerFactory.getLogger(CounterPartyCategoryResourceProd.class);
    ...
    public CounterPartyCategoryResourceProd(
