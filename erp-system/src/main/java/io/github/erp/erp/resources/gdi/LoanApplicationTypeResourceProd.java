 ...
 */
@RestController("LoanApplicationTypeResourceProd")
@RequestMapping("/api/granular-data")
public class LoanApplicationTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(LoanApplicationTypeResourceProd.class);
    ...
    public LoanApplicationTypeResourceProd(
