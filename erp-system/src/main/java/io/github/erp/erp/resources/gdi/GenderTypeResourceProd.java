 ...
 */
@RestController("genderTypeResourceProd")
@RequestMapping("/api/granular-data")
public class GenderTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(GenderTypeResourceProd.class);
