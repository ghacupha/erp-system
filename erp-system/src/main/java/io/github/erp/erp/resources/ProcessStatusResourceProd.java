 ...
 */
@RestController("processStatusResourceProd")
@RequestMapping("/api/app")
public class ProcessStatusResourceProd {

    private final Logger log = LoggerFactory.getLogger(ProcessStatusResourceProd.class);
    ...
    public ProcessStatusResourceProd(
    ...
    public ResponseEntity<ProcessStatusDTO> updateProcessStatus(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, processStatusDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ProcessStatusDTO> partialUpdateProcessStatus(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, processStatusDTO.getId().toString())
        );
    }
