 ...
 */
@RestController("contractMetadataResourceProd")
@RequestMapping("/api/app")
public class ContractMetadataResourceProd {

    private final Logger log = LoggerFactory.getLogger(ContractMetadataResourceProd.class);
    ...
    public ContractMetadataResourceProd(
