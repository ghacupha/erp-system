...
@Service
@Transactional
public class TransactionAccountPostingRuleConditionIndexingService extends AbstractStartupRegisteredIndexService {

    private static final String TAG = "TransactionAccountPostingRuleConditionIndex";
    private static final Logger log = LoggerFactory.getLogger(TAG);

    private final TransactionAccountPostingRuleConditionRepository repository;
    private final TransactionAccountPostingRuleConditionSearchRepository searchRepository;
    private final TransactionAccountPostingRuleIndexingSupport indexingSupport;

    public TransactionAccountPostingRuleConditionIndexingService(
        IndexProperties indexProperties,
        TransactionAccountPostingRuleConditionRepository repository,
        TransactionAccountPostingRuleConditionSearchRepository searchRepository,
    ...
    private void indexerSequence() {
        ...
        this.searchRepository.saveAll(
            repository
                ...
                .filter(entity -> entity != null && !searchRepository.existsById(entity.getId()))
