...
import io.github.erp.internal.service.ledgers.InternalTAInterestPaidTransferRuleService;
...
public class TAInterestPaidTransferRuleResourceProd {

    private final Logger log = LoggerFactory.getLogger(TAInterestPaidTransferRuleResourceProd.class);

    private static final String ENTITY_NAME = "tAInterestPaidTransferRule";

    @Value("${jhipster.clientApp.name}")
    private String applicationName;

    private final InternalTAInterestPaidTransferRuleService tAInterestPaidTransferRuleService;

    private final InternalTAInterestPaidTransferRuleRepository tAInterestPaidTransferRuleRepository;

    private final TAInterestPaidTransferRuleQueryService tAInterestPaidTransferRuleQueryService;

    public TAInterestPaidTransferRuleResourceProd(
        InternalTAInterestPaidTransferRuleService tAInterestPaidTransferRuleService,
        InternalTAInterestPaidTransferRuleRepository tAInterestPaidTransferRuleRepository,
