...
public class NatureOfCustomerComplaintsResourceProd {

    private final Logger log = LoggerFactory.getLogger(NatureOfCustomerComplaintsResourceProd.class);
    ...
    public NatureOfCustomerComplaintsResourceProd(
