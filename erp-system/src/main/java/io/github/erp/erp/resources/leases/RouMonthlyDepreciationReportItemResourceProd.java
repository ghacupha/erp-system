...
public class RouMonthlyDepreciationReportItemResourceProd {

    private final Logger log = LoggerFactory.getLogger(RouMonthlyDepreciationReportItemResourceProd.class);
    ...
    public RouMonthlyDepreciationReportItemResourceProd(
