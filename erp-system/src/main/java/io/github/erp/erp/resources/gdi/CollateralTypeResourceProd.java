 ...
 */
@RestController("CollateralTypeResourceProd")
@RequestMapping("/api/granular-data")
public class CollateralTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CollateralTypeResourceProd.class);
    ...
    public CollateralTypeResourceProd(
