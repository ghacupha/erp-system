 ...
 */
@RestController("insiderCategoryTypesResourceProd")
@RequestMapping("/api/granular-data")
public class InsiderCategoryTypesResourceProd {

    private final Logger log = LoggerFactory.getLogger(InsiderCategoryTypesResourceProd.class);
    ...
    public InsiderCategoryTypesResourceProd(
