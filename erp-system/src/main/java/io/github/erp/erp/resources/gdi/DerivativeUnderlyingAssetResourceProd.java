...
public class DerivativeUnderlyingAssetResourceProd {

    private final Logger log = LoggerFactory.getLogger(DerivativeUnderlyingAssetResourceProd.class);
    ...
    public DerivativeUnderlyingAssetResourceProd(
