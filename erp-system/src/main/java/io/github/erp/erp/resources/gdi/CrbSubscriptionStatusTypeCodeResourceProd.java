...
public class CrbSubscriptionStatusTypeCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbSubscriptionStatusTypeCodeResourceProd.class);
    ...
    public CrbSubscriptionStatusTypeCodeResourceProd(
