...
public class LeaseLiabilityPostingReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityPostingReportResourceProd.class);
    ...
    public LeaseLiabilityPostingReportResourceProd(
