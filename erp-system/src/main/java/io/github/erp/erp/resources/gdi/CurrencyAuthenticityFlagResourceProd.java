...
public class CurrencyAuthenticityFlagResourceProd {

    private final Logger log = LoggerFactory.getLogger(CurrencyAuthenticityFlagResourceProd.class);
    ...
    public CurrencyAuthenticityFlagResourceProd(
