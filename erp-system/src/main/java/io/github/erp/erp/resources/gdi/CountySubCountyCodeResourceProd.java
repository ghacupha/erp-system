...
public class CountySubCountyCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(CountySubCountyCodeResourceProd.class);
    ...
    public CountySubCountyCodeResourceProd(
