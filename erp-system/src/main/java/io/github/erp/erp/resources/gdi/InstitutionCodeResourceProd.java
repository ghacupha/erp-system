 ...
 */
@RestController("institutionCodeResourceProd")
@RequestMapping("/api/granular-data")
public class InstitutionCodeResourceProd {

    private final Logger log = LoggerFactory.getLogger(InstitutionCodeResourceProd.class);
    ...
    public InstitutionCodeResourceProd(
    ...
    public ResponseEntity<InstitutionCodeDTO> updateInstitutionCode(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, institutionCodeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<InstitutionCodeDTO> partialUpdateInstitutionCode(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, institutionCodeDTO.getId().toString())
        );
    }
