...
public class CrbAccountStatusResourceProd {

    private final Logger log = LoggerFactory.getLogger(CrbAccountStatusResourceProd.class);
    ...
    public CrbAccountStatusResourceProd(
