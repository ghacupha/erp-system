 ...
 */
@RestController("prepaymentMappingResourceProd")
@RequestMapping("/api/app")
public class PrepaymentMappingResourceProd {

    private final Logger log = LoggerFactory.getLogger(PrepaymentMappingResourceProd.class);
    ...
    public PrepaymentMappingResourceProd(
        InternalPrepaymentMappingService prepaymentMappingService,
