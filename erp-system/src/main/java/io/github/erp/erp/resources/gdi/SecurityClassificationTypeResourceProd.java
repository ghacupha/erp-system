...
public class SecurityClassificationTypeResourceProd {

    private final Logger log = LoggerFactory.getLogger(SecurityClassificationTypeResourceProd.class);
    ...
    public SecurityClassificationTypeResourceProd(
