...
public class RouAccountBalanceReportResourceProd {

    private final Logger log = LoggerFactory.getLogger(RouAccountBalanceReportResourceProd.class);
    ...
    public RouAccountBalanceReportResourceProd(
