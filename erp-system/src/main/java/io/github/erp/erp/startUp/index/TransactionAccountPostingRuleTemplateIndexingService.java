...
@Service
@Transactional
public class TransactionAccountPostingRuleTemplateIndexingService extends AbstractStartupRegisteredIndexService {

    private static final String TAG = "TransactionAccountPostingRuleTemplateIndex";
    private static final Logger log = LoggerFactory.getLogger(TAG);

    private final TransactionAccountPostingRuleTemplateRepository repository;
    private final TransactionAccountPostingRuleTemplateSearchRepository searchRepository;
    private final TransactionAccountPostingRuleIndexingSupport indexingSupport;

    public TransactionAccountPostingRuleTemplateIndexingService(
        IndexProperties indexProperties,
        TransactionAccountPostingRuleTemplateRepository repository,
        TransactionAccountPostingRuleTemplateSearchRepository searchRepository,
