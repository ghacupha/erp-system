 ...
 */
@RestController("CardTypesResourceProd")
@RequestMapping("/api/granular-data")
public class CardTypesResourceProd {

    private final Logger log = LoggerFactory.getLogger(CardTypesResourceProd.class);
