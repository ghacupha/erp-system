 ...
 */
@RestController("ProfessionalQualificationResourceProd")
@RequestMapping("/api/granular-data")
public class ProfessionalQualificationResourceProd {

    private final Logger log = LoggerFactory.getLogger(ProfessionalQualificationResourceProd.class);
    ...
    public ProfessionalQualificationResourceProd(
