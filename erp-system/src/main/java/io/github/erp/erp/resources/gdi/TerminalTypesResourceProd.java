...
public class TerminalTypesResourceProd {

    private final Logger log = LoggerFactory.getLogger(TerminalTypesResourceProd.class);
    ...
    public TerminalTypesResourceProd(
