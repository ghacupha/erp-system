...
@Service
@Transactional
public class TransactionAccountPostingRuleIndexingService extends AbstractStartupRegisteredIndexService {

    private static final String TAG = "TransactionAccountPostingRuleIndex";
    private static final Logger log = LoggerFactory.getLogger(TAG);

    private final TransactionAccountPostingRuleRepository repository;
    private final TransactionAccountPostingRuleSearchRepository searchRepository;
    private final TransactionAccountPostingRuleIndexingSupport indexingSupport;

    public TransactionAccountPostingRuleIndexingService(
        IndexProperties indexProperties,
        TransactionAccountPostingRuleRepository repository,
        TransactionAccountPostingRuleSearchRepository searchRepository,
    ...
    private void indexerSequence() {
        ...
        this.searchRepository.saveAll(
            repository
                ...
                .stream()
                .map(indexingSupport::sanitizePostingRule)
