...
/**
 * Criteria class for the {@link io.github.erp.domain.LeaseLiabilityScheduleReport} entity. This class is used
 * in {@link io.github.erp.web.rest.LeaseLiabilityScheduleReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /lease-liability-schedule-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LeaseLiabilityScheduleReportCriteria implements Serializable, Criteria {
    ...
    public LeaseLiabilityScheduleReportCriteria() {}

    public LeaseLiabilityScheduleReportCriteria(LeaseLiabilityScheduleReportCriteria other) {
    ...
    @Override
    public LeaseLiabilityScheduleReportCriteria copy() {
        return new LeaseLiabilityScheduleReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LeaseLiabilityScheduleReportCriteria that = (LeaseLiabilityScheduleReportCriteria) o;
        return (
    ...
    public String toString() {
        return "LeaseLiabilityScheduleReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
