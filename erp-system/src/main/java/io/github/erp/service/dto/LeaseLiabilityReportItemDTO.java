...
/**
 * A DTO for the {@link io.github.erp.domain.LeaseLiabilityReportItem} entity.
 */
public class LeaseLiabilityReportItemDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LeaseLiabilityReportItemDTO)) {
            return false;
        }

        LeaseLiabilityReportItemDTO leaseLiabilityReportItemDTO = (LeaseLiabilityReportItemDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, leaseLiabilityReportItemDTO.id);
    }
    ...
    public String toString() {
        return "LeaseLiabilityReportItemDTO{" +
            "id=" + getId() +
