...
/**
 * A DTO for the {@link io.github.erp.domain.TransactionAccountPostingRuleTemplate} entity.
 */
public class TransactionAccountPostingRuleTemplateDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TransactionAccountPostingRuleTemplateDTO)) {
            return false;
        }

        TransactionAccountPostingRuleTemplateDTO transactionAccountPostingRuleTemplateDTO = (TransactionAccountPostingRuleTemplateDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, transactionAccountPostingRuleTemplateDTO.id);
    }
    ...
    public String toString() {
        return "TransactionAccountPostingRuleTemplateDTO{" +
            "id=" + getId() +
