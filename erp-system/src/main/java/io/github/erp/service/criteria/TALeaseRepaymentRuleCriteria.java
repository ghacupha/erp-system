...
/**
 * Criteria class for the {@link io.github.erp.domain.TALeaseRepaymentRule} entity. This class is used
 * in {@link io.github.erp.web.rest.TALeaseRepaymentRuleResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ta-lease-repayment-rules?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TALeaseRepaymentRuleCriteria implements Serializable, Criteria {
    ...
    public TALeaseRepaymentRuleCriteria() {}

    public TALeaseRepaymentRuleCriteria(TALeaseRepaymentRuleCriteria other) {
    ...
    @Override
    public TALeaseRepaymentRuleCriteria copy() {
        return new TALeaseRepaymentRuleCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TALeaseRepaymentRuleCriteria that = (TALeaseRepaymentRuleCriteria) o;
        return (
    ...
    public String toString() {
        return "TALeaseRepaymentRuleCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
