...
@Service
@Transactional
public class TAInterestPaidTransferRuleServiceImpl implements TAInterestPaidTransferRuleService {

    private final Logger log = LoggerFactory.getLogger(TAInterestPaidTransferRuleServiceImpl.class);
    ...
    public TAInterestPaidTransferRuleServiceImpl(
