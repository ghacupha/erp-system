...
/**
 * A DTO for the {@link io.github.erp.domain.CrbRecordFileType} entity.
 */
public class CrbRecordFileTypeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CrbRecordFileTypeDTO)) {
            return false;
        }

        CrbRecordFileTypeDTO crbRecordFileTypeDTO = (CrbRecordFileTypeDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, crbRecordFileTypeDTO.id);
    }
