...
/**
 * A DTO for the {@link io.github.erp.domain.LeaseLiabilityByAccountReport} entity.
 */
public class LeaseLiabilityByAccountReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LeaseLiabilityByAccountReportDTO)) {
            return false;
        }

        LeaseLiabilityByAccountReportDTO leaseLiabilityByAccountReportDTO = (LeaseLiabilityByAccountReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, leaseLiabilityByAccountReportDTO.id);
    }
    ...
    public String toString() {
        return "LeaseLiabilityByAccountReportDTO{" +
            "id=" + getId() +
