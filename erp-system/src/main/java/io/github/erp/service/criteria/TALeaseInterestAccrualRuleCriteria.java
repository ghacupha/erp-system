...
/**
 * Criteria class for the {@link io.github.erp.domain.TALeaseInterestAccrualRule} entity. This class is used
 * in {@link io.github.erp.web.rest.TALeaseInterestAccrualRuleResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ta-lease-interest-accrual-rules?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TALeaseInterestAccrualRuleCriteria implements Serializable, Criteria {
    ...
    public TALeaseInterestAccrualRuleCriteria() {}

    public TALeaseInterestAccrualRuleCriteria(TALeaseInterestAccrualRuleCriteria other) {
    ...
    @Override
    public TALeaseInterestAccrualRuleCriteria copy() {
        return new TALeaseInterestAccrualRuleCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TALeaseInterestAccrualRuleCriteria that = (TALeaseInterestAccrualRuleCriteria) o;
        return (
    ...
    public String toString() {
        return "TALeaseInterestAccrualRuleCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
