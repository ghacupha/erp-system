...
/**
 * Mapper for the entity {@link PrepaymentReportRequisition} and its DTO {@link PrepaymentReportRequisitionDTO}.
 */
@Mapper(componentModel = "spring", uses = { ApplicationUserMapper.class })
public interface PrepaymentReportRequisitionMapper extends EntityMapper<PrepaymentReportRequisitionDTO, PrepaymentReportRequisition> {
    ...
    PrepaymentReportRequisitionDTO toDto(PrepaymentReportRequisition s);
}
