...
/**
 * Mapper for the entity {@link TransactionAccountLedger} and its DTO {@link TransactionAccountLedgerDTO}.
 */
@Mapper(componentModel = "spring", uses = { PlaceholderMapper.class })
public interface TransactionAccountLedgerMapper extends EntityMapper<TransactionAccountLedgerDTO, TransactionAccountLedger> {
    @Mapping(target = "placeholders", source = "placeholders", qualifiedByName = "descriptionSet")
    TransactionAccountLedgerDTO toDto(TransactionAccountLedger s);
