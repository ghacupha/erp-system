...
/**
 * Criteria class for the {@link io.github.erp.domain.WIPListReport} entity. This class is used
 * in {@link io.github.erp.web.rest.WIPListReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /wip-list-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class WIPListReportCriteria implements Serializable, Criteria {
    ...
    public WIPListReportCriteria() {}

    public WIPListReportCriteria(WIPListReportCriteria other) {
    ...
    @Override
    public WIPListReportCriteria copy() {
        return new WIPListReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final WIPListReportCriteria that = (WIPListReportCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, timeOfRequest, requestId, fileChecksum, tampered, filename, reportParameters, requestedById, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "WIPListReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
