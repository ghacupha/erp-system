...
/**
 * Criteria class for the {@link io.github.erp.domain.TAInterestPaidTransferRule} entity. This class is used
 * in {@link io.github.erp.web.rest.TAInterestPaidTransferRuleResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ta-interest-paid-transfer-rules?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TAInterestPaidTransferRuleCriteria implements Serializable, Criteria {
    ...
    public TAInterestPaidTransferRuleCriteria() {}

    public TAInterestPaidTransferRuleCriteria(TAInterestPaidTransferRuleCriteria other) {
    ...
    @Override
    public TAInterestPaidTransferRuleCriteria copy() {
        return new TAInterestPaidTransferRuleCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TAInterestPaidTransferRuleCriteria that = (TAInterestPaidTransferRuleCriteria) o;
        return (
    ...
    public String toString() {
        return "TAInterestPaidTransferRuleCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
