...
/**
 * A DTO for the {@link io.github.erp.domain.NbvReport} entity.
 */
public class NbvReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NbvReportDTO)) {
            return false;
        }

        NbvReportDTO nbvReportDTO = (NbvReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, nbvReportDTO.id);
    }
