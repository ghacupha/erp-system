 ...
 */
public class MfbBranchCodeCriteria implements Serializable, Criteria {
    ...
    public MfbBranchCodeCriteria() {}

    public MfbBranchCodeCriteria(MfbBranchCodeCriteria other) {
    ...
    @Override
    public MfbBranchCodeCriteria copy() {
        return new MfbBranchCodeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MfbBranchCodeCriteria that = (MfbBranchCodeCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, bankCode, bankName, branchCode, branchName, placeholderId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "MfbBranchCodeCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
