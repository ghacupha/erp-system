...
/**
 * Criteria class for the {@link io.github.erp.domain.RouDepreciationEntryReport} entity. This class is used
 * in {@link io.github.erp.web.rest.RouDepreciationEntryReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /rou-depreciation-entry-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class RouDepreciationEntryReportCriteria implements Serializable, Criteria {
    ...
    public RouDepreciationEntryReportCriteria() {}

    public RouDepreciationEntryReportCriteria(RouDepreciationEntryReportCriteria other) {
    ...
    @Override
    public RouDepreciationEntryReportCriteria copy() {
        return new RouDepreciationEntryReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RouDepreciationEntryReportCriteria that = (RouDepreciationEntryReportCriteria) o;
        return (
    ...
    public String toString() {
        return "RouDepreciationEntryReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
