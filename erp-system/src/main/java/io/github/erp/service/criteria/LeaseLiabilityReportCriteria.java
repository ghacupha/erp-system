...
/**
 * Criteria class for the {@link io.github.erp.domain.LeaseLiabilityReport} entity. This class is used
 * in {@link io.github.erp.web.rest.LeaseLiabilityReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /lease-liability-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LeaseLiabilityReportCriteria implements Serializable, Criteria {
    ...
    public LeaseLiabilityReportCriteria() {}

    public LeaseLiabilityReportCriteria(LeaseLiabilityReportCriteria other) {
    ...
    @Override
    public LeaseLiabilityReportCriteria copy() {
        return new LeaseLiabilityReportCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LeaseLiabilityReportCriteria that = (LeaseLiabilityReportCriteria) o;
        return (
    ...
    public String toString() {
        return "LeaseLiabilityReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
