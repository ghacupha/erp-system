...
/**
 * Criteria class for the {@link io.github.erp.domain.WIPTransferListReport} entity. This class is used
 * in {@link io.github.erp.web.rest.WIPTransferListReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /wip-transfer-list-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class WIPTransferListReportCriteria implements Serializable, Criteria {
    ...
    private BooleanFilter tempered;
    ...
    public WIPTransferListReportCriteria() {}

    public WIPTransferListReportCriteria(WIPTransferListReportCriteria other) {
        ...
        this.tempered = other.tempered == null ? null : other.tempered.copy();
    ...
    @Override
    public WIPTransferListReportCriteria copy() {
        return new WIPTransferListReportCriteria(this);
    }
    ...
    public BooleanFilter getTempered() {
        return tempered;
    }

    public BooleanFilter tempered() {
        if (tempered == null) {
            tempered = new BooleanFilter();
        }
        return tempered;
    }

    public void setTempered(BooleanFilter tempered) {
    ...
    public boolean equals(Object o) {
        ...
        final WIPTransferListReportCriteria that = (WIPTransferListReportCriteria) o;
        return (
            Objects.equals(id, that.id) &&
            Objects.equals(timeOfRequest, that.timeOfRequest) &&
            Objects.equals(requestId, that.requestId) &&
            Objects.equals(fileChecksum, that.fileChecksum) &&
            Objects.equals(tempered, that.tempered) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, timeOfRequest, requestId, fileChecksum, tempered, filename, reportParameters, requestedById, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "WIPTransferListReportCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (timeOfRequest != null ? "timeOfRequest=" + timeOfRequest + ", " : "") +
            (requestId != null ? "requestId=" + requestId + ", " : "") +
            (fileChecksum != null ? "fileChecksum=" + fileChecksum + ", " : "") +
            (tempered != null ? "tempered=" + tempered + ", " : "") +
