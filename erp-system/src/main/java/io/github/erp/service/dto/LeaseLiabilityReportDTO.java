...
/**
 * A DTO for the {@link io.github.erp.domain.LeaseLiabilityReport} entity.
 */
public class LeaseLiabilityReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LeaseLiabilityReportDTO)) {
            return false;
        }

        LeaseLiabilityReportDTO leaseLiabilityReportDTO = (LeaseLiabilityReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, leaseLiabilityReportDTO.id);
    }
    ...
    public String toString() {
        return "LeaseLiabilityReportDTO{" +
            "id=" + getId() +
