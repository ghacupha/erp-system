...
/**
 * A DTO for the {@link io.github.erp.domain.PrepaymentAccountReportRequisition} entity.
 */
public class PrepaymentAccountReportRequisitionDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrepaymentAccountReportRequisitionDTO)) {
            return false;
        }

        PrepaymentAccountReportRequisitionDTO prepaymentAccountReportRequisitionDTO = (PrepaymentAccountReportRequisitionDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, prepaymentAccountReportRequisitionDTO.id);
    }
    ...
    public String toString() {
        return "PrepaymentAccountReportRequisitionDTO{" +
            "id=" + getId() +
