...
@Service
@Transactional
public class TransactionAccountCategoryServiceImpl implements TransactionAccountCategoryService {

    private final Logger log = LoggerFactory.getLogger(TransactionAccountCategoryServiceImpl.class);
    ...
    public TransactionAccountCategoryServiceImpl(
