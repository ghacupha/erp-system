...
@Service
@Transactional
public class InternalLeaseLiabilityReportServiceImpl implements InternalLeaseLiabilityReportService {

    private final Logger log = LoggerFactory.getLogger(InternalLeaseLiabilityReportServiceImpl.class);
    ...
    public InternalLeaseLiabilityReportServiceImpl(
