 ...
 */
@Repository
public interface InternalTransactionAccountRepository
    ...
    @Query(
        nativeQuery = true,
        value = "SELECT CAST(id AS BIGINT) FROM public.transaction_account",
        countQuery = "SELECT id FROM public.transaction_account"
    )
