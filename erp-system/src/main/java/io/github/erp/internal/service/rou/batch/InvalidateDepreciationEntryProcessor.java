...
public class InvalidateDepreciationEntryProcessor implements ItemProcessor<RouDepreciationEntryDTO, RouDepreciationEntryDTO> {


    private final String batchJobIdentifier;

    public InvalidateDepreciationEntryProcessor(String batchJobIdentifier) {
    ...
    public RouDepreciationEntryDTO process(RouDepreciationEntryDTO item) throws Exception {
        // Set invalidated and batch-job-identifier
        item.setInvalidated(true);
