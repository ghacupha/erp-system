...
public class RevalidateMetadataAmortizationReader implements ItemReader<RouModelMetadataDTO> {
    ...
    public RevalidateMetadataAmortizationReader(InternalRouModelMetadataService rouModelMetadataService, String previousBatchJobIdentifier) {
