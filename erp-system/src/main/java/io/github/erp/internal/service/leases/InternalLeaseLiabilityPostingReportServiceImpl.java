...
@Service
@Transactional
public class InternalLeaseLiabilityPostingReportServiceImpl implements InternalLeaseLiabilityPostingReportService {

    private final Logger log = LoggerFactory.getLogger(InternalLeaseLiabilityPostingReportServiceImpl.class);
    ...
    public InternalLeaseLiabilityPostingReportServiceImpl(
