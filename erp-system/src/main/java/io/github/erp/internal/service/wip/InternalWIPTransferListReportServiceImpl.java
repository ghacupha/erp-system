...
@Service
@Transactional
public class InternalWIPTransferListReportServiceImpl implements InternalWIPTransferListReportService {

    private final Logger log = LoggerFactory.getLogger(InternalWIPTransferListReportServiceImpl.class);
