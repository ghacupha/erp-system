 ...
 */
import io.github.erp.internal.service.leases.trxAccounts.LeaseInterestPaidTransferTransactionDetailsService;
...
public class LeaseInterestPaidTransferTasklet implements Tasklet, InitializingBean {

    private final LeaseInterestPaidTransferTransactionDetailsService transactionDetailsService;

    private final UUID requisitionId;

    private final Long postedById;

    public LeaseInterestPaidTransferTasklet(LeaseInterestPaidTransferTransactionDetailsService leaseInterestPaidTransferTransactionDetailsService, UUID requisitionId, Long postedById) {
        this.transactionDetailsService = leaseInterestPaidTransferTransactionDetailsService;
