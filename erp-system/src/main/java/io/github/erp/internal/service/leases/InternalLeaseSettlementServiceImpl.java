...
@Service
@Transactional
public class InternalLeaseSettlementServiceImpl implements InternalLeaseSettlementService {

    private final Logger log = LoggerFactory.getLogger(InternalLeaseSettlementServiceImpl.class);
    ...
    public InternalLeaseSettlementServiceImpl(
    ...
    @Override
    public LeaseSettlementDTO update(LeaseSettlementDTO leaseSettlementDTO) {
        log.debug("Request to save LeaseSettlement : {}", leaseSettlementDTO);
        LeaseSettlement leaseSettlement = leaseSettlementMapper.toEntity(leaseSettlementDTO);
        leaseSettlement = leaseSettlementRepository.save(leaseSettlement);
        return leaseSettlementMapper.toDto(leaseSettlement);
    }
