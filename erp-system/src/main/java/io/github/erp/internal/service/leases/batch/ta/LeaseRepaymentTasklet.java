 ...
 */
import io.github.erp.internal.service.leases.trxAccounts.LeaseRepaymentTransactionDetailsService;
...
public class LeaseRepaymentTasklet implements Tasklet, InitializingBean {

    private final LeaseRepaymentTransactionDetailsService transactionDetailsService;

    private final UUID requisitionId;

    private final Long postedById;

    public LeaseRepaymentTasklet(LeaseRepaymentTransactionDetailsService leaseRepaymentTransactionDetailsService, UUID requisitionId, Long postedById) {
        this.transactionDetailsService = leaseRepaymentTransactionDetailsService;
