...
class PaymentSearchRepositoryInternalImpl implements PaymentSearchRepositoryInternal {
    ...
    PaymentSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<Payment> search(String query, Pageable pageable) {
        ...
        List<Payment> hits = elasticsearchTemplate
            .search(nativeSearchQuery, Payment.class)
