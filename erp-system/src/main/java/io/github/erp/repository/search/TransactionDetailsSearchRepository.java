...
public interface TransactionDetailsSearchRepository
    extends ElasticsearchRepository<TransactionDetails, Long>, TransactionDetailsSearchRepositoryInternal {}
...
class TransactionDetailsSearchRepositoryInternalImpl implements TransactionDetailsSearchRepositoryInternal {
    ...
    TransactionDetailsSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<TransactionDetails> search(String query, Pageable pageable) {
        ...
        List<TransactionDetails> hits = elasticsearchTemplate
            .search(nativeSearchQuery, TransactionDetails.class)
