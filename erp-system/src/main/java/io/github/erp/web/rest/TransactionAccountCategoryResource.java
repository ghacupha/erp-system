...
@RestController
@RequestMapping("/api")
public class TransactionAccountCategoryResource {

    private final Logger log = LoggerFactory.getLogger(TransactionAccountCategoryResource.class);
    ...
    private final TransactionAccountCategoryService transactionAccountCategoryService;
    ...
    public TransactionAccountCategoryResource(
        TransactionAccountCategoryService transactionAccountCategoryService,
