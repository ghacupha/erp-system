...
@RestController
@RequestMapping("/api")
public class TACompilationRequestResource {
    ...
    private final TACompilationRequestService tACompilationRequestService;
    ...
    public TACompilationRequestResource(
        TACompilationRequestService tACompilationRequestService,
