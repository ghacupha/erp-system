...
@RestController
@RequestMapping("/api")
public class TARecognitionROURuleResource {

    private final Logger log = LoggerFactory.getLogger(TARecognitionROURuleResource.class);

    private static final String ENTITY_NAME = "accountingTaRecognitionRouRule";

    @Value("${jhipster.clientApp.name}")
    private String applicationName;

    private final TARecognitionROURuleService tARecognitionROURuleService;
    ...
    public TARecognitionROURuleResource(
        TARecognitionROURuleService tARecognitionROURuleService,
