...
public class SecurityClearanceResource {
    ...
    public ResponseEntity<SecurityClearanceDTO> updateSecurityClearance(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, securityClearanceDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SecurityClearanceDTO> partialUpdateSecurityClearance(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, securityClearanceDTO.getId().toString())
        );
    }
