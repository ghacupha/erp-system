...
@RestController
@RequestMapping("/api")
public class DepreciationJobNoticeResource {

    private final Logger log = LoggerFactory.getLogger(DepreciationJobNoticeResource.class);

    private static final String ENTITY_NAME = "depreciationJobNotice";
