...
@RestController
@RequestMapping("/api")
public class NetBookValueEntryResource {

    private final Logger log = LoggerFactory.getLogger(NetBookValueEntryResource.class);
    ...
    public NetBookValueEntryResource(
