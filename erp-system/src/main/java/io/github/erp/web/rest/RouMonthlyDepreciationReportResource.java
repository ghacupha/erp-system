...
@RestController
@RequestMapping("/api")
public class RouMonthlyDepreciationReportResource {

    private final Logger log = LoggerFactory.getLogger(RouMonthlyDepreciationReportResource.class);
    ...
    public RouMonthlyDepreciationReportResource(
