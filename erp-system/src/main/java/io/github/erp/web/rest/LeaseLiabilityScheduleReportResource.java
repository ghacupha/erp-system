...
@RestController
@RequestMapping("/api")
public class LeaseLiabilityScheduleReportResource {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityScheduleReportResource.class);
    ...
    public LeaseLiabilityScheduleReportResource(
