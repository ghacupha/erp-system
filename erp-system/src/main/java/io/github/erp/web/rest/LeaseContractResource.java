...
public class LeaseContractResource {
    ...
    public ResponseEntity<LeaseContractDTO> updateLeaseContract(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, leaseContractDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<LeaseContractDTO> partialUpdateLeaseContract(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, leaseContractDTO.getId().toString())
        );
    }
