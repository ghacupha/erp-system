...
@RestController
@RequestMapping("/api")
public class AssetWarrantyResource {
    ...
    public ResponseEntity<AssetWarrantyDTO> updateAssetWarranty(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, assetWarrantyDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AssetWarrantyDTO> partialUpdateAssetWarranty(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, assetWarrantyDTO.getId().toString())
        );
    }
