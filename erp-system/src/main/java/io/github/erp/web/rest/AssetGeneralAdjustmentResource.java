...
@RestController
@RequestMapping("/api")
public class AssetGeneralAdjustmentResource {

    private final Logger log = LoggerFactory.getLogger(AssetGeneralAdjustmentResource.class);
    ...
    public AssetGeneralAdjustmentResource(
