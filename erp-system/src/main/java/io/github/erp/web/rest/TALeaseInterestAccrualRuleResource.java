...
@RestController
@RequestMapping("/api")
public class TALeaseInterestAccrualRuleResource {

    private final Logger log = LoggerFactory.getLogger(TALeaseInterestAccrualRuleResource.class);

    private static final String ENTITY_NAME = "accountingTaLeaseInterestAccrualRule";

    @Value("${jhipster.clientApp.name}")
    private String applicationName;

    private final TALeaseInterestAccrualRuleService tALeaseInterestAccrualRuleService;
    ...
    public TALeaseInterestAccrualRuleResource(
        TALeaseInterestAccrualRuleService tALeaseInterestAccrualRuleService,
