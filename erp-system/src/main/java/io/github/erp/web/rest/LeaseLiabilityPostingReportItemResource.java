...
@RestController
@RequestMapping("/api")
public class LeaseLiabilityPostingReportItemResource {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityPostingReportItemResource.class);

    private final LeaseLiabilityPostingReportItemService leaseLiabilityPostingReportItemService;
    ...
    public LeaseLiabilityPostingReportItemResource(
        LeaseLiabilityPostingReportItemService leaseLiabilityPostingReportItemService,
