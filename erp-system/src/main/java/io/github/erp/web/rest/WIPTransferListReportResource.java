...
@RestController
@RequestMapping("/api")
public class WIPTransferListReportResource {

    private final Logger log = LoggerFactory.getLogger(WIPTransferListReportResource.class);
    ...
    private final WIPTransferListReportService wIPTransferListReportService;
    ...
    public WIPTransferListReportResource(
        WIPTransferListReportService wIPTransferListReportService,
