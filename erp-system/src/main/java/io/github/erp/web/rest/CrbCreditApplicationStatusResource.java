...
@RestController
@RequestMapping("/api")
public class CrbCreditApplicationStatusResource {

    private final Logger log = LoggerFactory.getLogger(CrbCreditApplicationStatusResource.class);
    ...
    public CrbCreditApplicationStatusResource(
