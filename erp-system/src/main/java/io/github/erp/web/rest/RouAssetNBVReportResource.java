...
@RestController
@RequestMapping("/api")
public class RouAssetNBVReportResource {

    private final Logger log = LoggerFactory.getLogger(RouAssetNBVReportResource.class);
    ...
    public RouAssetNBVReportResource(
