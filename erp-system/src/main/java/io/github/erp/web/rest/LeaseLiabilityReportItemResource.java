...
@RestController
@RequestMapping("/api")
public class LeaseLiabilityReportItemResource {

    private final Logger log = LoggerFactory.getLogger(LeaseLiabilityReportItemResource.class);

    private final LeaseLiabilityReportItemService leaseLiabilityReportItemService;
    ...
    public LeaseLiabilityReportItemResource(
        LeaseLiabilityReportItemService leaseLiabilityReportItemService,
