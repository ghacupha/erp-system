...
/**
 * A LeaseLiabilityPostingReport.
 */
@Entity
@Table(name = "lease_liability_posting_report")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "leaseliabilitypostingreport")
public class LeaseLiabilityPostingReport implements Serializable {
    ...
    public LeaseLiabilityPostingReport id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public LeaseLiabilityPostingReport requestId(UUID requestId) {
    ...
    public LeaseLiabilityPostingReport timeOfRequest(ZonedDateTime timeOfRequest) {
    ...
    public LeaseLiabilityPostingReport fileChecksum(String fileChecksum) {
    ...
    public LeaseLiabilityPostingReport tampered(Boolean tampered) {
    ...
    public LeaseLiabilityPostingReport filename(UUID filename) {
    ...
    public LeaseLiabilityPostingReport reportParameters(String reportParameters) {
    ...
    public LeaseLiabilityPostingReport reportFile(byte[] reportFile) {
    ...
    public LeaseLiabilityPostingReport reportFileContentType(String reportFileContentType) {
    ...
    public LeaseLiabilityPostingReport requestedBy(ApplicationUser applicationUser) {
    ...
    public LeaseLiabilityPostingReport leasePeriod(LeasePeriod leasePeriod) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LeaseLiabilityPostingReport)) {
            return false;
        }
        return id != null && id.equals(((LeaseLiabilityPostingReport) o).id);
    }
