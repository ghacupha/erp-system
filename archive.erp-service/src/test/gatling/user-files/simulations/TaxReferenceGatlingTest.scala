...
/**
 * Performance test for the TaxReference entity.
 */
class TaxReferenceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the TaxReference entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all taxReferences")
            .get("/services/erpservice/api/tax-references")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new taxReference")
            .post("/services/erpservice/api/tax-references")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "taxName":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created taxReference")
                .get("/services/erpservice${new_taxReference_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created taxReference")
            .delete("/services/erpservice${new_taxReference_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
