...
/**
 * Performance test for the PaymentCalculation entity.
 */
class PaymentCalculationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PaymentCalculation entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all paymentCalculations")
            .get("/services/erpservice/api/payment-calculations")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new paymentCalculation")
            .post("/services/erpservice/api/payment-calculations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created paymentCalculation")
                .get("/services/erpservice${new_paymentCalculation_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created paymentCalculation")
            .delete("/services/erpservice${new_paymentCalculation_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
