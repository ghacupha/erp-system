...
import { PaymentCalculationComponent } from 'app/entities/payments/payment-calculation/payment-calculation.component';
  ...
  describe('PaymentCalculation Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new PaymentCalculation(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.paymentCalculations && comp.paymentCalculations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
