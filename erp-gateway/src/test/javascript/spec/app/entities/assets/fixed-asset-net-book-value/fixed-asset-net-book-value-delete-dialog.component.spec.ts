...
import { FixedAssetNetBookValueDeleteDialogComponent } from 'app/entities/assets/fixed-asset-net-book-value/fixed-asset-net-book-value-delete-dialog.component';
