...
4. Downloads the table via **Export CSV** or **Export Excel** to share the current contract's schedule with auditors.
5. Switches to a different lease contract using the dropdown on the dashboard to compare schedules without leaving the view.
...
- The totals and export files update automatically when the controller changes the selected contract.
