...
4. Confirms the headline figures (initial ROU amount, total depreciation, closing NBV and **Current period depreciation** that sums year-to-date charges) and scrolls through the period-by-period rows for that date.
...
- The **Current period depreciation** card aggregates depreciation for periods within the selected year up to the picked date so controllers can cite the year-to-date charge straight from the dashboard.
