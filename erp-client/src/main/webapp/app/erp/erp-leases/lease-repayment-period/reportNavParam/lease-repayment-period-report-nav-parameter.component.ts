...
@Component({
  selector: 'jhi-lease-repayment-period-report-nav-parameter',
  templateUrl: './lease-repayment-period-report-nav-parameter.component.html',
})
export class LeaseRepaymentPeriodReportNavParameterComponent {
  ...
  updateLeasePeriod(update: ILeaseRepaymentPeriod): void {
