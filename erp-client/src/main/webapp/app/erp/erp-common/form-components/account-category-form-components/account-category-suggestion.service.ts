...
export class AccountCategorySuggestionService {
  ...
  search(searchText: string): Observable<ITransactionAccountCategory[]> {

    if (searchText === "") {
      return of([])
    }

    return this.http.get<ITransactionAccountCategory[]>(
