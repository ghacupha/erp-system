...
export class LeaseLiabilityCompilationSuggestionService {
  ...
  search(searchText: string): Observable<ILeaseLiabilityCompilation[]> {
    if (!searchText) {
      return of([]);
    }

    return this.http.get<ILeaseLiabilityCompilation[]>(this.resourceSearchUrl, {
