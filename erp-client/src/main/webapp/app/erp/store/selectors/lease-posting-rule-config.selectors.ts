...
import {
  leasePostingRuleConfigFeatureKey,
  LeasePostingRuleConfigState,
} from '../reducers/lease-posting-rule-config.reducer';

export const selectLeasePostingRuleConfigState = createFeatureSelector<LeasePostingRuleConfigState>(
  leasePostingRuleConfigFeatureKey
);

export const selectLeasePostingRuleDraft = createSelector(
