...
export class ReportingEntityService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/app/reporting-entities');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/app/_search/reporting-entities');
