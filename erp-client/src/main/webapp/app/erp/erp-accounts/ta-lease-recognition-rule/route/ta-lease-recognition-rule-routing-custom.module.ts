...
const taLeaseRecognitionRuleCopyRoute: Routes = [
  {
    path: ':id/copy',
...
@NgModule({
  imports: [RouterModule.forChild(taLeaseRecognitionRuleCopyRoute)],
  exports: [RouterModule],
})
export class TALeaseRecognitionRuleRoutingCustomModule {
}
