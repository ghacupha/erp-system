...
const taRecognitionRouRuleCopyRoute: Routes = [
  {
    path: ':id/copy',
...
@NgModule({
  imports: [RouterModule.forChild(taRecognitionRouRuleCopyRoute)],
  exports: [RouterModule],
})
export class TARecognitionROURuleRoutingCustomModule {}
