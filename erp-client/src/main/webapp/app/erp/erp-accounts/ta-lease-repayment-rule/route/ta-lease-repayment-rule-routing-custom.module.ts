...
const taLeaseRepaymentRuleCopyRoute: Routes = [
  {
    path: ':id/copy',
...
@NgModule({
  imports: [RouterModule.forChild(taLeaseRepaymentRuleCopyRoute)],
  exports: [RouterModule],
})
export class TALeaseRepaymentRuleRoutingCustomModule {
}
