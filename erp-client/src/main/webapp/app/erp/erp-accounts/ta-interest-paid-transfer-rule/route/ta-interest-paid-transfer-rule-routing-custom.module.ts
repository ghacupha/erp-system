...
const taInterestPaidTransferRuleCopyRoute: Routes = [
  {
    path: ':id/copy',
...
@NgModule({
  imports: [RouterModule.forChild(taInterestPaidTransferRuleCopyRoute)],
  exports: [RouterModule],
})
export class TAInterestPaidTransferRuleRoutingCustomModule {
}
