...
export class TARecognitionROURuleComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-ta-recognition-rou-rule div table .btn-danger'));
  title = element.all(by.css('jhi-ta-recognition-rou-rule div h2#page-heading span')).first();
...
export class TARecognitionROURuleUpdatePage {
  pageTitle = element(by.id('jhi-ta-recognition-rou-rule-heading'));
...
export class TARecognitionROURuleDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-tARecognitionROURule-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-tARecognitionROURule'));
