...
export class TALeaseInterestAccrualRuleComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-ta-lease-interest-accrual-rule div table .btn-danger'));
  title = element.all(by.css('jhi-ta-lease-interest-accrual-rule div h2#page-heading span')).first();
...
export class TALeaseInterestAccrualRuleUpdatePage {
  pageTitle = element(by.id('jhi-ta-lease-interest-accrual-rule-heading'));
...
export class TALeaseInterestAccrualRuleDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-tALeaseInterestAccrualRule-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-tALeaseInterestAccrualRule'));
