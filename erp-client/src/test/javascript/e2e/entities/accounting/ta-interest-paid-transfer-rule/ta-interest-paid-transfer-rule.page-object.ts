...
export class TAInterestPaidTransferRuleComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-ta-interest-paid-transfer-rule div table .btn-danger'));
  title = element.all(by.css('jhi-ta-interest-paid-transfer-rule div h2#page-heading span')).first();
...
export class TAInterestPaidTransferRuleUpdatePage {
  pageTitle = element(by.id('jhi-ta-interest-paid-transfer-rule-heading'));
...
export class TAInterestPaidTransferRuleDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-tAInterestPaidTransferRule-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-tAInterestPaidTransferRule'));
