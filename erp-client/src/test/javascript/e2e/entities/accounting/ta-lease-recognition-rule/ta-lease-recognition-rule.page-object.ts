...
export class TALeaseRecognitionRuleComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-ta-lease-recognition-rule div table .btn-danger'));
  title = element.all(by.css('jhi-ta-lease-recognition-rule div h2#page-heading span')).first();
...
export class TALeaseRecognitionRuleUpdatePage {
  pageTitle = element(by.id('jhi-ta-lease-recognition-rule-heading'));
...
export class TALeaseRecognitionRuleDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-tALeaseRecognitionRule-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-tALeaseRecognitionRule'));
