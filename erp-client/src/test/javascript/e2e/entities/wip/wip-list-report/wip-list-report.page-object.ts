...
export class WIPListReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-wip-list-report div table .btn-danger'));
  title = element.all(by.css('jhi-wip-list-report div h2#page-heading span')).first();
...
export class WIPListReportUpdatePage {
  pageTitle = element(by.id('jhi-wip-list-report-heading'));
...
export class WIPListReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-wIPListReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-wIPListReport'));
