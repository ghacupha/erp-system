...
export class WIPTransferListReportComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-wip-transfer-list-report div table .btn-danger'));
  title = element.all(by.css('jhi-wip-transfer-list-report div h2#page-heading span')).first();
...
export class WIPTransferListReportUpdatePage {
  pageTitle = element(by.id('jhi-wip-transfer-list-report-heading'));
  ...
  temperedInput = element(by.id('field_tempered'));
  ...
  getTemperedInput(): ElementFinder {
    return this.temperedInput;
  }
...
export class WIPTransferListReportDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-wIPTransferListReport-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-wIPTransferListReport'));
