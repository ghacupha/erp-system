...
describe('PrepaymentAmortization e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {"timeOfRequest":"2023-11-20T12:26:49.792Z","compilationStatus":"STARTED","itemsProcessed":95347,"compilationToken":"399be39b-ee13-402e-8ea0-16d01454acbd","narration":"compressing French","postedBy":"Ergonomic copying"},
    }).then(({ body }) => {
